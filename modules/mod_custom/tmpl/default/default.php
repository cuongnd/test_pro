...
<div class="custom<?php echo $moduleclass_sfx ?> module-custom-html" contenteditable="true" <?php if ($params->get('backgroundimage')) : ?> style="background-image:url(<?php echo $params->get('backgroundimage');?>)"<?php endif;?> >
