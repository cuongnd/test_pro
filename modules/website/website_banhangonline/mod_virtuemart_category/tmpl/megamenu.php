...
$doc->addScriptNotCompile(JUri::root() . '/modules/website/website_banhangonline/mod_virtuemart_category/asset/js/custom_mega_menu_styles/js/jquery.dcmegamenu.1.3.js');
$doc->addScriptNotCompile(JUri::root() . '/modules/website/website_banhangonline/mod_virtuemart_category/asset/js/dcmegamenu.js');
$doc->addLessStyleSheetTest(JUri::root() . '/modules/website/website_banhangonline/mod_virtuemart_category/asset/js/custom_mega_menu_styles/megamenu.less');
