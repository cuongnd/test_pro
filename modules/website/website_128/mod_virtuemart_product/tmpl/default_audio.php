...
<div class="thumbnail">
    ...
    <audio controls="controls" height="150px" style="padding-top: 40px" width="300px" poster="<?php echo JUri::root() ?>/images/stories/sound.jpg"
           preload="none" aria-describedby="full-descript">
        <source type="audio/mp3" src="<?php echo $product->audio_player ?>"/>
    </audio>
