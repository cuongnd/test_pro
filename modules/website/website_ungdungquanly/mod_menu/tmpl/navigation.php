...
$doc->addScript(JUri::root() . '/modules/website/website_ungdungquanly/mod_menu/assets/Responsive-Cross-platform-jQuery-Navigation-Menu-Plugin-Smart-Menus/src/jquery.smartmenus.js');
$doc->addScript(JUri::root() . '/modules/website/website_ungdungquanly/mod_menu/assets/navigation_menu.js');
$doc->addStyleSheet(JUri::root() . '/modules/website/website_ungdungquanly/mod_menu/assets/Responsive-Cross-platform-jQuery-Navigation-Menu-Plugin-Smart-Menus/src/css/sm-core-css.css');
$doc->addStyleSheet(JUri::root() . '/modules/website/website_ungdungquanly/mod_menu/assets/Responsive-Cross-platform-jQuery-Navigation-Menu-Plugin-Smart-Menus/src/css/sm-blue/sm-blue.css');
ob_start();
?>
