...
$column=4;
$list_list_product_best_sale=array_chunk($list_product_best_sale,$column);
?>
<?php foreach($list_list_product_best_sale AS $list_product_best_sale){ ?>
    <div class="row form-group">
        <?php  foreach($list_product_best_sale AS $product){ ?>
