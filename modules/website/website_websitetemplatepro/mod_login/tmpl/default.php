...
$scriptId = "script_mod_login" . $module->id;
ob_start();
?>
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        $('#mod_login_<?php echo $module->id ?> .dropdown-menu').on({
            "click":function(e){
                e.stopPropagation();
            }
        });
...
<div id="mod_login_<?php echo $module->id ?>" class="mod_login pull-right mod_login_<?php echo $module->id ?>">
    <a class="dropdown-toggle" data-toggle = "dropdown" href="#"><i class="im-user"></i> <?php echo JText::_('Login') ?></a>
