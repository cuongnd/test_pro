				...
				<?php if ($params->get('greeting')) : ?>
					<div class="login-greeting">
						<?php if ($params->get('name') == 0) : {
							echo JText::sprintf('mod_supper_admin_login_HINAME', htmlspecialchars($user->get('name')));
						} else : {
							echo JText::sprintf('mod_supper_admin_login_HINAME', htmlspecialchars($user->get('username')));
						} endif; ?>
					</div>
				<?php endif; ?>
