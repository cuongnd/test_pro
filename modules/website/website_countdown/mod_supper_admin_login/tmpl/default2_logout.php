        ...
        <?php if ($params->get('greeting')) : ?>
            <div class = "btn btn-default login-greeting lable_name">
                <?php if ($params->get('name') == 0) : {
                    echo JText::sprintf('mod_supper_admin_login_HINAME', htmlspecialchars($user->get('name')),'0.00$');
                } else : {
                    echo JText::sprintf('mod_supper_admin_login_HINAME', htmlspecialchars($user->get('username')),'0.00$');
                } endif; ?>
            </div>
        <?php endif; ?>
