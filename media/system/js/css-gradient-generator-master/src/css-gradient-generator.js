...
var CSSGradientEditor = function(container, options) {
  ...
  function updateToolbar() {
    ...
    elements.permalink.attr('href',currentLink+ '&' + currentgradient).data('querystring', currentgradient);

    elements.imagegradient.attr('href', (typeof this_host !="undefined"?this_host:'')  +'/media/system/js/css-gradient-generator-master/gradient.php?' + currentgradient);

    if (typeof window.history.pushState === 'function') {

      window.history.replaceState({}, '', currentLink + '&' + currentgradient);
    }
  ...
  function updateCssOutput() {
    ...
    $('textarea.css_output').val(cssoutput);
