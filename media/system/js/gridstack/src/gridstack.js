(function (scope, _) {
    ...
    var GridStackEngine = function (width, onchange,a_float, height, items) {
        this.width = width;
    ...
    GridStackEngine.prototype.write_header = function (el,node) {
        prevEl=el.prev();
        nextEl=el.next();
        var prevNode = prevEl.data('_gridstack_node');
        var nextNode = nextEl.data('_gridstack_node');
        offset=node.x;
    ...
    GridStack.prototype.destroy_resizable = function (el, val) {
        el = jQuery(el);
        el.each(function (index, el) {
            el = jQuery(el);
            var node = el.data('_gridstack_node');
    ...
    GridStack.prototype.destroy_draggable = function (el, val) {
        el = jQuery(el);
        el.each(function (index, el) {
            el = jQuery(el);
            var node = el.data('_gridstack_node');
    ...
    jQuery.fn.gridstack = function (opts) {
        return this.each(function () {
            if (!jQuery(this).data('gridstack')) {
                jQuery(this).data('gridstack', new GridStack(this, opts));
            }
        });
    };
