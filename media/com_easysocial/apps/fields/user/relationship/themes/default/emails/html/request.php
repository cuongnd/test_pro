	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<span style="margin-bottom:15px;">
			<span style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::_( 'PLG_FIELDS_RELATIONSHIP_EMAIL_REQUEST_TITLE' ); ?>
			</span>
			<span style="font-size:12px; color: #798796;font-weight:normal">
				<?php echo JText::sprintf( 'PLG_FIELDS_RELATIONSHIP_EMAIL_REQUEST_DESCRIPTION' , $posterName ); ?>
			</span>
		</span>
	</td>
</tr>
...
<tr>
	<td style="text-align: center;font-size:12px;color:#888">
		...
		<p style="text-align:left;padding: 0 30px;">
			<?php echo JText::sprintf( 'PLG_FIELDS_RELATIONSHIP_EMAIL_REQUEST_CONTENT', $posterName );?>:
		</p>
				...
				<tr>
					...
					<td valign="top" style="color:#888;background-color:#f8f9fb;text-align:left">
						<p style="margin:0 0 5px;font-weight:bold;font-size:13px;">
							<?php echo JText::sprintf( 'PLG_FIELDS_RELATIONSHIP_EMAIL_REQUEST_RELATIONSHIP_STATUS', $posterName, $type, $connect ); ?>
						</p>
					</td>
				</tr>
			</tbody>
		...
		<a style="
				...
				" href="<?php echo $link;?>"><?php echo JText::_( 'PLG_FIELDS_RELATIONSHIP_EMAIL_REQUEST_REVIEW' );?></a>
