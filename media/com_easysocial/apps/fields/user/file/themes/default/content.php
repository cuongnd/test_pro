	...
	<div data-field-file-list>
		<?php if( !empty( $count ) ) { ?>
			...
			<div class="data-field-file-item" data-field-file-item data-key="<?php echo $i; ?>">
				<?php echo $this->loadTemplate( 'fields/user/file/control', array( 'key' => $i, 'inputName' => $inputName, 'file' => $value[$i], 'element' => $element, 'group' => $group, 'field' => $field, 'params' => $params ) ); ?>
			</div>
			<?php } ?>
		<?php } ?>
