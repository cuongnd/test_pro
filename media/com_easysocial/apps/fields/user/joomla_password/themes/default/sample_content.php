...
<div data-field-joomla_password>
	<ul class="input-vertical unstyled">
		<li>
			<input type="password" size="30" class="input-xlarge text validation required match-password2" autocomplete="off" value="" id="password" name="password"
		...
		<li <?php if( !$params->get( 'reconfirm_password' ) ) { ?>style="display: none;"<?php } ?> data-password-confirm>
			<input type="password" size="30" class="input-xlarge text validation required match-password" autocomplete="off" value="" id="password2" name="password2"
					data-errors-invalid="<?php echo JText::_( 'Please enter valid password' );?>"
					data-errors-match="<?php echo JText::_( 'Passwords do not match' );?>"
					data-errors-required="<?php echo JText::_( 'Password is required' );?>"
