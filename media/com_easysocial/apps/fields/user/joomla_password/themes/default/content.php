...
?>
<div data-field-joomla_password data-password-strength="<?php echo $params->get( 'password_strength' ); ?>" data-reconfirm-password="<?php echo $params->get( 'reconfirm_password' ); ?>" data-min="<?php echo $params->get( 'min', 4 ); ?>">
	<ul class="input-vertical unstyled">
		<li>
			<input type="password" size="50" class="input-xlarge" autocomplete="off"
					value=""
		...
		<li>
			<input type="password" size="50" class="input-xlarge"
					autocomplete="off"
					value=""
