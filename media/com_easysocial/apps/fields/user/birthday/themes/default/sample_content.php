...
<div data-without-calendar <?php if( $params->get( 'calendar' ) ) { ?>style="display: none;"<?php } ?>>
	<div data-without-calendar-format <?php if( $params->get( 'date_format', 1 ) != 1 ) { ?>style="display: none;"<?php } ?>>
		<!-- DD/MM/YYYY -->
		<?php echo $this->includeTemplate( 'fields/user/birthday/form.day', array( 'day' => '') ); ?>
		<?php echo $this->includeTemplate( 'fields/user/birthday/form.month', array( 'month' => '') ); ?>
		<?php echo $this->includeTemplate( 'fields/user/birthday/form.year', array( 'year' => '') ); ?>
	</div>
