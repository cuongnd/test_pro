...
<div data-field-joomla_fullname>
	<ul class="input-vertical unstyled" <?php if( $params->get( 'format' , 1 ) != 1 ) { ?>style="display: none;"<?php } ?> data-fullname-format>
		<li>
			<input type="text"
				size="30"
	...
	<ul class="input-vertical unstyled" <?php if( $params->get( 'format' , 1 ) != 2 ) { ?>style="display: none;"<?php } ?> data-fullname-format>
		<li>
			<input type="text"
				size="30"
				class="input input-xlarge"
