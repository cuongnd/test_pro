 ...
 */
class SocialUserAppsTasksInstaller implements SocialAppInstaller
{
	/**
	...
	public function success()
	{
		ob_start();
	?>
	<h3><?php echo JText::_( 'APP_TASKS_INSTALL_SUCCESS_HEADING' );?></h3>
	<p>
		<?php echo JText::_( 'APP_TASKS_INSTALL_SUCCESS_DESC' ); ?>
	</p>
