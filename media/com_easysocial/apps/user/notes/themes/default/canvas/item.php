...
<li class="note-item" data-apps-notes-item data-id="<?php echo $note->id;?>">
	<div class="row-fluid">
		<a href="<?php echo FRoute::_( 'index.php?option=com_easysocial&view=apps&layout=canvas&id=' . $appId . '&appView=note&cid=' . $note->id . '&userid=' . $user->id );?>" class="note-title pull-left"><?php echo $note->title; ?></a>
