...
.script( 
	'<?php echo rtrim( JURI::root() , '/' );?>/media/com_easysocial/apps/user/calendar/assets/scripts/calendar.js'
)
.done(function($)
{
	...
	var options = {
					...
					<?php if( $schedules ){ ?>
						...
						<?php foreach( $schedules as $schedule ){ ?>
						{
							...
							"title"		: "<?php echo $this->html( 'string.escape' , $schedule->title );?>",
							...
							"desc"		: "<?php echo $this->html( 'string.escape' , $schedule->description ) ? $this->html( 'string.escape' , $schedule->description ) : JText::_( 'No description set' );?>"
