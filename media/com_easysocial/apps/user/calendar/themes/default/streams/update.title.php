...
<div class="row-fluid">
	...
	<?php } ?>
	<?php echo JText::_( 'APP_CALENDAR_UPDATED' ); ?>
	<a href="<?php echo FRoute::apps( array( 'layout' => 'canvas' , 'id' => $app->id , 'userid' => $actor->getAlias() , 'customView' => 'item' , 'schedule_id' => $calendar->id ) );?>"><?php echo $calendar->get( 'title' ); ?></a> 
