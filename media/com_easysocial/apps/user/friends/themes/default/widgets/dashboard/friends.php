...
<div class="es-widget">
	<div class="es-widget-head">
		<div class="pull-left widget-title">
			<?php echo JText::_( 'APP_FRIENDS_YOUR_FRIENDS' ); ?>
		</div>
	</div>
	<div class="es-widget-body">
		...
		<?php if( $total > 0 ){ ?>
		<div>
			<a href="<?php echo FRoute::friends( array( 'userid' => $this->my->getAlias() ) );?>" class="small"><?php echo JText::_( 'APP_FRIENDS_VIEW_ALL' );?></a>
		</div>
		<?php } ?>
	</div>
</div>