	...
	<div class="es-widget-body">
		...
		<ul class="widget-list es-nav es-nav-stacked friends-suggestion-list">
			<?php foreach( $friends as $item ){
				...
				if( $item->count )
				{
					$cntPluralize 	= Foundry::get( 'Language' )->pluralize( $item->count, true )->getString();
			...
			>
				<div class="widget-main-link">
					...
					<div class="media-body pl-10 small">
						<a href="<?php echo $item->friend->getPermalink();?>">
						...
						<div class="small total-no" data-friend-suggest-button>
							<a href="javascript:void(0);" data-friend-suggest-add>
		...
		<div class="pull-right pr-10">
			<a href="<?php echo FRoute::friends( array( 'filter' => 'suggest' ) ); ?>" class="small"><?php echo JText::_( 'APP_FRIENDS_SUGGEST_FRIENDS_VIEW_ALL' ); ?></a>
		</div>
		<?php } else { ?>
