...
case"MM":result=isFuture?"kuukauden":"kuukautta";break;case"y":return isFuture?"vuoden":"vuosi";case"yy":result=isFuture?"vuoden":"vuotta"}return result=verbal_number(number,isFuture)+" "+result}function verbal_number(number,isFuture){return 10>number?isFuture?numbers_future[number]:numbers_past[number]:number}var numbers_past="nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" "),numbers_future=["nolla","yhden","kahden","kolmen","neljän","viiden","kuuden",numbers_past[7],numbers_past[8],numbers_past[9]];
...
};exports(),module.resolveWith(exports)};FD31.module("moment/fi",moduleFactory)}();