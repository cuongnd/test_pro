...
//>> Properties
    ...
    * Sets the template option of the GridEditable.
    * Template which will be use during popup editing
    * @param string $value The class of the element which represents the kendo template.
    * @return \Kendo\UI\GridEditable
    */
    public function templateClass($value) {
        $value = new \Kendo\Template($value);
    ...
    * Sets the template option of the GridEditable.
    * Template which will be use during popup editing
    * @param string $value The jquery element of the element which represents the kendo template.
    * @return \Kendo\UI\GridEditable
    */
    public function templateJquery($value) {
        $value = new \Kendo\Template($value,true);
        return $this->setProperty('template', $value);
    }
