...
$create->url('http://etravelservice.com:81/media/kendotest/php/api/products/create.php')
  ->contentType('application/json')
  ->type('POST');

$read = new \Kendo\Data\DataSourceTransportRead();
$read->url('http://etravelservice.com:81/media/kendotest/php/api/products/read.php')
  ->contentType('application/json')
  ->type('POST');

$update = new \Kendo\Data\DataSourceTransportUpdate();
$update->url('http://etravelservice.com:81/media/kendotest/php/api/products/update.php')
  ->contentType('application/json')
  ->type('PUT');

$destroy = new \Kendo\Data\DataSourceTransportDestroy();
$destroy->url('http://etravelservice.com:81/media/kendotest/php/api/products/destroy.php')
  ->contentType('application/json')
  ->type('POST');
...
<script>
  ...
  function supplierEditor(container, options) {
    $("<input data-text-field='SupplierName' for='" + options.field + "' name='" + options.field + "' id='" + options.field + "' data-value-field='SupplierID' data-bind='value:" + options.field + "' />")
    .appendTo(container)
    .kendoDropDownList({
      index: -1,
      dataSource: {
