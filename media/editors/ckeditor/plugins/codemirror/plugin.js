        ...
        init: function (editor) {
                ...
                CKEDITOR.dialog.add('sourcedialog', function (editor) {
                    ...
                    return {
                        ...
                        onShow: function () {
                            ...
                            if (!IsStyleSheetAlreadyLoaded(this_host + '/media/system/js/CodeMirror-master/lib/codemirror.css')) {
                            ...
                            if (typeof (CodeMirror) == 'undefined') {
                                ...
                                CKEDITOR.scriptLoader.load(this_host + '/media/system/js/CodeMirror-master/jquery.codemirror.js', function() {
            ...
            editor.addMode('source', function (callback) {
                ...
                if (typeof (CodeMirror) == 'undefined') {
                    ...
                    if (typeof CodeMirror.prototype['autoFormatAll'] !=="undefined") {
                        loadCodeMirror(editor);
                        callback();
                    } else {
                        // loading the add-on scripts.
            ...
            function loadCodeMirror(editor) {
                ...
                var list_field=[];
                jQuery.each(CKEDITOR.config.list_var, function( index, value ) {
                    list_field.push('#:'+value+'#');
                });
                list_field.push('request(id,0)');
                ...
                CodeMirror.registerHelper("hint","list_menu",function(editor, options){
                    ...
                    function scan(dir) {
                        ...
                        var text = editor.getLine(line),m;
                        var text = curWord;
                        $.each(CKEDITOR.config.list_menu, function( index, value ) {
                ...
                CodeMirror.registerHelper("hint","list_style",function(editor, options){
                    ...
                    function scan(dir) {
                        ...
                        var text = editor.getLine(line),m;
                        var text = curWord;
                        $.each(CKEDITOR.config.list_style, function( index, value ) {
                            if(value.indexOf(text) != -1){
                                list.push(value);
                            }
                        });
                ...
                CodeMirror.commands.list_style = function(cm) {
                    cm.showHint({hint: CodeMirror.hint.list_style});
                };
