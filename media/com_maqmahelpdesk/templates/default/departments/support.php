<div class="maqmahelpdesk container-fluid">
	...
	<?php if ($supportConfig->show_dashboard_support) : ?>
	<div class="row-fluid" style="margin-top:10px;margin-bottom:10px;">
		<div class="span4 container">
			...
			<a href="<?php echo JRoute::_("index.php?option=com_maqmahelpdesk&Itemid=" . $Itemid . "&id_workgroup=" . $id_workgroup . "&task=ticket_my&filter_opened=1");?>">
				<img src="components/com_maqmahelpdesk/images/shortcuts.png" alt="" border="0"/>
			</a>
		</div>
		<div class="span4 container">
			<span class="badge badge-important"><?php echo $tickets_overdue; ?></span> <?php echo JText::_('overdued_ticket');?>
			<a href="<?php echo JRoute::_("index.php?option=com_maqmahelpdesk&Itemid=" . $Itemid . "&id_workgroup=" . $id_workgroup . "&task=ticket_my&filter_overdued=1");?>">
				<img src="components/com_maqmahelpdesk/images/shortcuts.png" alt="" border="0"/>
			</a>
		</div>
		<div class="span4 container">
			<span class="badge badge-success"><?php echo $tickets_today; ?></span> <?php echo JText::_('tickets_today');?>
			<a href="<?php echo JRoute::_("index.php?option=com_maqmahelpdesk&Itemid=" . $Itemid . "&id_workgroup=" . $id_workgroup . "&task=ticket_my&filter_today=1");?>">
				<img src="components/com_maqmahelpdesk/images/shortcuts.png" alt="" border="0"/>
			</a>
		</div>
	</div>
