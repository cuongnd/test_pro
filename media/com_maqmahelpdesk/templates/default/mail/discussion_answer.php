...
<table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#333333">
    <tr>
        <td class="heading2"><?php echo JText::_('mail_subject_answer');?></td>
    </tr>
</table>
<table width="100%" border="0" cellspacing="1" cellpadding="5" class="bodytable">
    ...
    <tr>
        <th align="left" nowrap class="bodytext"><?php echo JText::_('question');?>:</th>
        <td class="bodytext">[question]</td>
    </tr>
    <tr>
