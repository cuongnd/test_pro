...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
    <tr>
        <td class="heading2"><?php echo JText::_('tkt_assigned_old_assignee_head');?></td>
    </tr>
</table>
<table width="100%" border="0" cellspacing="3" cellpadding="5" class="bodytable">
    <tr>
        <td colspan="2" class="bodytext"><?php echo JText::_('dear');?>&nbsp;%unassigned%,<br>
            <br/><br/><?php echo JText::_('tkt_assigned_old_assignee_intro');?><br/><br/><br/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td valign="top" class="bodytext">%rpl_summary%</td>
    </tr>
    <tr>
        <th align="left" valign="top" nowrap class="bodytext"><?php echo JText::_('tpl_last');?>
            &nbsp;
        ...
        <td valign="top" class="bodytext">%rpl_msg%</td>
    </tr>
