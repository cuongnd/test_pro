        ...
        <div id="email_border3" style="border: 3px solid #eee;">
            <div id="padding" style="padding: 20px 20px 30px 20px;">
                <div id="big" style="font-weight: bold; font-size: 26px; text-align: center;">
                    <?php echo JText::_('contracts_addon_title');?>
                </div>
                <div id="big"
                     style="font-weight: normal; font-size: 16px; padding: 5px 0; color: #888; text-align: center;">
                    <?php echo JText::_('contracts_body');?>
                </div>
                <div id="div" style="font-size: 13px; margin: 20px 0; color: #444; ">
                    <table width="100%" cellpadding="5" cellspacing="0">
                        <thead>
                        <tr class="header">
                            <th bgcolor="#CCCCCC"><?php echo JText::_('number');?></th>
                            <th bgcolor="#CCCCCC"><?php echo JText::_('unit');?></th>
                            <th bgcolor="#CCCCCC"><?php echo JText::_('value');?></th>
                            <th bgcolor="#CCCCCC"><?php echo JText::_('current');?></th>
                            <th bgcolor="#CCCCCC"><?php echo JText::_('start');?></th>
                            <th bgcolor="#CCCCCC"><?php echo JText::_('end');?></th>
                        </tr>
                        </thead>
                        <tbody>
                        $feed_summary
