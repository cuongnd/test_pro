        ...
        <div id="email_border3" style="border: 3px solid #eee;">
            <div id="padding" style="padding: 20px 20px 30px 20px;">
                ...
                <div id="div" style="font-size: 13px; margin: 20px 0; color: #444; ">
                    <?php echo JText::_('dear');?>&nbsp;%user%,
                </div>
                <div id="div" style="font-size: 13px; margin: 20px 0; color: #444; ">
                    <?php echo JText::_('notify_message');?>
                </div>
                <div id="div" style="clear: both; "></div>
                <div id="div" style="font-size: 13px; margin: 20px 0; color: #444; ">
                    <a href="%url%" target="_blank">%category%</a> &bull; <a href="%url%" target="_blank">%product%</a>
                </div>
            </div>
        </div>
    </div>
