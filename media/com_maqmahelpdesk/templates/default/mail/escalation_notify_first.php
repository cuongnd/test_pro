...
<table width="100%" border="0" cellspacing="3" cellpadding="5" class="bodytable">
    ...
    <tr>
        ...
        <td width="99%" align="left" valign="top" class="bodytext">%rpl_summary%</td>
    </tr>
    <tr>
        <th align="left" valign="top" nowrap class="bodytext"><?php echo JText::_('tpl_last');?>
            &nbsp;<?php echo JText::_('act_msg');?>&nbsp;(<?php echo JText::_('tpl_ifany');?>)
        </th>
        <td width="99%" align="left" valign="top" class="bodytext">%rpl_msg%</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="left" valign="top" width="99%" class="bodytext">%tkt_user% (<a href="mailto:%tkt_user_email%">%tkt_user_email%</a>)
        </td>
    </tr>
    <tr>
        <th align="left" valign="top" nowrap class="bodytext"><?php echo JText::_('status');?></th>
        <td align="left" valign="top" width="99%" class="bodytext">%status%</td>
    </tr>
    <tr>
        <th align="left" valign="top" nowrap class="bodytext"><?php echo JText::_('category');?></th>
        <td align="left" valign="top" width="99%" class="bodytext">%category%</td>
    </tr>
    <tr>
        <th align="left" valign="top" nowrap class="bodytext"><?php echo JText::_('priority');?></th>
        <td walign="left" valign="top" idth="99%" class="bodytext">%priority%</td>
    </tr>
    <tr>
        <th align="left" valign="top" nowrap class="bodytext"><?php echo JText::_('tpl_assignedto');?></th>
