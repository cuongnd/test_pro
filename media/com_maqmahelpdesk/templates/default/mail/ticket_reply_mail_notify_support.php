                ...
                <div id="div" style="padding: 0 0 20px 0;">
                    <table style="width:100%; font-family: arial, helvetica, sans-serif; font-size: 13px;">
                        ...
                        <tr>
                            ...
                            <td style="padding:3px;background:#fff;vertical-align:top;">[status] <span class="changed">[status_old]</span>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:3px;background:#eee;vertical-align:top;width:30%;"><?php echo JText::_('priority');?></td>
                            <td style="padding:3px;background:#fff;vertical-align:top;">[priority] <span
                                class="changed">[priority_old]</span></td>
                        </tr>
                        <tr>
                            <td style="padding:3px;background:#eee;vertical-align:top;width:30%;"><?php echo JText::_('category');?></td>
                            <td style="padding:3px;background:#fff;vertical-align:top;">[category] <span
                                class="changed">[category_old]</span></td>
                        </tr>
                        <tr>
                            <td style="padding:3px;background:#eee;vertical-align:top;width:30%;"><?php echo JText::_('duedate');?></td>
                            <td style="padding:3px;background:#fff;vertical-align:top;">[duedate] <span class="changed">[duedate_old]</span>
                            </td>
                        </tr>
                    </table>

                    <div id="div" style="font-size: 13px; margin-top: 30px; margin-bottom: 10px; color: #444; ">
                        <?php echo JText::_('previous_messages');?>:
                    </div>

                    <table style="width:100%; font-family: arial, helvetica, sans-serif; font-size: 13px;">
                        <!-- messages:start -->
                        <tr>
                            <td style="padding:3px;background:#eee;vertical-align:top;width:50px;text-align:center;"
                                rowspan="4"><img src="[messages:avatar]" width="48" height="48"/></td>
                        </tr>
                        <tr>
                            <td style="padding:3px;background:#fff;vertical-align:top;">[messages:author]</td>
                        </tr>
                        <tr>
                            <td style="padding:3px;background:#fff;vertical-align:top;">[messages:date]</td>
                        </tr>
                        <tr>
                            <td style="padding:3px;background:#fff;vertical-align:top;">[messages:message]</td>
                        </tr>
                        <!-- messages:end -->
                    </table>
                </div>
