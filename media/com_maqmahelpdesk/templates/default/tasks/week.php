<div class="maqmahelpdesk container-fluid">
	...
	<form id="calendarForm" name="adminForm" action="<?php echo JRoute::_("index.php");?>" method="POST">
		...
		<input type="hidden" name="task" value="calendar_week"/>
    ...
    <?php echo HelpdeskTask::GetWeek(($year . '-' . $month . '-' . $day == date("Y-m-d") ? HelpdeskTask::GetWeekStart($year . '-' . $month . '-' . $day, $supportConfig->week_start) : $year . '-' . $month . '-' . $day)); ?>
