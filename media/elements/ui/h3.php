...
class elementH3Helper extends  elementHelper
{
    ...
    function getHeaderHtml($block,$enableEditWebsite)
    {
        ...
        if($enableEditWebsite) {
            ...
            <h3 class="block-item block-item-h3" data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>" element-type="<?php echo $block->type ?>"><?php echo $text ?></h3>
        <?php
        }else{
            ?>
            <script type="text/javascript">
