...
class elementH5Helper extends  elementHelper
{
    ...
    function getHeaderHtml($block,$enableEditWebsite)
    {
        ...
        if($enableEditWebsite) {
            ?>
            <div class="control-element control-element-h5"  data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>" element-type="<?php echo $block->type ?>">
            <script type="text/javascript">
                jQuery(document).ready(function ($) {
                    element_ui_h5.init_ui_h5();
                });
            </script>
            ...
            <h5 class="block-item block-item-h5" data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>"><?php echo $text ?></h5>
        <?php
        }else{
            ?>
            <script type="text/javascript">
