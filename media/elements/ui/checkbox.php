...
class elementCheckBoxHelper extends  elementHelper
{
    ...
    function getHeaderHtml($block,$enableEditWebsite)
    {
        ...
        if($enableEditWebsite) {
            ?>
            <div class="control-element control-element-checkbox" style="width: auto" data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>" element-type="<?php echo $block->type ?>">
            ...
            <input  type="checkbox" class="noStyle block-item block-item-checkbox" name="vehicle" value="Bike">
        <?php
        }else{
            ?>
            <div class="">
                <?php
                $list_checkbox=explode("\n",$checkbox);
                foreach ($list_checkbox as $item){
                    echo '<input class="checkbox-style '.$class.'" type="checkbox" name="'.$name.'" value="'.trim($item).'">'.trim($item).''.'</br>';
                }
                ?>
        <?php
        }
