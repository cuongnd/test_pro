...
class elementH6Helper extends  elementHelper
{
    ...
    function getHeaderHtml($block,$enableEditWebsite)
    {
        ...
        if($enableEditWebsite) {
            ?>
            <div class="control-element control-element-h6"  data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>" element-type="<?php echo $block->type ?>">
            <script type="text/javascript">
                jQuery(document).ready(function ($) {
                    element_ui_h6.init_ui_h6();
                });
            </script>
            ...
            <h6 class="block-item block-item-h6" data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>"><?php echo $text ?></h6>
        <?php
        }else{
            ?>
            <script type="text/javascript">
