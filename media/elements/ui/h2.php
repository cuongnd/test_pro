...
class elementH2Helper extends  elementHelper
{
    ...
    function getHeaderHtml($block,$enableEditWebsite)
    {
        ...
        if($enableEditWebsite) {
            ?>
            <div class="control-element control-element-h2"  data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>" element-type="<?php echo $block->type ?>">
            <script type="text/javascript">
                jQuery(document).ready(function ($) {
                    element_ui_h2.init_ui_h2();
                });
            </script>
            ...
            <h2 class="block-item block-item-h2" data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>"><?php echo $text ?></h2>
        <?php
        }else{
            ?>
            <script type="text/javascript">
