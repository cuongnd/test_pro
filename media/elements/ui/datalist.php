...
class elementDataListHelper extends  elementHelper
{
    ...
    function getHeaderHtml($block,$enableEditWebsite)
    {
        ...
        if($enableEditWebsite) {
            ...
            <div class="block-item block-item-datalist "    data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>" id="<?php echo $id; ?>" element-type="<?php echo $block->type ?>">
