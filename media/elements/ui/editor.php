        ...
        if($enableEditWebsite) {
            ...
            <script type="text/javascript">
                jQuery(document).ready(function ($) {
                    element_ui_editor.init_ui_editor();
                });
            </script>
            ...
            <textarea enable-submit="<?php echo $enable_submit?'true':'false' ?>" name="<?php echo $name ?>" id="block_item_editor_<?php echo $block->id ?>" contenteditable="true" class="block-item block-item-editor "   data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>"  element-type="<?php echo $block->type ?>"><?php echo $text ?></textarea>
