<?php
class elementIconButtonHelper extends  elementHelper
{
    ...
    function getHeaderHtml($block,$enableEditWebsite)
    {
        ...
        <?php
            echo elementIconButtonHelper::render_element($block,$enableEditWebsite);
        }else{
            echo elementIconButtonHelper::render_element($block,$enableEditWebsite);
        }
        $html.=ob_get_clean();
    ...
    public function render_element($block,$enableEditWebsite)
    {
        ...
        $class_button = $params->get('element_config.class_button', '');
        if($class_button)
            $class_button="btn-$class_button";
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                $('#ui_button_<?php echo $block->id; ?>').ui_button({
        ...
        ob_start();
        ?>
        <button id="ui_button_<?php echo $block->id; ?>"  type="button" link-to-page="<?php echo $link_to_page ?>" class="block-item block-item-button btn btn-default <?php echo $class_button ?> <?php echo $pull_right ?>" name="<?php echo $name ?>" data-block-id="<?php echo $block->id ?>" data-block-parent-id="<?php echo $block->parent_id ?>"  element-type="<?php echo $block->type ?>">
            <?php if($icon_left){ ?>
