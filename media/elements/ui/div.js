    ...
    element_ui_div={
        init_ui_div:function(){
          if(enableEditWebsite)
          {
              ...
              element_ui_div.set_resizable($( '.control-element-div[enabled-resizable="true"]' ));
              element_ui_div.set_sortable_for_control($( '.control-element-div[enabled-sortable="true"]' ));
        ...
        unset_set_sortable:function(self){
            self.droppable( "destroy" );
        },
        set_resizable:function(self){
            self.resizable({

            });
        },
        set_sortable_for_control:function(self){
            self.sortable({
        ...
        on_off_sortable:function(self)
        {
            ...
            if(self.val()==1)
            {
                element_ui_div.set_sortable(block);
                block.attr('enabled-sortable',true);
            }else
            {
                element_ui_div.unset_set_sortable(block);
                block.attr('enabled-sortable',false);
            }
