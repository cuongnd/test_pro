...
(function ($) {
    ...
    // here we go!
    $.ui_banner_rotator = function (element, options) {
        ...
        plugin.init = function () {
            ...
            var slide_height=plugin.settings.slide_height;
            if($.isNumeric(slide_height))
            {
                slide_height=slide_height+'px';
            }
            option_slider={
                width:slide_width,
                height:slide_height
            }
            $element.css(option_slider);
            $element.find('div[u="slides"]').css(option_slider);


            //var options = { $AutoPlay: true };
            plugin.jssor_slider = new $JssorSlider$(element_id, plugin.settings);
    ...
    $.fn.ui_banner_rotator = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {
            // if plugin has not already been attached to the element
            if (undefined == $(this).data('ui_banner_rotator')) {
                var plugin = new $.ui_banner_rotator(this, options);
                $(this).data('ui_banner_rotator', plugin);
