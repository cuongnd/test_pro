...
<fieldset>
    <legend><?php echo JText::_('COM_VIRTUEMART_ADMIN_CFG_SHOP_PATH_UPLOAD_FILE') ?></legend>
    <div class="control-group">
					<span class="control-label hasTooltip">
						<?php echo JText::_('COM_VIRTUEMART_ADMIN_CFG_SHOP_PATH_UPLOAD_FILE') ?>
					</span>
        <div class="controls">
            <input type="text"  class="input-mini hasTooltip" title="<?php echo '<b>'.JText::_('COM_VIRTUEMART_ADMIN_CFG_SHOP_PATH_UPLOAD_FILE').'</b><br/ >'.JText::_('COM_VIRTUEMART_ADMIN_CFG_SHOP_PATH_UPLOAD_FILE') ?>" id="pathuploadfile" name="pathuploadfile" value="<?php echo VmConfig::get('pathuploadfile'); ?>" />
        </div>
    </div>
</fieldset>
