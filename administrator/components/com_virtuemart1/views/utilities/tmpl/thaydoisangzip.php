...
<form action="index.php" method="post" name="adminForm" id="adminForm">
    ...
    <div class="row-fluid" style="text-align: center">
        <input type="button"  class="btn" value="bat dau set bai viet" name="thaydoisangzip">

    </div>
    <div class="row-fuid">
        <span class="a_loading"></span>
        <div><span>list product da duoc thay doi sang zip </span><span class="respone"></span></div>
    </div>
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        $(document).on('click','input[name="thaydoisangzip"]',function(){
