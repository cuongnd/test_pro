		...
		<table class="table table-striped" id="itemList">
			<thead>
				<tr>
					...
					<th width="15%" class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'screen size', 'screensize', $listDirn, $listOrder); ?>
					</th>
			...
			?>
				<tr class="row<?php echo $i % 2; ?>" item-id="<?php echo $item->id?>" sortable-group-id="<?php echo $item->position?>">
					...
					<td class="has-context">
						<div class="pull-left">
							...
							<?php endif; ?>
							<?php if ($canEdit) : ?>
								<a class="quick-edit-title" href="<?php echo JRoute::_('index.php?option=com_modules&task=module.edit&id='.(int) $item->id); ?>">
					...
					<td class="small hidden-phone">
						<?php if ($item->screensize) : ?>
							<span class="label label-info">
								<?php echo $item->screensize; ?>
							</span>
						<?php else : ?>
							<span class="label">
								<?php echo JText::_('JNONE'); ?>
