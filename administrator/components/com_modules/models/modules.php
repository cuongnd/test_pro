...
class ModulesModelModules extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$screensize = $this->getUserStateFromRequest($this->context . '.filter.screensize', 'filter_screensize', '', 'string');
		$this->setState('filter.screensize', $screensize);
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.title, a.website_id,a.note, a.position,a.screensize, a.module, a.language,' .
		...
		$screensize = $this->getState('filter.screensize');
		if ($screensize)
		{
			$query->where('a.screensize = ' . $db->quote($screensize));
		}
		// Filter by website
        $website_id = $this->getState('filter.website_id');
		if ($website_id)
