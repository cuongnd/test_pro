 ...
 * @package		VirtueMart
 */
class TableCategory_websites extends VmTableXarray {
	...
	function __construct(&$db){
		parent::__construct('#__virtuemart_category_websites', 'id', $db);

		$this->setPrimaryKey('virtuemart_category_id');
		$this->setSecondaryKey('virtuemart_website_id');
		$this->setOrderable();

		$this->setTableShortCut('cw');
	}
