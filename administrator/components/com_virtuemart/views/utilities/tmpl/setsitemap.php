...
<form action="index.php" method="post" name="adminForm" id="adminForm">
    ...
    <div class="row-fluid" style="text-align: center">
        <input type="button"  class="btn" value="setsitemap" name="setsitemap">

    </div>
    <div class="row-fuid">
        <span class="a_loading"></span>
        <div><span>list setsitemap </span><span class="respone"></span></div>
    </div>
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        $(document).on('click','input[name="setsitemap"]',function(){
