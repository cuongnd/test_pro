...
<fieldset>
	...
	<div class="row-fluid">
		<table class="span6">
			...
			<?php echo VmHTML::row('input','COM_VIRTUEMART_CLASS_ICON','classicon',$this->category->classicon); ?>
            <?php $websiteList = '
			<select multiple name="websites[]" id="websites"  class="inputbox">
				<option value="0">'.JText::_('COM_VIRTUEMART_CATEGORY_ALL').'</option>
				'.$this->websiteList.'
			</select>';
            echo VmHTML::row('raw','COM_VIRTUEMART_CATEGORY_SHOW_IN_WEBSITE', $websiteList ); ?>
