...
class TourModelCountry extends JModelAdmin
{

    public function getTable($type = 'country', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.country', 'country', array('control' => 'jform', 'load_data' => $loadData));
