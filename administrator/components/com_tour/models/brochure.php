...
class TourModelBrochure extends JModelAdmin
{

    public function getTable($type = 'brochure', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.brochure', 'brochure', array('control' => 'jform', 'load_data' => $loadData));
