...
class TourModelTourtariff extends JModelAdmin
{

    public function getTable($type = 'tourtariff', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.tourtariff', 'tourtariff', array('control' => 'jform', 'load_data' => $loadData));
