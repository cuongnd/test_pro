...
class TourModelTourphoto extends JModelAdmin
{

    public function getTable($type = 'tourphotos', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.tourphoto', 'tourphoto', array('control' => 'jform', 'load_data' => $loadData));
