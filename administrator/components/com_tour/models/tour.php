...
class TourModelTour extends JModelAdmin
{

    public function getTable($type = 'tour', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.tour', 'tour', array('control' => 'jform', 'load_data' => $loadData));
    ...
    protected function loadFormData()
    {
        ...
        $this->preprocessData('com_tour.tour', $data);
