...
class TourModelHotelphoto extends JModelAdmin
{

    public function getTable($type = 'hotelphoto', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.hotelphoto', 'hotelphoto', array('control' => 'jform', 'load_data' => $loadData));
