...
class TourModelTourstyle extends JModelAdmin
{

    public function getTable($type = 'tourstyle', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.tourstyle', 'tourstyle', array('control' => 'jform', 'load_data' => $loadData));
