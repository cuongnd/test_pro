...
class TourModelCity extends JModelAdmin
{

    public function getTable($type = 'city', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.city', 'city', array('control' => 'jform', 'load_data' => $loadData));
