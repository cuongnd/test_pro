...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tour&task=tourtariffs.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'tourList', 'adminForm',
        strtolower($listDirn), $saveOrderingUrl);
}

?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=tourtariffs'); ?>" method="post" name="adminForm"
      id="adminForm">
            ...
            <div id="filter-bar" class="btn-toolbar">
                ...
                <div class="btn-group pull-right hidden-phone">
                    ...
                    <table class="table table-striped" id="tourList">
                        ...
                        <tr>
                            ...
                            <th class="datefrom">
                                <?php
                                echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURTARIFF_FILED_DATEFROM', 'a.datefrom', $listDirn, $listOrder);
                                ?>
                            </th>
                            <th width="25%" class="dateto">
                                <?php echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURTARIFF_FILED_DATETO', 'a.dateto', $listDirn, $listOrder); ?>
                            </th>
                            <th width="1%" class="nowrap center">
                                <?php echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURTARIFF_FILED_ID', 'a.id', $listDirn, $listOrder); ?>
                            </th>
                        </tr>
                        </thead>
                        <tfoot>
				...
				<i class="icon-menu"></i>
                            ...
                            <td class="nowrap has-context"><a
                                    href="<?php echo JRoute::_('index.php?option=com_tour&task=tourtariff.edit&id=' . ( int )$item->id);?>">
                                    <?php echo $this->escape($item->dateto); ?></a></td>
                            <td>
                                <?php echo $this->escape($item->datefrom); ?>
                            </td>
                            <td class="center">
