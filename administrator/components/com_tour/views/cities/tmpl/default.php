...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tour&task=touractivities.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'tourList', 'adminForm',
        strtolower($listDirn), $saveOrderingUrl);
}

?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=cities'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="name">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_CITY_FILED_NAME', 'a.name', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="gallery">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_CITY_FILED_GALLERY', 'a.gallery', $listDirn, $listOrder);
                        ?>
                    </th>
				...
				<i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                href="<?php echo JRoute::_('index.php?option=com_tour&task=city.edit&id=' . ( int )$item->id);?>">
                                <?php echo $this->escape($item->name); ?></a></td>

                        <td>
                            <button type="button" class="btn btn-default"><a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=galleries&city_id=<?php echo $item->id; ?>">List</a></button>
                            <button type="button" class="btn btn-default"><a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=gallery&layout=edit&city_id=<?php echo $item->id; ?>">Add</a></button>
                        </td>
