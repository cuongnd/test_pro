...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tour&task=hotels.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'tourList', 'adminForm',
        strtolower($listDirn), $saveOrderingUrl);
}

?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=hotels'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="name">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURSTYLE_FILED_NAME', 'a.name', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="title">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_HOTEL_FILED_TITLE', 'a.title', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="city">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_HOTEL_FILED_IDCITY', 'a.idcity', $listDirn, $listOrder);
                        ?>
                    </th>
                    <th class="photo">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_HOTEL_FILED_IDPHOTO', 'a.idphotos', $listDirn, $listOrder);
                        ?>
                    </th>


                    <th width="1%" class="nowrap center hidden-phone">
                        <?php echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_HOTEL_FILED_ID', 'a.id', $listDirn, $listOrder); ?>
                    </th>
                </tr>
                </thead>
                <tfoot>
				...
				<i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                href="<?php echo JRoute::_('index.php?option=com_tour&task=hotel.edit&id=' . ( int )$item->id);?>">
                        ...
                        <td>
                            <?php echo $this->escape($item->idcity); ?>
                        </td>
                        <td>
                            <?php echo $this->escape($item->idphotos); ?>
                        </td>
                        <td class="center hidden-phone">
