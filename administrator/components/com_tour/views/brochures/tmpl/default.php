...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=brochures'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="name">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_BROCHURE_FILED_NAME', 'a.name', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="id_hotel">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_BROCHURE_FILED_EMAIL', 'a.email', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th width="1%" class="nowrap center ">
                        <?php echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_BROCHURE_FILED_ID', 'a.id', $listDirn, $listOrder); ?>
                    </th>
                </tr>
                </thead>
                <tfoot>
