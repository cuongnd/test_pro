...
?>
<form
    action="<?php echo JRoute::_('index.php?option=com_tour&&view=hotel&layout=edit&id='.(int) $this->item->id); ?>"
    ...
    <div class="row-fluid">
        <div class="span10 form-horizontal">
            <fieldset>
                ...
                <?php echo $this->form->renderField('facility'); ?>
                <?php echo $this->form->renderField('note'); ?>
                <?php echo $this->form->renderField('idcity'); ?>
