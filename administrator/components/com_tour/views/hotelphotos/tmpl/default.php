...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=hotelphotos'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="name">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_HOTELPHOTO_FILED_NAME', 'a.name', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="id_hotel">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_HOTELPHOTO_FILED_IDHOTEL', 'a.id_hotel', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th width="1%" class="nowrap center ">
                        <?php echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_HOTELPHOTO_FILED_ID', 'a.id', $listDirn, $listOrder); ?>
                    </th>
                </tr>
                </thead>
                <tfoot>
                ...
                <i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                href="<?php echo JRoute::_('index.php?option=com_tour&task=hotelphoto.edit&id=' . ( int )$item->id);?>">
                                <?php echo $this->escape($item->name); ?></a></td>


                        <td>
                            <?php echo $this->escape($item->id_hotel); ?>
                        </td>
