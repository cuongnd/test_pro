...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tour&task=countries.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'tourList', 'adminForm',
        strtolower($listDirn), $saveOrderingUrl);
}

?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=countries'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="name">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_COUNTRY_FILED_NAME', 'a.name', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="title">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_COUNTRY_FILED_CODE', 'a.code', $listDirn, $listOrder);
                        ?>
                    </th>
				...
				<i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                href="<?php echo JRoute::_('index.php?option=com_tour&task=country.edit&id=' . ( int )$item->id);?>">
