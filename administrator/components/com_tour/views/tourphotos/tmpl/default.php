...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=tourphotos'); ?>" method="post" name="adminForm"
      id="adminForm">
            ...
            <table class="table table-striped" id="tourList">
				...
				<i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                href="<?php echo JRoute::_('index.php?option=com_tour&task=tourphoto.edit&id=' . ( int )$item->id);?>">
