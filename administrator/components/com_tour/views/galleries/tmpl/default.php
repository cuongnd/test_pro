...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=galleries'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="status">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_GALLERY_FILED_STATE', 'a.status', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="title">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_GALLERY_FILED_TITLE', 'a.title', $listDirn, $listOrder);
                        ?>
                    </th>
                    <th class="title">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_GALLERY_FILED_PATH', 'a.path', $listDirn, $listOrder);
                        ?>
                    </th>
				...
				<i class="icon-menu"></i>
                        ...
                        <td>
                           <img src="<?php echo JUri::root().'/'.$item->path;?>" width="150px"/>
                        </td>
