...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_tour&task=tourstyles.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'tourList', 'adminForm',
        strtolower($listDirn), $saveOrderingUrl);
}

?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=tourstyles'); ?>" method="post" name="adminForm"
      id="adminForm">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="image" width="5%">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURSTYLE_FILED_IMAGE', 'a.image', $listDirn, $listOrder);
                        ?>
                    </th>
				...
				<i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                href="<?php echo JRoute::_('index.php?option=com_tour&task=tourstyle.edit&id=' . ( int )$item->id);?>">
