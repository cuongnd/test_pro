...
?>
<form action="<?php echo JRoute::_('index.php?option=com_tour&view=touractivities'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="name">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURPHOTO_FILED_TITLE', 'a.title', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="title">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURPHOTO_FILED_IDTOUR', 'a.idtour', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="image" width="5%">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURPHOTO_FILED_IMAGE', 'a.image', $listDirn, $listOrder);
                        ?>
                    </th>
				...
				<i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                href="<?php echo JRoute::_('index.php?option=com_tour&task=touractivity.edit&id=' . ( int )$item->id);?>">
                                <?php echo $this->escape($item->title); ?></a></td>
                        <td>
                            <?php echo $this->escape($item->idtour); ?>
                        </td>

                        <td>
                            <img src="<?php echo JUri::root(). $item->image; ?>" width="50px"/>
                        </td>
                        <td class="center hidden-phone">
