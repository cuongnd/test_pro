...
class iJoomla_SeoControllerArticles extends iJoomla_SeoController{
	
	function __construct() {	  
		parent::__construct();
		// Register Extra tasks		
		$this->registerTask('', 'articles');
	...
	function genMetadesc(){
		...
		$link = "index.php?option=com_ijoomla_seo&controller=articles".$and;
	...
	function save(){		
		...
		if($task == "apply"){
			$link = "index.php?option=com_ijoomla_seo&controller=articles";
		}
		elseif($task == "save"){
