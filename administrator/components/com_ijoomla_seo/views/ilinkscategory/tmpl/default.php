...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<div class="seo-head-line-title">
		<div class="row-fluid">
        	<div class="span6">
            	<span class="title_page"><?php echo JText::_("COM_IJOOMLA_SEO_INTERNAL_CATEGORY_MANAGER"); ?></span>
            </div>
	...
	<table class="adminlist" cellpadding="0" cellspacing="0" border="0" width="100%">            
		...
		?>
			...
			?>
                ...
                <td>
					<a href="index.php?option=com_ijoomla_seo&controller=newilinkscategory&task=edit&id=<?php echo $item->id; ?>"><?php echo $item->name; ?></a>
				</td>
                <td>
	...
	<input type="hidden" name="controller" value="ilinkscategory" />
