...
if (count($item)) {
	$part_link = JURI::root()."index.php?option=com_kunena&view=category&catid=";
}
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="adminlist">
		...
		$limistart	= $app->getUserStateFromRequest('com_ijoomla_seo.kunena'.'.list.start', 'limitstart');
		$limit		= $app->getUserStateFromRequest('com_ijoomla_seo.kunena'.'.list.limit', 'limit');
		$k = $limistart+1;
	...
	<input type="hidden" name="controller" value="kunena" />
