...
<form class="form-horizontal" action="index.php" method="post" name="adminForm" id="adminForm">
    ...
    <?php
		if(intval($id) != "0"){
			echo "<h2>".JText::_("COM_IJOOMLA_SEO_REDIRECT_MANAGER")."&nbsp;:Edit&nbsp;[&nbsp;<small>".$name."</small>&nbsp;]"."</h2>";
		}
		else{
			echo "<h2>".JText::_("COM_IJOOMLA_SEO_REDIRECT_MANAGER").":&nbsp;New"."</h2>";
		}
	?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
			...
			<?php
                echo JHTML::tooltip(
                    JText::_("COM_IJOOMLA_SEO_SEO_TOOLTIP_NAME_REDIRECT_CATEG"), 
                    "",
