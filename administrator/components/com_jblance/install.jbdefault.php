...
function defaultConfigs(){
	...
	if(!$db->loadResult()){
		$query = "
				INSERT INTO `#__jblance_config` VALUES ('1', '{\"welcomeTitle\":\"Welcome to JoomBri!\",\"currencySymbol\":\"$\",\"currencyCode\":\"USD\",\"dateFormat\":\"d-m-Y\",\"theme\":\"styleGR.css\",\"termArticleId\":\"1\",\"rssLimit\":\"10\",\"showRss\":\"1\",\"showJoombriCredit\":\"0\",\"reviewProjects\":\"0\",\"enableAddThis\":\"1\",\"addThisPubid\":\"\",\"showFeedsDashboard\":\"1\",\"feedLimitDashboard\":\"10\",\"enableReporting\":\"1\",\"maxReport\":\"25\",\"enableGuestReporting\":\"0\",\"reportCategory\":\"Posting contact information;Fake project\\/information posted;Obscenities or harassing behaviour;Other\",\"mailFromName\":\"Freelance Support\",\"mailFromAddress\":\"support@mysite.com\",\"invoiceDetails\":\"#123, My Address,<br\\/>City,<br\\/>Country<br\\/>My Tax No:123456\",\"invoiceFormatDeposit\":\"FD-[YYYY]-[ID]\",\"invoiceFormatPlan\":\"MP-[YYYY]-[ID]\",\"invoiceFormatWithdraw\":\"WF-[YYYY]-[ID]\",\"fundDepositMin\":\"0.5\",\"withdrawMin\":\"25\",\"taxName\":\"VAT\",\"taxPercent\":\"12.5\",\"checkFund\":\"1\",\"enableEscrowPayment\":\"1\",\"enableWithdrawFund\":\"1\",\"projectFileType\":\"image\\/jpeg,image\\/gif,image\\/png,image\\/x-png,application\\/msword,application\\/excel,application\\/pdf,text\\/plain,application\\/x-z,application\\/octet-stream,application\\/vnd.ms-excel\",\"projectFileText\":\"jpg, gif, word, excel, pdf, zip\",\"projectMaxsize\":\"500\",\"projectMaxfileCount\":\"3\",\"imgFileType\":\"image\\/jpeg,image\\/pjpeg,image\\/gif,image\\/png,image\\/x-png,image\\/bmp,image\\/ico\",\"imgWidth\":\"300\",\"imgHeight\":\"200\",\"imgMaxsize\":\"200\",\"integrationProfile\":\"joombri\",\"integrationAvatar\":\"joombri\"}');
				";
		$db->setQuery($query);
		$db->execute();
	}
...
function defaultCustomFields(){
	...
	if(!$db->loadResult()){
		$query = "
				...
				('1', 'Basic Information', '', 'inputbox', 'left-to-right', '0', 'COM_JBLANCE_', '', '1', '0', '1', '1', '', 'group', 'profile', 'custom', '0'),
				('2', 'Gender', 'Male;\r\nFemale', '', 'left-to-right', '1', 'COM_JBLANCE_', '', '2', '0', '1', '1', null, 'Radio', 'profile', 'custom', '0'),
				('3', 'About Me', '', '', 'left-to-right', '1', 'COM_JBLANCE_', '', '1', '0', '1', '1', null, 'Textarea', 'profile', 'custom', '0'),
				('4', 'Contact Information', '', '', 'left-to-right', '0', 'COM_JBLANCE_', null, '2', '0', '1', '1', '', 'group', 'profile', 'custom', '0'),
				('5', 'Address', '', '', 'left-to-right', '4', 'COM_JBLANCE_', '', '1', '0', '1', '1', null, 'Textarea', 'profile', 'custom', '0'),
				('6', 'Location', '', '', 'left-to-right', '4', 'COM_JBLANCE_', '', '2', '0', '1', '1', null, 'Textbox', 'profile', 'custom', '0'),
				('7', 'Postal Code', '', '', 'left-to-right', '4', 'COM_JBLANCE_', '', '3', '0', '1', '1', null, 'Textbox', 'profile', 'custom', '0'),
				('8', 'Phone', '', '', 'left-to-right', '4', 'COM_JBLANCE_', '', '4', '0', '1', '1', null, 'Textbox', 'profile', 'custom', '0');
				";
		$db->setQuery($query);
		$db->execute();
	}
...
function defaultPaymentModes(){
	...
	if(!$db->loadResult()){
		$query = "
				...
				('1', 'Bank Transfer', '1', '1', 'BT', 'banktransfer', '0', '0', null, '15', '0', '{\"btAccnum\":\"000123456789\",\"btBankname\":\"My Bank Name\",\"btAccHoldername\":\"My Name\",\"btIBAN\":\"\",\"btSWIFT\":\"\",\"btNotifyEmail\":\"notify@mysite.com\",\"btNotifyFaxno\":\"+1 2345678910\"}'),
...
function defaultPlans(){
	...
	if(!$db->loadResult()){
		$query = "
				...
				('1', 'Free Membership', '15', 'days', '0', '0', '1', '0', '1', '1', '1', '', '5', '', 'Thank you subscribing to this plan.', '{\"portfolioCount\":\"3\",\"buyFeeAmtPerProject\":\"0\",\"buyFeePercentPerProject\":\"0\",\"buyChargePerProject\":\"0\",\"buyFeePerFeaturedProject\":\"0\",\"buyFeePerUrgentProject\":\"0\",\"buyFeePerPrivateProject\":\"0\",\"buyFeePerSealedProject\":\"0\",\"buyFeePerNDAProject\":\"0\",\"flFeeAmtPerProject\":\"5\",\"flFeePercentPerProject\":\"10\",\"flChargePerBid\":\"5\"}', '1', '1', '0', '0'),
				('2', 'Paid Membership', '3', 'months', '25', '5', '1', '0', '2', '0', '1', '', '10', '', 'Thank you subscribing to this plan.', '{\"portfolioCount\":\"5\",\"buyFeeAmtPerProject\":\"0\",\"buyFeePercentPerProject\":\"0\",\"buyChargePerProject\":\"0\",\"buyFeePerFeaturedProject\":\"0\",\"buyFeePerUrgentProject\":\"0\",\"buyFeePerPrivateProject\":\"0\",\"buyFeePerSealedProject\":\"0\",\"buyFeePerNDAProject\":\"0\",\"flFeeAmtPerProject\":\"3\",\"flFeePercentPerProject\":\"3\",\"flChargePerBid\":\"3\"}', '1', '0', '0', '0'),
				('3', 'Free Membership', '15', 'days', '0', '0', '1', '0', '3', '1', '1', '', '5', '', 'Thank you subscribing to this plan.', '{\"portfolioCount\":\"3\",\"buyFeeAmtPerProject\":\"5\",\"buyFeePercentPerProject\":\"5\",\"buyChargePerProject\":\"5\",\"buyFeePerFeaturedProject\":\"25\",\"buyFeePerUrgentProject\":\"5\",\"buyFeePerPrivateProject\":\"5\",\"buyFeePerSealedProject\":\"5\",\"buyFeePerNDAProject\":\"15\",\"flFeeAmtPerProject\":\"0\",\"flFeePercentPerProject\":\"0\",\"flChargePerBid\":\"0\"}', '2', '1', '0', '0'),
				('4', 'Paid Membership', '3', 'months', '50', '10', '1', '0', '4', '5', '1', '', '25', '', 'Thank you subscribing to this plan.', '{\"portfolioCount\":\"5\",\"buyFeeAmtPerProject\":\"3\",\"buyFeePercentPerProject\":\"3\",\"buyChargePerProject\":\"3\",\"buyFeePerFeaturedProject\":\"15\",\"buyFeePerUrgentProject\":\"5\",\"buyFeePerPrivateProject\":\"5\",\"buyFeePerSealedProject\":\"5\",\"buyFeePerNDAProject\":\"10\",\"flFeeAmtPerProject\":\"0\",\"flFeePercentPerProject\":\"0\",\"flChargePerBid\":\"0\"}', '2', '0', '0', '0');
				";
		$db->setQuery($query);
		$db->execute();
	}
...
function upgrade103_104(){
	...
	$registry = new JRegistry;
	$registry->loadString($config->params);
	if(!$registry->get('checkFund')){
		$string = '{"checkFund":"1","enableAddThis":"1","addThisPubid":"","showFeedsDashboard":"1","feedLimitDashboard":"10","enableReporting":"1","maxReport":"25","enableGuestReporting":"0","reportCategory":"Posting contact information;Fake project\/information posted;Obscenities or harassing behaviour;Other"}';
		$registry->loadString($string);
