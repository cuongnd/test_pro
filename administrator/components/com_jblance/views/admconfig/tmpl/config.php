...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	...
	<div class="width-100">
		<fieldset class="adminform">
			...
			<table class="admintable">
				...
				<tr>
					<td class="key"><label for="name"><?php echo JText::_('COM_JBLANCE_THEME'); ?>:</label>
					</td>
					<td>
						<?php $list_theme = $model->getselectTheme('params[theme]', $this->params->theme);
						 echo $list_theme; ?>
					</td>
					<td width="50%">
						<?php echo JText::_('COM_JBLANCE_CHOOSE_DEFAULT_THEME_EXAMPLE'); ?>	
					</td>
				</tr>
				<tr>
		...
		<fieldset class="adminform">
			...
			<table class="admintable">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="params[invoiceFormatDeposit]" id="paramsInvoiceFormatDeposit" size="60" maxlength="100" value="<?php echo $this->params->invoiceFormatDeposit; ?>" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="params[invoiceFormatPlan]" id="paramsInvoiceFormatPlan" size="60" maxlength="100" value="<?php echo $this->params->invoiceFormatPlan; ?>" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="params[invoiceFormatWithdraw]" id="paramsInvoiceFormatWithdraw" size="60" maxlength="100" value="<?php echo $this->params->invoiceFormatWithdraw; ?>" />
					</td>
				</tr>
		    </table>
	...
	<div class="width-100">
		<fieldset class="adminform">
			...
			<table class="admintable">
				<tr>
					<td class="key"><label for="checkFund"><?php echo JText::_('COM_JBLANCE_CHECK_FUNDS'); ?>:</label>
					</td>
					<td>
						<fieldset class="radio">
							<?php $checkFund = $select->YesNoBool('params[checkFund]', $this->params->checkFund);
							echo  $checkFund; ?>
						</fieldset>
					</td>
					<td width="50%">
						<?php echo JText::_('COM_JBLANCE_CHECK_FUNDS_EXAMPLE'); ?>	
					</td>
				</tr>
				<tr>
	...
	<div class="width-100">
		<fieldset class="adminform">
			...
			<table class="admintable">
				<tr>
					<td class="key"><label for="name"><?php echo JText::_('COM_JBLANCE_ALLOW_IMAGE_TYPES'); ?>:</label>
					</td>
					<td>
						<textarea name="params[imgFileType]" id="paramsImgFileType" rows="6" cols="30"><?php echo $this->params->imgFileType; ?></textarea>
					</td>
					<td width="50%">
						<?php echo JText::_('COM_JBLANCE_ALLOW_IMAGE_TYPES_MESSAGE'); ?>	
					</td>
				</tr>
				<tr>
