			...
			<table class="admintable">
				...
				<tr>
					...
					<?php 
						...
						//$types = array('Textbox', 'Textarea', 'Radio', 'Checkbox', 'Select', 'Multiple Select', 'Location', 'URL', 'Email', 'Date');
				...
				<tr>
				 ...
				 <tr id="con_searchPage">
					<td class="key"><?php echo JText::_('COM_JBLANCE_SEARCH_PAGE'); ?>:</td>
					<td>
						<fieldset class="radio"><?php $searchPage = $select->YesNoBool('searchPage', $this->row->searchPage);
					    echo  $searchPage; ?>
						</fieldset>
					</td>
		        </tr>
