		...
		for ($i=0, $n=count($this->rows); $i < $n; $i++) {
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td style="text-align: right;">
					<?php echo number_format($row->total_fund, 2, '.', '');?>
				</td>
				<td>
					<a href="<?php echo $uurl; ?>" title="<?php echo JText::_('COM_JBLANCE_EDIT_USER_ACCOUNT'); ?>" onclick="<?php echo $onclick; ?>" ><?php echo $row->id;?></a>
				</td>					
			</tr>
			<?php
			$k = 1 - $k;
