					...
					<tr>
						...
						<td>
						 <?php
						  ...
						  <input type="checkbox" name=file-id[] value="<?php echo $projfile->id; ?>" style="float:none;" /> <?php echo $projfile->show_name; ?> 
						  <a href="<?php echo JBPROJECT_URL.$projfile->file_name; ?>" target="_blank"><img src="components/com_jblance/images/download.png" width="24" alt="Download" style="float:none;" title="<?php echo JText::_('COM_JBLANCE_DOWNLOAD'); ?>"/></a><br>
						  <?php	
						  }
						  ?>
						</td>
