		...
		<form action="index.php" method="post" id="adminForm" name="adminForm">
			...
			<div class="contentarea">
						...
						<tbody><?php
							if (count($rows) == 0) { ?>
								...
								for ($i = 0, $n = count($rows); $i < $n; $i++)
								{
									...
									$task = $row->published ? 'types_unpublish' : 'types_publish';
									...
									<tr>
										...
										<td>
											<a href="#types_edit"
											   onClick="return listItemTask('cb<?php echo $i;?>','types_edit')">
										...
										<td class="algcnt valgmdl" width="70"><a class="btn btn-<?php echo ($row->published ? 'success' : 'danger');?>" href="javascript:;" onclick="return listItemTask('cb<?php echo $i;?>','<?php echo $task;?>')" title="<?php echo $alt;?>"><i class="ico-<?php echo $img;?> ico-white"></i></a></td>
									</tr><?php
								} // for loop
							} // if ?>
						<tbody>
				...
				<div id="infobox">
					...
					<dl class="first">
						<dd class="title"><?php echo JText::_('INFO_TYPES_TITLE');?></dd>
						<dd class="last">
							<?php echo JText::_('INFO_TYPES_DESC');?>
                            <div class="btn-group">
