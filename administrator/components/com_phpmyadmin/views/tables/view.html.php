 ...
 * @since       1.6
 */
class phpMyAdminViewTables extends JViewLegacy
{
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::custom('tables.synchronous', 'featured.png', 'featured_f2.png', 'JFEATURED', true);
		JToolbarHelper::custom('tables.SynStructureAllTableLocalToServer', 'featured.png', 'featured_f2.png', 'synchronous Structure all  table local to server', true);
