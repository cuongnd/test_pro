...
//require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/display_import_functions.lib.php';
...
// Import functions
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/import.lib.php';
...
if (! empty($id_bookmark)) {
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/bookmark.lib.php';
    ...
    if ($compression === false) {
        ...
        case 'application/zip':
            if ($cfg['ZipDump'] && @function_exists('zip_open')) {
                 ...
                 */
                include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/zip_extension.lib.php';
