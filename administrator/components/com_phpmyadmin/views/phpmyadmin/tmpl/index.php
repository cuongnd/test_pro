 ...
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/display_git_revision.lib.php';
...
if ($server > 0 || count($cfg['Servers']) > 1
    ...
    if ($server > 0 && ! PMA_DRIZZLE) {
        include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/check_user_privileges.lib.php';
