 ...
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/display_change_password.lib.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/server_privileges.lib.php';
...
if ((isset($_REQUEST['viewing_mode']) && $_REQUEST['viewing_mode'] == 'server')
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/server_users.lib.php';
