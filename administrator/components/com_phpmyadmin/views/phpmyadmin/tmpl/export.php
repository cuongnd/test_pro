...
if (!defined('TESTSUITE')) {
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/common.inc.php';
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/zip.lib.php';
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugin_interface.lib.php';
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/export.lib.php';
