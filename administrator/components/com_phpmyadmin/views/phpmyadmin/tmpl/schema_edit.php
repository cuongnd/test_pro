...
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/db_common.inc.php';
require 'libraries/StorageEngine.class.php';

$active_page = 'db_operations.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/db_common.inc.php';
$url_query .= '&amp;goto=schema_edit.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/db_info.inc.php';
...
/**
 * Now in require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/relation.lib.php we check for all tables
...
if ($cfgRelation['pdfwork']) {
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/schema/User_Schema.class.php';
