                    ...
                    <?php foreach ($this->items as $key => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?> <?php echo (!$local_table_property||!$server_table_property)?' error ':'' ?>" sortable-group-id="<?php echo $item->catid; ?>">
                            ...
                            <?php if($local_table_property)foreach($local_table_property as $key=> $value){ ?>
                                <td class="center hidden-phone">
                                    <span title="<?php echo $value!=$server_table_property->$key?('server-'.$key.':'.$server_table_property->$key):'' ?>" class="<?php echo $value!=$server_table_property->$key?' text-error ':'' ?>"><?php echo $value ?></span>
                                </td>
                            <?php }else{
                                ?>
                                <td  colspan="<?php echo $countColumn ?>" class="center hidden-phone">
                            ...
                            <?php if($server_table_property)foreach($server_table_property as $key=> $value){ ?>
                                <td class="center hidden-phone">
                                    <span title="<?php echo $value!=$local_table_property->$key?('Local-'.$key.':'.$local_table_property->$key):'' ?>" class="<?php echo $value!=$local_table_property->$key?' text-error ':'' ?>"><?php echo $value ?></span>
                                </td>
                            <?php }else{ ?>
                                <td  colspan="<?php echo $countColumn ?>" class="center hidden-phone">
                                    ...
                                    <?php foreach($list_column as $key=>$properties){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span title="<?php echo $error?'Server:'.$properties->server->$property:''; ?>" class="<?php echo $error?' text-error ':'' ?>"><?php echo $valueProperty ?></span>
                                            </td>
                                            <?php }else{ ?>
                                            <td colspan="<?php echo $colSpan ?>"><?php echo JText::_('This field not exists') ?></td>
                                            <?php } ?>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                        ...
                                        <tr>
                                            <?php if(is_object($properties->server))foreach($properties->server as $property=>$valueProperty){ ?>
                                                <td>
                                                    ...
                                                    <span title="<?php echo $error?'Local:'.$properties->local->$property:''; ?>" class="<?php echo $error?' text-error ':'' ?>"><?php echo $valueProperty ?></span>
                                                </td>
                                            <?php }else{ ?>
                                                <td colspan="<?php echo $colSpan ?>"><?php echo JText::_('This field not exists') ?></td>
                                            <?php } ?>
