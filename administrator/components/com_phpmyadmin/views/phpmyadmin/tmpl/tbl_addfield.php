...
if (isset($_REQUEST['do_save_data'])) {
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/create_addfield.lib.php';

    list($result, $sql_query) = PMA_tryColumnCreationQuery($db, $table, $err_url);

    if ($result === true) {
        // If comments were sent, enable relation stuff
        include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/transformations.lib.php';
...
if ($abort == false) {
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/tbl_info.inc.php';
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/tbl_columns_definition_form.inc.php';
}
?>
