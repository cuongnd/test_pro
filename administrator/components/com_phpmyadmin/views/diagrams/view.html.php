 ...
 * @since       1.5
 */
class phpMyAdminViewDiagrams extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		{
			JToolbarHelper::addNew('diagram.add');
		}

		if ($canDo->get('diagram.edit'))
		{
			JToolbarHelper::editList('diagram.edit');
		}
		...
		{
			JToolbarHelper::trash('diagrams.trash');
		}
		...
		if (JFactory::getUser()->authorise('core.admin'))
		{
			JToolbarHelper::custom('diagrams.rebuild', 'refresh.png', 'refresh_f2.png', 'JToolbar_Rebuild', false);
		}
