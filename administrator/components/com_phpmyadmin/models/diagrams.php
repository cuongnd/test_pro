 ...
 * @since       1.6
 */
class phpMyAdminModelDiagrams extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	public  function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id ,a.website_id,a.issystem,a.title,a.data_png_image,  a.checked_out, a.checked_out_time,' .
					'  a.access, a.ordering'
			)
		)
			->from($db->quoteName('#__diagram') . ' AS a');
