...
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/ExportPlugin.class.php';
/* Get the table property class */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/export/TableProperty.class.php';
