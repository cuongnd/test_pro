...
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/ImportPlugin.class.php';
/* Get the ShapeFile class */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/bfShapeFiles/ShapeFile.lib.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/import/ShapeFile.class.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/import/ShapeRecord.class.php';
...
class ImportShp extends ImportPlugin
{
    ...
    public function doImport()
    {
        ...
        if (isset($gis_type)) {
            include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/gis/GIS_Factory.class.php';
