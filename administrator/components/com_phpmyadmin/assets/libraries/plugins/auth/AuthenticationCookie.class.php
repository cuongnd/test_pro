...
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/AuthenticationPlugin.class.php';
 ...
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/auth/swekey/swekey.auth.lib.php';
...
class AuthenticationCookie extends AuthenticationPlugin
{
    ...
    <a href="';
       ...
       <h1>';
        ...
        if (empty($GLOBALS['cfg']['Lang'])) {
            include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/display_select_lang.lib.php';
    ...
    <form method="post" action="index.php" name="login_form"' . $autocomplete .
        ...
        if (count($GLOBALS['cfg']['Servers']) > 1) {
            ...
            include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/select_server.lib.php';
    ...
    public function authCheck()
    {
        ...
        if (  !empty($GLOBALS['cfg']['CaptchaLoginPrivateKey'])
            ...
            if (  !empty($_POST["recaptcha_challenge_field"])
                ...
                include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/auth/recaptchalib.php';
