 ...
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/vendor_config.php';
...
class PMA_Config
{
    ...
    {
        $this->default_source = JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/config.default.php';
        $this->settings = array();
