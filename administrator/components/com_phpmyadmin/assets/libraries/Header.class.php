...
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Scripts.class.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/RecentFavoriteTable.class.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Menu.class.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/navigation/Navigation.class.php';
    ...
    public function getDisplay()
    {
        ...
        if (! $this->_headerIsSent) {
            if (! $this->_isAjax && $this->_isEnabled) {
                ...
                if ($this->_userprefsOfferImport) {
                    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/user_preferences.lib.php';
