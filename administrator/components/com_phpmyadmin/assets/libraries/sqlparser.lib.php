 ...
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/string.inc.php';

/**
 * Include data for the SQL Parser
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/sqlparser.data.php';

/**
 * Charset information
 */
if (!defined('TESTSUITE') && ! PMA_DRIZZLE) {
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/mysql_charsets.inc.php';
}
