...
class ConfigFile
{
    ...
    public function __construct(array $base_config = null)
    {
        ...
        include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/config.default.php';
        $cfg['fontsize'] = '82%';

        // load additional config information
        $cfg_db = &$this->_cfgDb;
        include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/config.values.php';
    ...
    public function getFilePath()
    {
        ...
        if (!defined('SETUP_CONFIG_FILE')) {
            include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/vendor_config.php';
        }
