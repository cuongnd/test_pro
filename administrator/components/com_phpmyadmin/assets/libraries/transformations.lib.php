...
function PMA_getAvailableMIMEtypes()
{
    ...
    $handle = opendir(JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/transformations');
...
function PMA_getTransformationDescription($file, $html_formatted = true)
{
    ...
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/transformations/' . $file;
