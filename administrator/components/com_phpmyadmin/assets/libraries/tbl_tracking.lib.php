...
{
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/relation.lib.php';
...
function PMA_exportAsSQLDump($entries)
{
    ...
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/sql_query_form.lib.php';
