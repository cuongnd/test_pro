    ...
    if ($GLOBALS['is_ajax_request']) {
        ...
        if (!function_exists('__')) {
            ...
            if (defined(GETTEXT_INC)) {
                ...
                include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/php-gettext/gettext.inc';
            }
        }
        ...
        include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/error.inc.php';
    }
