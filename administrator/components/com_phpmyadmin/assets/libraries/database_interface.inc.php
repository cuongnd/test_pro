...
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/DatabaseInterface.class.php';

if (defined('TESTSUITE')) {
    /**
     * For testsuite we use dummy driver which can fake some queries.
     */
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/dbi/DBIDummy.class.php';
    ...
    switch($extension) {
    case 'mysql' :
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/dbi/DBIMysql.class.php';
        $extension = new PMA_DBI_Mysql();
        break;
    case 'mysqli' :
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/dbi/DBIMysqli.class.php';
