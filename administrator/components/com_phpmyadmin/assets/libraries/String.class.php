...
class PMA_String
{
    ...
    public function __construct()
    {
        if (@function_exists('mb_strlen')) {
            ...
            include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/StringMB.class.php';
            $this->_byte = new PMA_StringMB();
        } else {
            include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/StringNative.class.php';
            $this->_byte = new PMA_StringNative();
        }

        if (@extension_loaded('ctype')) {
            include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/StringCType.class.php';
            $this->_type = new PMA_StringCType();
        } else {
            include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/StringNativeType.class.php';
