 ...
 */
define('GETTEXT_INC', JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/php-gettext/gettext.inc');
/**
 * Path to tcpdf.php file. Useful when you want to use system tcpdf,
 * eg. /usr/share/php/tcpdf/tcpdf.php.
 */
define('TCPDF_INC', JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/tcpdf/tcpdf.php');

/**
 * Path to the phpseclib. Useful when you want to use system phpseclib.
 */
define('PHPSECLIB_INC_DIR', JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/phpseclib/');
