...
function PMA_getForeigners($db, $table, $column = '', $source = 'both')
{
    ...
    if (($isInformationSchema || $is_data_dictionary)
        ...
        if ($isInformationSchema) {
            ...
            include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/information_schema_relations.lib.php';
        } else {
            $relations_key = 'data_dictionary_relations';
            include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/data_dictionary_relations.lib.php';
        }
