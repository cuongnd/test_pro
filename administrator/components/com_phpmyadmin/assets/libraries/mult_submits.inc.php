...
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/transformations.lib.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/bookmark.lib.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/sql.lib.php';
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/mult_submits.lib.php';
...
if (!empty($submit_mult) && !empty($what)) {
    ...
    if (strlen($table)) {
        include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/tbl_common.inc.php';
        $url_query .= '&amp;goto=tbl_sql.php&amp;back=tbl_sql.php';
        include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/tbl_info.inc.php';
    } elseif (strlen($db)) {
        include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/db_common.inc.php';
        include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/db_info.inc.php';
    } else {
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/server_common.inc.php';
    }
    ...
    if ($query_type == 'drop_db'
        ...
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/relation_cleanup.lib.php';
    }
    ...
    if ($use_sql) {
         ...
         */
        include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/parse_analyze.inc.php';
