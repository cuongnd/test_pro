 ...
 * the error handler
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Error_Handler.class.php';
 ...
 * core functions
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/core.lib.php';

/**
 * Input sanitizing
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/sanitizing.lib.php';
 ...
 * the PMA_Theme class
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Theme.class.php';

/**
 * the PMA_Theme_Manager class
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Theme_Manager.class.php';

/**
 * the PMA_Config class
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Config.class.php';

/**
 * the relation lib, tracker needs it
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/relation.lib.php';

/**
 * the PMA_Tracker class
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Tracker.class.php';

/**
 * the PMA_Table class
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Table.class.php';

/**
 * the PMA_Types class
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Types.class.php';

if (! defined('PMA_MINIMUM_COMMON')) {
    /**
     * common functions
     */
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Util.class.php';

    /**
     * JavaScript escaping.
     */
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/js_escape.lib.php';

    /**
     * Include URL/hidden inputs generating.
     */
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/url_generating.lib.php';

    /**
     * Used to generate the page
     */
    include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/Response.class.php';
}
 ...
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/session.inc.php';
...
if ($token_mismatch) {
     ...
     */
    include JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/cleanup.lib.php';
    /**
     * Do actual cleanup
     */
 ...
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/select_lang.lib.php';
...
if (! defined('PMA_MINIMUM_COMMON')) {
     ...
     */
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/charset_conversion.lib.php';

    /**
     * String handling
     */
    include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/string.inc.php';
    ...
    if (function_exists('mb_convert_encoding')
        ...
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/kanji-encoding.lib.php';
    } // end if
    ...
    if (! empty($cfg['Server'])) {
         ...
         */
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/database_interface.inc.php';

        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/logging.lib.php';
        ...
        if (! file_exists(
            JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/auth/'
        ...
        include_once  JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/plugins/auth/' . $auth_class . '.class.php';
        ...
        if (isset($cfg['Server']['AllowDeny'])
             ...
             */
            include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/ip_allow_deny.lib.php';
         ...
         * SQL Parser code
         */
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/sqlparser.lib.php';

        /**
         * the PMA_List_Database class
         */
        include_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/PMA.php';
        $pma = new PMA;
