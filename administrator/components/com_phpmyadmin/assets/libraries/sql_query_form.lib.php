 ...
 *
 */
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/file_listing.lib.php'; // used for file listing
require_once JPATH_ROOT.'/administrator/components/com_phpmyadmin/assets/libraries/bookmark.lib.php'; // used for bookmarks
