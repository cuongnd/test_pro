 ...
 * @since       1.6
 */
class phpMyAdminControllerDiagrams extends JControllerAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Diagram', $prefix = 'phpMyAdminModel', $config = array('ignore_request' => true))
	{
