...
<form name="adminForm" id="adminForm" class="esForm" action="index.php" method="post" data-table-grid>
	...
	<div class="row-fluid filter-bar">
		<div class="span12">
			<i class="icon-es-help mr-5"></i> <?php echo JText::_( 'COM_EASYSOCIAL_LANGUAGES_INFO_NOTE' ); ?> <a href="http://docs.stackideas.com/developers/translations/becoming_a_translator" class="btn btn-small btn-es-success ml-10"><?php echo JText::_( 'COM_EASYSOCIAL_START_CONTRIBUTING' ); ?></a>
		</div>
	</div>
