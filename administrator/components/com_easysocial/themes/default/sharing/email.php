...
<div class="row-fluid" data-sharing-email <?php if( !empty( $url ) ) { ?>data-token="<?php echo $url; ?>"<?php } ?>>
	...
	<div data-sharing-email-frame data-sharing-email-form class="es-sharing-form">
		<div class="control-group">
			...
			<div data-sharing-email-recipients class="controls">
				<input type="text" data-textboxlist-textField data-sharing-email-input class="full-width" />
				<p class="help-block small muted"><?php echo JText::_( 'COM_EASYSOCIAL_SHARING_EMAIL_INFO' ); ?>
			</div>
		</div>
		<div class="control-group mt-10">
			<label class="control-label"><?php echo JText::_( 'COM_EASYSOCIAL_SHARING_EMAIL_MESSAGE' ); ?></label>
			<div class="controls">
				<textarea data-sharing-email-content class="full-width"></textarea>
			</div>
		</div>
