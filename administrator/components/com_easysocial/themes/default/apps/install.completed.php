	...
	<div class="span4">
		...
		<div class="row-fluid">
			<div class="span12 widget-box">
				<h3 style="line-height: 15px;padding: 8px 0;">
					<img src="<?php echo $app->getIcon();?>" align="left" class="mr-5" />
					<span><?php echo JText::_( 'COM_EASYSOCIAL_APPS_APPLICATION_INFO' );?></span>
				</h3>
	...
	<div class="span8">
		...
		<div class="row-fluid">
			<div class="span12 widget-box">
				...
				<h3><?php echo JText::_( 'COM_EASYSOCIAL_APPS_INSTALL_COMPLETED_WIDGET_TITLE' );?></h3>
				...
				<?php } else { ?>
				<p>
					<?php echo JText::_( 'COM_EASYSOCIAL_APPS_INSTALL_INSTALLATION_COMPLETED_MESSAGE' ); ?>
				</p>
				<?php } ?>
