...
echo $settings->renderTabs(array(
	'general' => $settings->renderPage(
		$settings->renderColumn(
			$settings->renderSection(
				...
				$settings->renderSetting( 'Conversation Attachments', 'storage.conversations', 'list', $storageServices ),
	...
	'amazon' => $settings->renderPage(
		$settings->renderColumn(
			...
			$settings->renderSection(
				...
				$settings->renderSetting( 'Amazon access key', 'storage.amazon.access', 'input' , array( 'class' => 'input-full' , 'help' => true ) ),
				$settings->renderSetting( 'Amazon secret key', 'storage.amazon.secret', 'input' , array( 'class' => 'input-full' , 'help' => true ) ),
				$settings->renderSetting( 'Amazon bucket path', 'storage.amazon.bucket', 'input' , array( 'help' => true , 'class' => 'input-full' , 'unit' => true ) ),
				$settings->renderSetting( 'Amazon SSL', 'storage.amazon.ssl', 'boolean' , array( 'help' => true ) ),
				$settings->renderSetting( 'Amazon transfer limit', 'storage.amazon.limit', 'input' , array( 'help' => true , 'class' => 'input-mini center' , 'unit' => true ) ),
				$settings->renderSetting( 'Amazon storage region', 'storage.amazon.region', 'list', array( 'options' => $amazonRegion, 'help' => true ) ),
				$settings->renderSetting( 'Amazon storage class', 'storage.amazon.class', 'list', array( 'options' => $amazonClass, 'help' => true , 'info' => true ) )
			)
		)
	)
	...
	// 			$settings->renderSetting( 'Rackspace username', 'storage.rackspace.username', 'input' , array( 'class' => 'input-full' , 'help' => true )),
	// 			$settings->renderSetting( 'Rackspace access key', 'storage.rackspace.api', 'input' , array( 'class' => 'input-full' , 'help' => true ) ),
	// 			$settings->renderSetting( 'Rackspace CDN URL', 'storage.rackspace.url', 'input' , array( 'class' => 'input-full' , 'help' => true ) ),
	// 			$settings->renderSetting( 'Rackspace container', 'storage.rackspace.container', 'input' , array( 'class' => 'input-full' , 'help' => true ) )
	// 		)
	// 	)
	// )
));
