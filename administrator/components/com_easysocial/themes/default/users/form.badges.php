...
?>
<h3><?php echo JText::_( 'COM_EASYSOCIAL_USERS_ACHIEVEMENTS' ); ?></h3>
<hr />
...
<ul class="es-user-badges mb-20 mt-15">
	<?php if( $badges ){ ?>
		<?php foreach( $badges as $badge ){ ?>
			<li>
				...
				<div class="mt-5 small"><?php echo $badge->getAchievedDate()->format( 'jS M, Y' ); ?></div>
			</li>
		<?php } ?>
	<?php } ?>
	...
	<li class="empty">
		...
		<div class="small"><?php echo JText::_( 'COM_EASYSOCIAL_USERS_NO_BADGES_YET' ); ?></div>
	</li>
	<?php } ?>
</ul>
