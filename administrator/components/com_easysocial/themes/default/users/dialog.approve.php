...
<dialog>
	...
	<content>
		...
		<div class="footnote">
			<label for="sendConfirmationMail" class="small">
	...
	<buttons>
		...
		<button data-approve-button type="button" class="btn btn-es-primary"><?php echo JText::_('COM_EASYSOCIAL_APPROVE_BUTTON'); ?></button>
	</buttons>
</dialog>
