...
<dialog>
	...
	<content>
		<div class="row-fluid">
			...
			<div class="es-controls-row">
				<div class="span3">
					<label for="total" class="small"><?php echo JText::_( 'COM_EASYSOCIAL_USERS_SELECT_PROFILE' );?></label>
				</div>
			...
			<div>
				<span class="label label-important"><?php echo JText::_( 'COM_EASYSOCIAL_FOOTPRINT_IMPORTANT' );?></span>
	...
	<buttons>
		...
		<button data-submit-button type="button" class="btn btn-es-primary"><?php echo JText::_('COM_EASYSOCIAL_SWITCH_PROFILE_BUTTON'); ?></button>
	</buttons>
</dialog>
