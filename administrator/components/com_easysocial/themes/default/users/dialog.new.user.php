...
<dialog>
		...
		<div class="row-fluid">
			<form name="approveUser" method="post" action="index.php" data-users-assign-form>
				...
				<div class="es-controls-row">
					<div class="span3">
						<label for="profileId" class="small"><?php echo JText::_( 'COM_EASYSOCIAL_USERS_SELECT_USER_GROUP' );?></label>
					</div>
	...
	<buttons>
		...
		<button data-continue-button type="button" class="btn btn-es-primary"><?php echo JText::_( 'COM_EASYSOCIAL_CONTINUE_BUTTON' ); ?></button>
	</buttons>
</dialog>
