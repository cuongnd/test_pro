...
<dialog>
	...
	<content>
		<form name="rejectUser" method="post" action="index.php" data-users-reject-form>
			...
			<div class="mt-20">
				<label for="sendRejectEmail" class="small">
				...
				<label for="deleteUser" class="small">
	...
	<buttons>
		...
		<button data-reject-button type="button" class="btn btn-es-danger"><?php echo JText::_('COM_EASYSOCIAL_REJECT_BUTTON'); ?></button>
	</buttons>
</dialog>
