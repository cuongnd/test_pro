...
<dialog>
	...
	<content type="text"><?php echo JURI::root();?>administrator/index.php?option=com_easysocial&view=badges&tmpl=component&jscallback=assignBadge&callbackParams[]=<?php echo implode( '&callbackParams[]=' , $ids );?></content>
	<buttons>
