...
?>
<div class="row-fluid" data-edit-privacy>
	<div class="span6">
		<div class="span12 widget-box">
			<h3><?php echo JText::_( 'COM_EASYSOCIAL_PROFILES_PROFILE_PRIVACY_PANEL_TITLE' );?></h3>
			...
			<?php } else { ?>
				...
				<div class="es-controls-row small">
					<label class="checkbox" style="color:#000;">
						<input type="checkbox" value="1" name="privacyReset" style="float:left;margin-left:-20px;"/> <?php echo JText::_( 'COM_EASYSOCIAL_PRIVACY_RESET_ALL_USER_DESCRIPTION' ); ?>
					</label>
				</div>
				...
				<div class="es-controls-row">
					...
					<div class="es-controls-row privacyItem" data-privacy-item>
						<div class="span6">
						...
						<div class="span6">
							...
							<select class="full-width privacySelection" name="privacy[<?php echo $gKey;?>][<?php echo $rule;?>]" data-privacy-select >
							...
							>
								<div class="small mb-10"><?php echo JText::_('COM_EASYSOCIAL_PRIVACY_CUSTOM_DIALOG_NAME'); ?></div>
