...
class SocialRouterPoints extends SocialRouterAdapter
{
	...
	public function parse( &$segments )
	{
		...
		if( $total == 1 && $segments[ 0 ] == $this->translate( 'points' ) )
		{
			$vars[ 'view' ]	= 'points';
		...
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'points' ) && $segments[ 1 ] == $this->translate( 'points_layout_item' ) )
		{
			$vars[ 'view' ]		= 'points';
			$vars[ 'layout' ]	= 'item';
			$vars[ 'id' ]		= $segments[ 2 ];
		...
		// URL: http://site.com/menus/points/item/ID-point-alias
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'points' ) && $segments[ 1 ] == $this->translate( 'points_layout_history' ) )
		{
			$vars[ 'view' ]		= 'points';
			$vars[ 'layout' ]	= 'history';
