...
class SocialRouterConversations extends SocialRouterAdapter
{
	...
	public function parse( &$segments )
	{
		...
		if( $total == 1 && $segments[ 0 ] == $this->translate( 'conversations' ) )
		{
		...
		if( $total == 2 && $segments[ 0 ] == $this->translate( 'conversations' ) && $segments[ 1 ] == $this->translate( 'conversations_layout_archives') )
		{
			$vars[ 'view' ]		= 'conversations';
		...
		if( $total == 2 && $segments[ 0 ] == $this->translate( 'conversations' ) && $segments[ 1 ] == $this->translate( 'conversations_layout_compose') )
		{
			$vars[ 'view' ]		= 'conversations';
			$vars[ 'layout' ]	= 'compose';
			return $vars;
		...
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'conversations' ) && $segments[ 1 ] == $this->translate( 'conversations_layout_read') )
		{
			$vars[ 'view' ]		= 'conversations';
			$vars[ 'layout' ]	= 'read';
			$vars[ 'id' ]		= $segments[ 2 ];
		...
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'conversations' ) && $segments[ 1 ] == $this->translate( 'conversations_layout_download') )
		{
			$vars[ 'view' ]		= 'conversations';
		...
		// URL: http://site.com/menu/conversations/download/ID
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'conversations' ) && $segments[ 1 ] == $this->translate( 'conversations_layout_preview') )
		{
			$vars[ 'view' ]		= 'conversations';
			$vars[ 'layout' ]	= 'preview';
			$vars[ 'fileid' ]		= $segments[ 2 ];
