...
class SocialRouterFriends extends SocialRouterAdapter
{
	...
	public function parse( &$segments )
	{
		...
		$filters 	= array( $this->translate( 'friends_filter_pending' ) , $this->translate( 'friends_filter_request' ) , $this->translate( 'friends_filter_suggest' ) );
		...
		if( $total == 2 && $segments[ 0 ] == $this->translate( 'friends' ) )
		{
			$vars[ 'view' ]		= 'friends';
