...
class SocialRouterRegistration extends SocialRouterAdapter
{
	...
	public function build( &$menu , &$query )
	{
		...
		if( !is_null( $layout ) )
		{
			$segments[]		= $this->translate( 'registration_layout_' . $layout );
			unset( $query[ 'layout' ] );
		}
	...
	public function parse( &$segments )
	{
		...
		if( $total == 1 && $segments[ 0 ] == $this->translate( 'registration' ) )
		{
		...
		if( $total == 2 && $segments[ 0 ] == $this->translate( 'registration' ) && $segments[ 1 ] == $this->translate( 'registration_layout_activation' ) )
		{
			$vars[ 'view' ]		= 'registration';
		...
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'registration' ) && $segments[ 1 ] == $this->translate( 'registration_layout_steps' ) )
		{
			$vars[ 'view' ]		= 'registration';
			$vars[ 'layout' ]	= 'steps';
		...
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'registration' ) && $segments[ 1 ] == $this->translate( 'registration_layout_oauthselectprofile' ) )
		{
			$vars[ 'view' ]		= 'registration';
		...
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'registration' ) && $segments[ 1 ] == $this->translate( 'registration_layout_completed' ) )
		{
			$vars[ 'view' ]		= 'registration';
		...
		// URL: http://site.com/menu/registration/completed/1
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'registration' ) && $segments[ 1 ] == $this->translate( 'registration_layout_oauthdialog' ) )
		{
			$vars[ 'view' ]		= 'registration';
		...
		// URL: http://site.com/menu/registration/completed/1
		if( $total == 3 && $segments[ 0 ] == $this->translate( 'registration' ) && $segments[ 1 ] == $this->translate( 'registration_layout_oauth' ) )
		{
			$vars[ 'view' ]		= 'registration';
			$vars[ 'layout' ]	= 'oauth';
			$vars[ 'client' ]	= $segments[ 2 ];
