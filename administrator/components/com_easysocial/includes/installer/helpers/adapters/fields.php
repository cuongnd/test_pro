...
/**
 * Installation library for fields. Handles most of the fields installation request here.not in
 *
 * @since	1.0
...
class SocialInstallerFields extends JObject
{
	...
	public function install()
	{
		...
		// Store it into the database once the installation is successful.
		$app 	= Foundry::table( 'App' );
		$app->load( array( 'element' => $element , 'group' => $group , 'type' => SOCIAL_APPS_TYPE_FIELDS ) );
