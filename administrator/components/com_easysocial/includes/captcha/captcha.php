 ...
 * <code>
 * <?php
 * $captcha = Foundry::get( 'Captcha' , 'Mollom' );
 * ?>
 * </code>
 *
 * @since	1.0
...
class SocialCaptcha 
{
	...
	{		
		...
		{
			Foundry::logError( __FILE__ , __LINE__ , 'CAPTCHA: Library file ' . $file . ' not found.' );
			return false;
		}
		...
		{
			Foundry::logError( __FILE__ , __LINE__ , 'CAPTCHA: Library class ' . $class . ' not found.' );
			return false;
		}
