...
class SocialConfig
{
	...
	public function load( $key )
	{
		...
		else
		{
			...
			{
				Foundry::logError( __FILE__ , __LINE__ , 'CONFIG: Configuration file ' . $default . ' not found.' );
			}
