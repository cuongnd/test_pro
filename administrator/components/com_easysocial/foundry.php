...
class FD31_FoundryCompiler_EasySocial extends FD31_FoundryCompiler_Foundry
{
	...
	public function getView( $name )
	{
		...
		JFactory::getLanguage()->load( 'com_easysocial' , JPATH_ROOT , 'en-GB');
		JFactory::getLanguage()->load( 'com_easysocial' , JPATH_ROOT . '/administrator' , 'en-GB' );
