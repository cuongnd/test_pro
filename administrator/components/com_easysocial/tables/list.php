	...
	implements ISocialIndexerTable
{
	...
	/**
	 * Returns the valid permalink for this list item.
	 */
	public function getPermalink()
	{
		return FRoute::_( 'index.php?option=com_easysocial&view=friends&listid=' . $this->id );
	}
