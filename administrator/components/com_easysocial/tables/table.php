...
Foundry::import( 'admin:/includes/privacy/privacy' );
...
class SocialTable extends JTable
{
	...
	public function getPrivacyHide()
	{
		...
		{
			// get from database.
			$privacyObj 	= Foundry::privacy( Foundry::user()->id );
	...
	{
		return Foundry::get( 'Parameter' , $params , $file )->render();
	}
	...
	public function toJSON()
	{
		...
		return Foundry::json()->encode( $result );
	}
