...
<form name="adminForm" id="adminForm" action="index.php" method="post"
	...
	<fieldset>
		...
		<div class="control-group">
			<label for="jscombine"
				   class="control-label"><?php echo JText::_('ATOOLS_LBL_SEOANDLINK_OPT_JSCOMBINE'); ?></label>
		...
		<div class="control-group">
			<label for="jsdelivery"
				   class="control-label"><?php echo JText::_('ATOOLS_LBL_SEOANDLINK_OPT_JSDELIVERY'); ?></label>
		...
		<div class="control-group">
			<label for="jsskip"
				   class="control-label"><?php echo JText::_('ATOOLS_LBL_SEOANDLINK_OPT_JSSKIP'); ?></label>

			<div class="controls">
				<textarea rows="5" cols="55" name="jsskip"
						  id="jsskip"><?php echo $this->salconfig['jsskip'] ?></textarea>
			</div>
		</div>
		...
		<div class="control-group">
			<label for="csscombine"
				   class="control-label"><?php echo JText::_('ATOOLS_LBL_SEOANDLINK_OPT_CSSCOMBINE'); ?></label>
		...
		<div class="control-group">
			<label for="cssdelivery"
				   class="control-label"><?php echo JText::_('ATOOLS_LBL_SEOANDLINK_OPT_CSSDELIVERY'); ?></label>
		...
		<div class="control-group">
			<label for="cssskip"
				   class="control-label"><?php echo JText::_('ATOOLS_LBL_SEOANDLINK_OPT_CSSSKIP'); ?></label>

			<div class="controls">
				<textarea rows="5" cols="55" name="cssskip"
						  id="jsskip"><?php echo $this->salconfig['cssskip'] ?></textarea>
			</div>
		</div>
	</fieldset>
