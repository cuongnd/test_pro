...
<optgroup title="Windows Central European" label="cp1250">
	...
	<option title="Central European (multilingual), case-insensitive" value="cp1250_general_ci">cp1250_general_ci
	</option>
...
<optgroup title="ISO 8859-2 Central European" label="latin2">
	...
	<option title="Central European (multilingual), case-insensitive" value="latin2_general_ci">latin2_general_ci
	</option>
...
<optgroup title="Mac West European" label="macroman">
	...
	<option title="West European (multilingual), case-insensitive" value="macroman_general_ci">macroman_general_ci
	</option>
</optgroup>
...
<optgroup title="UTF-8 Unicode" label="utf8">
	...
	<option selected="selected" title="Unicode (multilingual), case-insensitive" value="utf8_general_ci">
		utf8_general_ci
	</option>
