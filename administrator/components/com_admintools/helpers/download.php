...
/**
 * Downloads file over the Internet using cURL or fopen(),
 * taking care of making the target location writable.
 */
class AdmintoolsHelperDownload
{
	...
	private static function &getCURL($url, $fp = null, $nofollow = false)
	{
		...
		$ch = curl_init($url);
		@curl_setopt($ch, CURLOPT_CAINFO, JPATH_COMPONENT_ADMINISTRATOR . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'cacert.pem');
		...
		curl_setopt($ch, CURLOPT_USERAGENT, 'Admin Tools/2.0');
	...
	private static function &getFOPEN($url, $fp = null)
	{
		...
		if (function_exists('stream_context_create'))
		{
			...
			$httpopts = Array('user_agent' => 'Admin Tools/2.0');
