...
<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;ctrl=bounces" method="post" name="adminForm" id="adminForm" >
		...
		<table><tr><td>
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<td>
						<input type="text" style="width:160px" name="config[bounce_username]" value="<?php echo $this->escape(trim($this->config->get('bounce_username',''))); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
					...
					<td>
						<input type="password" autocomplete="off" style="width:160px" name="config[bounce_password]" value="<?php echo $this->escape(trim($this->config->get('bounce_password',''))); ?>" />
					</td>
				</tr>
				<tr>
					<td class="key">
