...
class JChatController extends JControllerLegacy {
	...
	function __construct($config = array()) {
		...
		$baseMethods = get_class_methods(get_class($reflectionClass->getParentClass()));
		...
		if (array_key_exists ( 'model_path', $config )) {
			...
			$this->addModelPath ( $this->basePath . DIRECTORY_SEPARATOR . 'models' );
		}
		...
		if (array_key_exists ( 'view_path', $config )) {
			...
			$this->setPath ( 'view', $this->basePath . DIRECTORY_SEPARATOR . 'views' );
		}
	}
}