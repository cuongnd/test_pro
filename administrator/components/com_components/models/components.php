 ...
 * @since       1.6
 */
class componentsModelcomponents extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_components');
	...
	protected function translate(&$items)
	{
		...
		{
			$source = JPATH_componentS . '/' . $item->folder . '/' . $item->element;
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id ,a.website_id,a.issystem, a.name,a.title, a.element, a.folder, a.checked_out, a.checked_out_time,' .
