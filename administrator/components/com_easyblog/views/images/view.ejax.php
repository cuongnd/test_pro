...
include_once( JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_easyblog' . DIRECTORY_SEPARATOR .'views' . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'view.ejax.php' );
