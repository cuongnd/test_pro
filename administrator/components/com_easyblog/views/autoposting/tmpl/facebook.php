...
{
	window.location.href 	= 'index.php?option=com_easyblog&view=autoposting&layout=facebook&step=<?php echo $this->step - 1;?>';
}
</script>
<?php } ?>
...
<div class="pa-15">
	...
	<h3 class="head-3"><?php echo JText::_( 'COM_EASYBLOG_AUTOPOST_FACEBOOK');?> - <?php echo JText::_( 'COM_EASYBLOG_AUTOPOST_STEP_' . $this->step ); ?></h3>
	<div class="clear"></div>
	<hr />
