...
<div class="row-fluid">
	<div class="span12">
			...
			<div id="sidebar">
				<div class="sidebar-nav">
					<ul id="submenu" class="nav nav-list">
						<li>
							<a href="index.php?option=com_easyblog&view=autoposting&layout=facebook&step=1"><?php echo JText::_( 'COM_EASYBLOG_AUTOPOST_FACEBOOK');?></a>
						</li>
						<li>
							<a href="index.php?option=com_easyblog&view=autoposting&layout=twitter&step=1"><?php echo JText::_( 'COM_EASYBLOG_AUTOPOST_TWITTER');?></a>
						</li>
						<li>
							<a href="index.php?option=com_easyblog&view=autoposting&layout=linkedin&step=1"><?php echo JText::_( 'COM_EASYBLOG_AUTOPOST_LINKEDIN');?></a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div id="j-main-container" class="span10">
			...
			<ul class="autoposting-p1 unstyled">
				<li>
					...
					<div>
						<a href="<?php echo JRoute::_( 'index.php?option=com_easyblog&view=autoposting&layout=facebook&step=1' );?>" class="btn btn-primary button social facebook"><?php echo JText::_( 'COM_EASYBLOG_SETUP_STEP_GUIDES' );?></a>
				...
				<li>
					...
					<div>
						<a href="<?php echo JRoute::_( 'index.php?option=com_easyblog&view=autoposting&layout=twitter&step=1' );?>" class="btn btn-primary button social twitter"><?php echo JText::_( 'COM_EASYBLOG_SETUP_STEP_GUIDES' );?></a>
						<span class="small"><?php echo JText::_( 'COM_EASYBLOG_OR' );?></span>
				...
				<li>
					...
					<div>
						<a href="<?php echo JRoute::_( 'index.php?option=com_easyblog&view=autoposting&layout=linkedin&step=1' );?>" class="btn btn-primary button social linkedin"><?php echo JText::_( 'COM_EASYBLOG_SETUP_STEP_GUIDES' );?></a>
						<span class="small"><?php echo JText::_( 'COM_EASYBLOG_OR' );?></span>
