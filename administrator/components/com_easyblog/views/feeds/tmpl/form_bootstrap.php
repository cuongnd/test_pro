...
<div class="row-fluid">
	...
	<div class="tabbable">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#feed-details" data-toggle="tab"><?php echo JText::_( 'COM_EASYBLOG_FEEDS_DETAILS' ); ?></a>
			</li>
			<li>
				<a href="#feed-publish" data-toggle="tab"><?php echo JText::_( 'COM_EASYBLOG_FEEDS_PUBLISHING_DETAILS' );?></a>
			</li>
		</ul>
	</div>
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="feed-details">
		...
		<div class="tab-pane" id="feed-publish">
			<table class="table table-striped">
				<tr>
					<td class="key">
