				...
				<tr>
					...
					<td valign="top">
						<div class="has-tip">
							...
							<div class="notice half-width"><?php echo JText::sprintf('COM_EASYBLOG_SETTINGS_SOCIALSHARE_SHARETHIS_PUBLISHERS_INSTRUCTIONS', 'http://stackideas.com/docs/easyblog/structure/settings-configuration-guide.html');?></div>
						</div>
					</td>
				</tr>
				</tbody>
