						...
						<div class="has-tip">
							...
							<div class="radio-wrap">
								<div>
									...
									<div style="margin-left: 25px; width: 450px;">
										<table>
											<tr>
												<td width="30%">
												...
												<td width="15%">
													<div>
														<input type="text" name="main_routing_order_bloggerstandalone" id="main_routing_order_bloggerstandalone" value="<?php echo $this->config->get('main_routing_order_bloggerstandalone' );?>" size="2" maxlength="1"/>
													</div>
												</td>
												<td width="25%">
													<div>
											...
											<tr>
												...
												<td>
													<div>
														<input type="text" name="main_routing_order_entry" id="main_routing_order_entry" value="<?php echo $this->config->get('main_routing_order_entry' );?>" size="2" maxlength="1" />
													</div>
												</td>
												<td>
													<div>
											...
											<tr>
												...
												<td>
													<div>
														<input type="text" name="main_routing_order_category" id="main_routing_order_category" value="<?php echo $this->config->get('main_routing_order_category' );?>" size="2" maxlength="1" />
													</div>
												</td>
												<td>
													<div>
											...
											<tr>
												...
												<td>
													<div>
														<input type="text" name="main_routing_order_blogger" id="main_routing_order_blogger" value="<?php echo $this->config->get('main_routing_order_blogger' );?>" size="2" maxlength="1" />
													</div>
												</td>
												<td>
													<div>
											...
											<tr>
												...
												<td>
													<div>
														<input type="text" name="main_routing_order_teamblog" id="main_routing_order_teamblog" value="<?php echo $this->config->get('main_routing_order_teamblog' );?>" size="2" maxlength="1" />
													</div>
												</td>
												<td>
													<div>
