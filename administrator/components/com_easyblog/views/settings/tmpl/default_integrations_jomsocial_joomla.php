...
<table class="noshow">
	<tr>
		<td width="50%" valign="top">
				...
				<tr>
					...
					<td valign="top">
						<div class="has-tip">
							...
							<span style="padding-left: 10px;line-height:28px;" class="small">
			...
			<p class="small"><?php echo JText::_( 'COM_EASYBLOG_SETTINGS_INTEGRATIONS_JOMSOCIAL_NOTIFICATIONS_DESC' ); ?></p>
			<table class="admintable" cellspacing="1">
				<tbody>
				<tr>
					<td width="300" class="key">
		...
		<td width="50%" valign="top">
			<fieldset class="adminform">
				...
				<p class="small"><?php echo JText::_( 'COM_EASYBLOG_SETTINGS_INTEGRATIONS_JOMSOCIAL_MEDIA_INFO' );?></p>
				<table class="admintable" cellspacing="1">
				<tr>
					<td width="300" class="key">
					<span class="editlinktip">
