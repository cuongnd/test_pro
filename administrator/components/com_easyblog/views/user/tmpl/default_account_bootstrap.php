...
<table  width="100%" class="table table-striped">
	<tr>
		<td class="key" width="20%"><span><?php echo JText::_('COM_EASYBLOG_ID'); ?></span></td>
		<td class="paramlist_value"><?php echo  $this->user->get('id'); ?></td>
	</tr>
	<tr>
		<td class="key"><span><?php echo JText::_('COM_EASYBLOG_BLOGGERS_EDIT_NAME'); ?></span></td>
	...
	<tr>
		<td class="key"><span><?php echo JText::_('COM_EASYBLOG_BLOGGERS_EDIT_USERNAME'); ?></span></td>
	...
	<tr>
		<td class="key"><span><?php echo JText::_('COM_EASYBLOG_BLOGGERS_EDIT_EMAIL'); ?></span></td>
	...
	<tr>
		<td class="key"><span><?php echo JText::_('COM_EASYBLOG_BLOGGERS_EDIT_NEW_PASSWORD'); ?></span></td>
	...
	<tr>
		<td class="key"><span><?php echo JText::_('COM_EASYBLOG_BLOGGERS_EDIT_VERIFY_PASSWORD'); ?></span></td>
	...
	<tr>
		<td valign="top" class="key"><span><?php echo JText::_( 'COM_EASYBLOG_BLOGGERS_EDIT_USER_GROUP' ); ?></span></td>
	...
	<tr>
		...
		<td>
			<?php echo $this->renderCheckbox( 'block' , $this->user->get( 'block' ) ); ?>
		</td>
	</tr>
	<tr>
		<td class="key"><span><?php echo JText::_('COM_EASYBLOG_BLOGGERS_EDIT_RECEIVE_SYSTEM_EMAILS'); ?></span></td>
		<td>
			<?php echo $this->renderCheckbox( 'sendEmail' , $this->user->get( 'sendEmail' ) ); ?>
		</td>
	</tr>
	<tr>
