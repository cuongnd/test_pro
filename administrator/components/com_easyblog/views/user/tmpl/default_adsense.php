...
<tr>
    ...
    <td class="paramlist_value">
		<select name="adsense_display">
			...
			<option value="beforecomments"<?php echo ($this->adsense->display == ' beforecomments')? 'selected="selected"' : ''; ?>><?php echo JText::_('COM_EASYBLOG_BEFORE_COMMENTS_OPTION'); ?></option>
    		<option value="userspecified"<?php echo ($this->adsense->display == 'userspecified')? ' selected="selected"' : ''; ?>><?php echo JText::_('COM_EASYBLOG_ADSENSE_USER_SPECIFIED'); ?></option>
		</select>
	</td>
</tr>
</table>	