			...
			<table class="table table-striped">
				<tr>
					<td width="25%" class="key">
						<label for="title"><?php echo JText::_('COM_EASYBLOG_COMMENTS_COMMENT_TITLE'); ?></label>
					</td>
				...
				<tr>
					<td class="key">
						<label for="name"><?php echo JText::_('COM_EASYBLOG_COMMENTS_COMMENT_AUTHOR_NAME'); ?></label>
					</td>
					<td>
				...
				<tr>
					<td class="key">
						<label for="email"><?php echo JText::_('COM_EASYBLOG_EMAIL'); ?></label>
					</td>
					<td valign="top">
				...
				<tr>
					<td class="key"><label for="url"><?php echo JText::_('COM_EASYBLOG_COMMENTS_COMMENT_AUTHOR_WEBSITE'); ?></label></td>
					<td valign="top">
				...
				<tr>
					<td class="key">
						<label for="comment"><?php echo JText::_('COM_EASYBLOG_COMMENTS_COMMENT'); ?></label><br />
					</td>
					<td valign="top">
