...
include_once( JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_easyblog' . DIRECTORY_SEPARATOR .'views' . DIRECTORY_SEPARATOR . 'media' . DIRECTORY_SEPARATOR . 'view.html.php' );
