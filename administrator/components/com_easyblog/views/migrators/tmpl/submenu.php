		...
		<div class="submenu-box">
			<div class="submenu-pad">
				<ul id="submenu" class="migrators">
					...
					<li><a id="wordpress"><?php echo JText::_( 'WordPress for Joomla!' ); ?></a></li>
					<li><a id="wordpressimport"><?php echo JText::_( 'WordPress XML Import' ); ?></a></li>
					<li><a id="k2"><?php echo JText::_( 'K2' ); ?></a></li>
					<li><a id="blogger"><?php echo JText::_( 'Blogger XML Import' ); ?></a></li>
