		...
		$(".tag-form")
			.implement(
				"EasyBlog.Controller.Tag.Form",
				{
					...
					tagLimit: <?php echo $this->config->get( 'max_tags_allowed' ); ?>,
	...
	<div class="tag-form">
		...
		<div class="tag-selection no-selection">
			...
			<div class="tag-selection-actions clearfix">
				...
				<span class="tag-limit"><span class="total-tags">0</span>/<span class="max-tags"><?php echo $this->config->get( 'max_tags_allowed' ); ?> <?php echo JText::_( 'COM_EASYBLOG_NUMBER_TAGS_ALLOWED' ); ?></span></span>
				<?php } ?>
			</div>
		</div>
	</div>
