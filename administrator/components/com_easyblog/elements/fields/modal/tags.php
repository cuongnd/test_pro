...
class JFormFieldModal_Tags extends JFormField
{
	...
	protected function getInput()
	{
		...
		if( !$this->value )
		{
			$value 	= JText::_( 'COM_EASYBLOG_SELECT_A_TAG' );
		}
		else
		{
		...
		<div class="button2-left">
			<div class="blank">
				<a rel="{handler: 'iframe', size: {x: 750, y: 475}}" href="<?php echo JRoute::_( 'index.php?option=com_easyblog&view=tags&tmpl=component&browse=1&browsefunction=insertTag' );?>" title="<?php echo JText::_( 'COM_EASYBLOG_SELECT_A_TAG'); ?>" class="modal">
