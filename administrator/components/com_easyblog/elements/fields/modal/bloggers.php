...
class JFormFieldModal_Bloggers extends JFormField
{
	...
	protected function getInput()
	{
		...
		if( !$this->value )
		{
			$value 	= JText::_( 'COM_EASYBLOG_SELECT_A_USER' );
		}
		else
		{
		...
		function insertBlogger( id , name )
		{
		...
		<div class="button2-left">
			<div class="blank">
				<a rel="{handler: 'iframe', size: {x: 750, y: 475}}" href="<?php echo JRoute::_( 'index.php?option=com_easyblog&view=users&tmpl=component&browse=1&browsefunction=insertBlogger' );?>" title="<?php echo JText::_( 'COM_EASYBLOG_SELECT_A_USER'); ?>" class="modal">
