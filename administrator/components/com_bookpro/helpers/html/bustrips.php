...
abstract class JHtmlBustrips
{
	...
	{
		$options = array();
		$options[] = JHtml::_('select.option', 'user', 'COM_BOOKPRO_OPTION_POSITION_USER_DEFINED');
		$options[] = JHtml::_('select.option', 'template', 'COM_BOOKPRO_OPTION_POSITION_TEMPLATE_DEFINED');
	...
	public static function state($value, $i, $enabled = true, $checkbox = 'cb')
	{
		...
		return JHtml::_('jgrid.state', $states, $value, $i, 'bustrips.', $enabled, true, $checkbox);
	}
	...
	public static function positions($clientId, $state = 1, $selectedPosition = '')
	{
		...
		$customGroupText = JText::_('COM_BOOKPRO_CUSTOM_POSITION');
