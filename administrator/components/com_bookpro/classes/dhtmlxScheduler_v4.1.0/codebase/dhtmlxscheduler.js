...
function getOffsetRect(e) {
    var t = e.getBoundingClientRect(), i = document.body, s = document.documentElement, n = window.pageYOffset || s.scrollTop || i.scrollTop, r = window.pageXOffset || s.scrollLeft || i.scrollLeft, a = s.clientTop || i.clientTop || 0, d = s.clientLeft || i.clientLeft || 0, o = t.top + n - a, l = t.left + r - d;
    return {top: Math.round(o), left: Math.round(l)}
}
...
window.dhtmlXScheduler = window.scheduler = {version: "4.1.0"}, window.dhtmlx || (dhtmlx = function (e) {
    ...
    if (window.name) {
        ...
        if (parent.dhtmlDragAndDrop) {
            ...
            i += 1 * n.split("_")[0], s += 1 * n.split("_")[1]
        }
        if (e)return i + "_" + s;
        this.fx = i, this.fy = s
    }
    ...
    "single" == s && (r = XPathResult.FIRST_ORDERED_NODE_TYPE);
    var a = [], d = t.evaluate(e, n, function () {
        return i
    }, r, null);
    if (r == XPathResult.FIRST_ORDERED_NODE_TYPE)return d.singleNodeValue;
    for (var o = d.iterateNext(); o;)a[a.length] = o, o = d.iterateNext();
    return a
    ...
    var i = e.replace(/[\/]+/gi, "/").split("/"), s = null, n = 1;
    if (!i.length)return [];
    if ("." == i[0])s = [t]; else {
        if ("" !== i[0])return [];
        s = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(i[n].replace(/\[[^\]]*\]/g, "")), n++
    }
    for (n; n < i.length; n++)s = this._getAllNamedChilds(s, i[n]);
    return -1 != i[n - 1].indexOf("[") && (s = this._filterXPath(s, i[n - 1])), s
    ...
    for (var s = 0; s < e.length; s++)for (var n = 0; n < e[s].childNodes.length; n++)_isKHTML ? e[s].childNodes[n].tagName && e[s].childNodes[n].tagName.toUpperCase() == t && (i[i.length] = e[s].childNodes[n]) : e[s].childNodes[n].tagName == t && (i[i.length] = e[s].childNodes[n]);
    return i
    ...
    function s(e, t, i) {
        var s = i ? i : e || "", n = "dhtmlx_" + s.toLowerCase().replace(/ /g, "_") + "_button";
    ...
    function r(t, i, n) {
        ...
        var a = "";
        if (t.width && (r.style.width = t.width), t.height && (r.style.height = t.height), t.title && (a += '<div class="dhtmlx_popup_title">' + t.title + "</div>"), a += '<div class="dhtmlx_popup_text"><span>' + (t.content ? "" : t.text) + '</span></div><div  class="dhtmlx_popup_controls">', i) {
            var d = t.ok || scheduler.locale.labels.message_ok;
            void 0 === d && (d = "OK"), a += s(d, !0, "ok")
        }
        if (n) {
            var o = t.cancel || scheduler.locale.labels.message_cancel;
            void 0 === o && (o = "Cancel"), a += s(o, !1, "cancel")
        }
        if (t.buttons)for (var l = 0; l < t.buttons.length; l++)a += s(t.buttons[l], l);
        if (a += "</div>", r.innerHTML = a, t.content) {
            var h = t.content;
            "string" == typeof h && (h = document.getElementById(h)), "none" == h.style.display && (h.style.display = ""), r.childNodes[t.title ? 1 : 0].appendChild(h)
        }
    ...
    function a(e, s, n) {
        var a = e.tagName ? e : r(e, s, n);
        e.hidden || i(!0), document.body.appendChild(a);
        var d = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - a.offsetWidth) / 2)), o = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - a.offsetHeight) / 2));
        return a.style.top = "top" == e.position ? "-3px" : o + "px", a.style.left = d + "px", a.onkeydown = t, a.focus(), e.hidden && dhtmlx.modalbox.hide(a), a
    }
    ...
    setTransactionMode: function (e, t) {
        ...
        if (!this._silent_mode) {
            ...
            n && "updated" == i && (i = n), t ? (this.set_invalid(e, !1), this.updatedRows[s] = e, this.obj.setUserData(e, this.action_param, i), this._in_progress[e] && (this._in_progress[e] = "wait")) : this.is_invalid(e) || (this.updatedRows.splice(s, 1), this.obj.setUserData(e, this.action_param, "")), t || this._clearUpdateFlag(e), this.markRow(e, t, i), t && this.autoUpdate && this.sendData(e)
        }
    }, _clearUpdateFlag: function () {
    }, markRow: function (e, t, i) {
        var s = "", n = this.is_invalid(e);
        if (n && (s = this.styles[n], t = !0), this.callEvent("onRowMark", [e, t, i, n]) && (s = this.styles[t ? i : "clear"] + s, this.obj[this._methods[0]](e, s), n && n.details)) {
            s += this.styles[n + "_cell"];
            for (var r = 0; r < n.details.length; r++)n.details[r] && this.obj[this._methods[1]](e, r, s)
        }
    }, getState: function (e) {
        ...
        var i = [], s = [];
        for (var n in e)e.hasOwnProperty(n) && (i.push(this.serialize_one(e[n], n + this.post_delim)), s.push(n));
        ...
        if ("string" == typeof e)return e;
        var i = [];
        for (var s in e)e.hasOwnProperty(s) && i.push(this.escape((t || "") + s) + "=" + this.escape(e[s]));
        return i.join("&")
        ...
        if (e) {
            ...
            var i = new dtmlXMLLoaderObject(this.afterUpdate, this, !0), s = this.serverProcessor + (this._user ? getUrlSymbol(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + this.obj.getUserData(0, "version")].join("&") : "");
            "POST" != this._tMode ? i.loadXML(s + (-1 != s.indexOf("?") ? "&" : "?") + this.serialize(e, t)) : i.loadXML(s, !0, this.serialize(e, t)), this._waitMode++
        }
        ...
        for (var e = {}, t = !1, i = 0; i < this.updatedRows.length; i++) {
            ...
            this._in_progress[s] || this.is_invalid(s) || this.callEvent("onBeforeUpdate", [s, this.getState(s)]) && (e[s] = this._getRowData(s, s + this.post_delim), t = !0, this._in_progress[s] = (new Date).valueOf())
        }
        return t ? e : null
        ...
        var n = e, r = "error" != i && "invalid" != i;
        if (r || this.set_invalid(e, i), this._uActions && this._uActions[i] && !this._uActions[i](s))return delete this._in_progress[n];
        ...
        switch (i) {
            ...
            case"delete":
            case"deleted":
                return this.obj.setUserData(e, this.action_param, "true_deleted"), this.obj[this._methods[3]](e), delete this._in_progress[n], this.callEvent("onAfterUpdate", [e, i, t, s])
        }
        "wait" != this._in_progress[n] ? (r && this.obj.setUserData(e, this.action_param, ""), delete this._in_progress[n]) : (delete this._in_progress[n], this.setUpdated(t, !0, this.obj.getUserData(e, this.action_param))), this.callEvent("onAfterUpdate", [a, i, t, s])
    }, afterUpdate: function (e, t, i, s, n) {
        if (n.getXMLTopNode("data"), n.xmlDoc.responseXML) {
            for (var r = n.doXPath("//data/action"), a = 0; a < r.length; a++) {
                var d = r[a], o = d.getAttribute("type"), l = d.getAttribute("sid"), h = d.getAttribute("tid");
        ...
        i = i.replace("editing=true&", ""), this.getUpdates(i, function () {
            ...
            if (i.length) {
                ...
                for (var s = 0; s < i.length; s++) {
                    var n = i[s].getAttribute("status"), r = i[s].getAttribute("id"), a = i[s].getAttribute("parent");
                    switch (n) {
                        case"inserted":
                            e.callEvent("insertCallback", [i[s], r, a]);
                            break;
                        case"updated":
                            e.callEvent("updateCallback", [i[s], r, a]);
                            break;
                        case"deleted":
                            e.callEvent("deleteCallback", [i[s], r, a])
                    }
                }
                e._silent_mode = !1
            }
    ...
    var e = function (e) {
        ...
        return this._connector_sorting = "&dhx_sort[" + i + "]=" + s, t.call(this, e)
    }, s = function (e, i, s) {
        for (var n = 0; n < i.length; n++)i[n] = "dhx_filter[" + i[n] + "]=" + encodeURIComponent(s[n]);
        return this._connector_filter = "&" + i.join("&"), t.call(this, e)
    };
    ...
    }), this.attachEvent("onBeforeSorting", function (e, t, s) {
        if ("connector" == t) {
            var n = this;
            return this.clearAndLoad(i.call(this, this.xmlFileUrl, e, s), function () {
                n.setSortImgState(!0, e, s)
            }), !1
        }
        return !0
    }), this.attachEvent("onFilterStart", function (e, t) {
        return this._con_f_used.length ? (this.clearAndLoad(s.call(this, this.xmlFileUrl, e, t)), !1) : !0
    }), this.attachEvent("onXLE", function (e, t, i, s) {
    ...
    if (!this._colls_loaded && this.cellType) {
        for (var t = [], i = 0; i < this.cellType.length; i++)(0 === this.cellType[i].indexOf("co") || 2 == this._con_f_used[i]) && t.push(i);
    ...
    if (this._parseHead_connector.apply(this, arguments), !this._colls_loaded) {
        for (var e = this.xmlLoader.doXPath("./coll_options", arguments[0]), t = 0; t < e.length; t++) {
            var i = e[t].getAttribute("for"), s = [], n = null;
            "combo" == this.cellType[i] && (n = this.getColumnCombo(i)), 0 === this.cellType[i].indexOf("co") && (n = this.getCombo(i));
            for (var r = this.xmlLoader.doXPath("./item", e[t]), a = 0; a < r.length; a++) {
                var d = r[a].getAttribute("value");
                if (n) {
                    var o = r[a].getAttribute("label") || d;
                    n.addOption ? n.addOption([[d, o]]) : n.put(d, o), s[s.length] = o
                } else s[s.length] = d
            }
            this._con_f_used[1 * i] && (this._con_f_used[1 * i] = s)
        }
    ...
    i[0].status && window.alert(i[0].responseText)
    ...
    var e = this._x = this._obj.clientWidth - this.xy.margin_left, t = this._y = this._obj.clientHeight - this.xy.margin_top, i = this._table_view ? 0 : this.xy.scale_width + this.xy.scroll_width, s = this._table_view ? -1 : this.xy.scale_width;
    ...
    var r = this.xy.scale_height + this.xy.nav_height + (this._quirks ? -2 : 0);
    this.set_xy(this._els.dhx_cal_data[0], e, t - (r + 2), 0, r + 2)
}, scheduler.set_xy = function (e, t, i, s, n) {
    e.style.width = Math.max(0, t) + "px", e.style.height = Math.max(0, i) + "px", arguments.length > 3 && (e.style.left = s + "px", e.style.top = n + "px")
}, scheduler.get_elements = function () {
    for (var e = this._obj.getElementsByTagName("DIV"), t = 0; t < e.length; t++) {
        var i = e[t].className || "", s = e[t].getAttribute("name") || "";
        i && (i = i.split(" ")[0]), this._els[i] || (this._els[i] = []), this._els[i].push(e[t]);
        var n = scheduler.locale.labels[s || i];
        "string" != typeof n && s && !e[t].innerHTML && (n = s.split("_")[0]), n && (e[t].innerHTML = n)
    }
    ...
    this._obj.onselectstart = function () {
        ...
        var t = e || event, i = t.target || t.srcElement, s = scheduler.callEvent("onContextMenu", [scheduler._locate_event(i), t]);
        return s
    }
    ...
    e || (e = s.start_date || Math.round(scheduler._currentDate().valueOf() / n) * n);
    var r = new Date(e);
    if (!t) {
        var a = this.config.first_hour;
        a > r.getHours() && (r.setHours(a), e = r.valueOf()), t = e.valueOf() + n
    }
    var d = new Date(t);
    r.valueOf() == d.valueOf() && d.setTime(d.valueOf() + n), s.start_date = s.start_date || r, s.end_date = s.end_date || d, s.text = s.text || this.locale.labels.new_event, s.id = this._drag_id = this.uid(), this._drag_mode = "new-size", this._loading = !0, this.addEvent(s), this.callEvent("onEventCreated", [this._drag_id, i]), this._loading = !1, this._drag_event = {}, this._on_mouse_up(i)
    ...
    if (t = t || e.target || e.srcElement, !this.config.readonly) {
        ...
        switch (i) {
            ...
            case"dhx_cal_container":
                return;
            default:
                var n = this["dblclick_" + i];
                if (n)n.call(this, e); else if (t.parentNode && t != this)return scheduler._on_dbl_click(e, t.parentNode)
        }
    }
    ...
    if (this._cols) {
        ...
        if (t = i ? e / i : 0, this._ignores)for (var s = 0; t >= s; s++)this._ignores[s] && t++
    }
    return t
    ...
    var t, i = document.body, s = document.documentElement;
    ...
    if (this._table_view) {
        ...
        var a = 0;
        for (a = 1; a < this._colsS.heights.length && !(this._colsS.heights[a] > t.y); a++);
        t.y = Math.ceil(24 * (Math.max(0, r) + 7 * Math.max(0, a - 1)) * 60 / this.config.time_step), (scheduler._drag_mode || "month" == this._mode) && (t.y = 24 * (Math.max(0, Math.ceil(r) - 1) + 7 * Math.max(0, a - 1)) * 60 / this.config.time_step), "move" == this._drag_mode && scheduler._ignores_detected && scheduler.config.preserve_length && (t._ignores = !0, this._drag_event._event_length || (this._drag_event._event_length = this._get_real_event_length(this._drag_event.start_date, this._drag_event.end_date, {
            x_step: 1,
            x_unit: "day"
        }))), t.x = 0
    ...
    if (this._drag_mode) {
        ...
        if (!this._drag_pos || t.force_redraw || this._drag_pos.x != t.x || this._drag_pos.y != t.y) {
            ...
            if (this._edit_id != this._drag_id && this._close_not_saved(), this._drag_pos = t, "create" == this._drag_mode) {
                ...
                var r = new Date(this._drag_start), a = new Date(s);
                "day" != this._mode && "week" != this._mode || r.getHours() != a.getHours() || r.getMinutes() != a.getMinutes() || (a = new Date(this._drag_start + 1e3)), this._drag_id = this.uid(), this.addEvent(r, a, this.locale.labels.new_event, this._drag_id, t.fields), this.callEvent("onEventCreated", [this._drag_id, e]), this._loading = !1, this._drag_mode = "new-size"
            }
            ...
            if ("move" == this._drag_mode)i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)), !t.custom && this._table_view && (i += 1e3 * this.date.time_part(o.start_date)), i = this._correct_shift(i), t._ignores && this.config.preserve_length && this._table_view ? (this.matrix && (d = this.matrix[this._mode]), d = d || {
                ...
                if (i = o.start_date.valueOf(), s = o.end_date.valueOf(), this._table_view) {
                    ...
                    if ("month" == this._mode)if (l = this._correct_shift(l, !1), this._drag_from_start) {
                        var h = 864e5;
                        l <= scheduler.date.date_part(new Date(s + h - 1)).valueOf() && (i = l - h)
                    } else s = l; else t.resize_from_start ? i = l : s = l
                ...
                } else i = this._drag_start; else i >= s && (s = i + 6e4 * this.config.time_step)
            }
            var c = new Date(s - 1), u = new Date(i);
            if (scheduler.config.limit_drag_out && (+u < +scheduler._min_date || +s > +scheduler._max_date)) {
                var f = s - u;
                +u < +scheduler._min_date ? (u = new Date(scheduler._min_date), s = new Date(+u + f)) : (s = new Date(scheduler._max_date), u = new Date(+s - f));
                var c = new Date(s - 1)
            }
            if (!this._table_view && (t.x != this._get_event_sday({
                ...
                var f = s - u, h = this._min_date.valueOf() + 24 * t.x * 60 * 6e4;
                s = scheduler.date.date_part(new Date(h)), s.setHours(this.config.last_hour), c = new Date(s - 1), "move" == this._drag_mode && (u = new Date(+s - f))
            }
            if (this._table_view || c.getDate() == u.getDate() && c.getHours() < this.config.last_hour || scheduler._allow_dnd)if (o.start_date = u, o.end_date = new Date(s), this.config.update_render) {
    ...
    if (2 != e.button && !this.config.readonly && !this._drag_mode) {
        ...
        if (this._drag_mode) {
            var s = this._locate_event(t);
            this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [s, this._drag_mode, e]) ? (this._drag_id = s, this._drag_event = scheduler._lame_clone(this.getEvent(this._drag_id) || {})) : this._drag_mode = this._drag_id = 0
        }
    ...
    var i = this._get_private_properties(e), s = this._get_private_properties(t);
    for (var n in s)i[n] || delete t[n]
    ...
    if (!e || 2 != e.button || !scheduler.config.touch) {
        if (this._drag_mode && this._drag_id) {
            ...
            if (this._drag_event._dhx_changed || !this._drag_event.start_date || t.start_date.valueOf() != this._drag_event.start_date.valueOf() || t.end_date.valueOf() != this._drag_event.end_date.valueOf()) {
                var i = "new-size" == this._drag_mode;
                if (this.callEvent("onBeforeEventChanged", [t, e, i, this._drag_event])) {
                    var s = this._drag_id, n = this._drag_mode;
                    if (this._drag_id = this._drag_mode = null, i && this.config.edit_on_create) {
                        if (this.unselect(), this._new_event = new Date, this._table_view || this.config.details_on_create || !this.config.select)return scheduler.callEvent("onDragEnd", [s, n, e]), this.showLightbox(s);
                        this._drag_pos = !0, this._select_id = this._edit_id = s
                    } else this._new_event || this.callEvent(i ? "onEventAdded" : "onEventChanged", [s, this.getEvent(s)])
                } else i ? this.deleteEvent(t.id, !0) : (this._drag_event._dhx_changed = !1, this._clear_temporary_properties(t, this._drag_event), scheduler._lame_copy(t, this._drag_event), this.updateEvent(t.id))
            }
    ...
    var r = this._els.dhx_cal_tab;
    if (r)for (var a = 0; a < r.length; a++) {
        var d = r[a].className;
        d = d.replace(/ active/g, ""), r[a].getAttribute("name") == this._mode + "_tab" && (d += " active"), r[a].className = d
    }
    ...
    "month" == this._mode && 0 === e && this.config.left_border && (n.className += " dhx_scale_bar_border", t += 1), this.set_xy(n, r, this.xy.scale_height - 2, t, 0), n.innerHTML = this.templates[this._mode + "_scale_date"](i, this._mode), s.appendChild(n)
    ...
    var s = e, n = this._get_columns_num(t, i);
    this._process_ignores(t, n, "day", 1);
    for (var r = n - this._ignores_detected, a = 0; n > a; a++)this._ignores[a] ? (this._cols[a] = 0, r++) : this._cols[a] = Math.floor(s / (r - a)), s -= this._cols[a], this._colsS[a] = (this._cols[a - 1] || 0) + (this._colsS[a - 1] || (this._table_view ? 0 : this.xy.scale_width + 2)), this._colsS.col_length = n;
    ...
    var i = new Date(scheduler._min_date), s = new Date(scheduler._max_date), n = this.date.date_part(scheduler._currentDate()), r = parseInt(e.style.width, 10), a = new Date(this._min_date), d = this._get_columns_num(i, s);
    this._calc_scale_sizes(r, i, s);
    var o = 0;
    e.innerHTML = "";
    for (var l = 0; d > l; l++) {
        if (this._ignores[l] || this._render_x_header(l, o, a, e), !this._table_view) {
            var h = document.createElement("DIV"), _ = "dhx_scale_holder";
            a.valueOf() == n.valueOf() && (_ = "dhx_scale_holder_now"), this._ignores_detected && this._ignores[l] && (_ += " dhx_scale_ignore"), h.className = _ + " " + this.templates.week_date_class(a, n), this._set_scale_col_size(h, this._cols[l], o), t.appendChild(h), this.callEvent("onScaleAdd", [h, a])
        }
        o += this._cols[l], a = this.date.add(a, 1, "day")
    }
    ...
    if (this.templates[this._mode + "_date"]) {
        ...
        t.className = "dhx_cal_data" + s, this._scales = {}, this._cols = [], this._colsS = {height: 0}, this._dy_shift = 0, this.set_sizes();
        var n, r, a = this._get_timeunit_start(), d = scheduler._get_view_end();
        if (n = r = this._table_view ? scheduler.date.week_start(a) : a, this._min_date = n, this._els.dhx_cal_date[0].innerHTML = this.templates[this._mode + "_date"](a, d, this._mode), this._max_date = d, scheduler._render_scales(e, t), this._table_view)this._reset_month_scale(t, a, r);
        else if (this._reset_hours_scale(t, a, r), i.multi_day) {
            var o = "dhx_multi_day";
    ...
    for (var i = new Date(1980, 1, 1, this.config.first_hour, 0, 0), s = 1 * this.config.first_hour; s < this.config.last_hour; s++) {
        ...
        var r = this.xy.scale_width;
        this.config.left_border && (r -= 1, n.className += " dhx_scale_hour_border"), n.style.width = r + "px", n.innerHTML = scheduler.templates.hour_scale(i), t.appendChild(n), i = this.date.add(i, 1, "hour")
    }
...
}, scheduler._process_ignores = function (e, t, i, s, n) {
    this._ignores = {}, this._ignores_detected = 0;
    var r = scheduler["ignore_" + this._mode];
    if (r)for (var a = new Date(e), d = 0; t > d; d++)r(a) && (this._ignores_detected += 1, this._ignores[d] = !0, n && t++), a = scheduler.date.add(a, s, i)
    ...
    var n = scheduler.date.add(t, 1, "month"), r = new Date(i), a = scheduler._currentDate();
    this.date.date_part(a), this.date.date_part(i);
    for (var d = Math.ceil(Math.round((n.valueOf() - i.valueOf()) / 864e5) / 7), o = [], l = 0; 7 >= l; l++) {
    ...
    for (var _ = 0, c = "<table cellpadding='0' cellspacing='0'>", u = [], l = 0; d > l; l++) {
        c += "<tr>";
        for (var f = Math.max(s(l) - scheduler.xy.month_head_height, 0), g = 0; 7 > g; g++) {
            c += "<td";
            var v = "";
            t > i ? v = "dhx_before" : i >= n ? v = "dhx_after" : i.valueOf() == a.valueOf() && (v = "dhx_now"), this._ignores_detected && this._ignores[g] && (v += " dhx_scale_ignore"), c += " class='" + v + " " + this.templates.month_date_class(i, a) + "' >";
            var m = "dhx_month_body", p = "dhx_month_head";
            0 === g && this.config.left_border && (m += " dhx_month_body_border", p += " dhx_month_head_border"), this._ignores_detected && this._ignores[g] ? c += "<div></div><div></div>" : (c += "<div class='" + p + "'>" + this.templates.month_day(i) + "</div>", c += "<div class='" + m + "' " + o[g] + ";height:" + f + "px;'></div></td>"), u.push(i);
            var x = i.getDate();
    ...
    c += "</table>", this._min_date = r, this._max_date = i, e.innerHTML = c, this._scales = {};
    ...
    var s = scheduler.date.add(t, 1, "month"), n = scheduler._currentDate();
    this.date.date_part(n), this.date.date_part(i);
    var r = Math.ceil(Math.round((s.valueOf() - i.valueOf()) / 864e5) / 7), a = Math.floor(e.clientHeight / r) - this.xy.month_head_height;
    return this._colsS.height = a + this.xy.month_head_height, this._colsS.heights = [], scheduler._render_month_scale(e, t, i)
}, scheduler.getLabel = function (e, t) {
    for (var i = this.config.lightbox.sections, s = 0; s < i.length; s++)if (i[s].map_to == e)for (var n = i[s].options, r = 0; r < n.length; r++)if (n[r].key == t)return n[r].label;
    return ""
    ...
    if (e && "object" == typeof e) {
        for (n = {}, s = [Array, Date, Number, String, Boolean], i = 0; i < s.length; i++)e instanceof s[i] && (n = i ? new s[i](e) : new s[i]);
        t.push(e, n);
        for (i in e)Object.prototype.hasOwnProperty.apply(e, [i]) && (n[i] = scheduler._lame_clone(e[i], t))
    }
    return n || e
    ...
    var s, n = t - e, r = i._start_correction + i._end_correction || 0, a = this["ignore_" + this._mode], d = 0;
    for (i.render ? (d = this._get_date_index(i, e), s = this._get_date_index(i, t)) : s = Math.round(n / 60 / 60 / 1e3 / 24); s > d;) {
        var o = scheduler.date.add(t, -i.x_step, i.x_unit);
        n -= a && a(t) ? t - o : r, t = o, s--
    }
    return n
},scheduler._get_fictional_event_length = function (e, t, i, s) {
    var n = new Date(e), r = s ? -1 : 1;
    if (i._start_correction || i._end_correction) {
        var a;
        a = s ? 60 * n.getHours() + n.getMinutes() - 60 * (i.first_hour || 0) : 60 * (i.last_hour || 0) - (60 * n.getHours() + n.getMinutes());
        var d = 60 * (i.last_hour - i.first_hour), o = Math.ceil((t / 6e4 - a) / d);
        t += o * (1440 - d) * 60 * 1e3
    }
    var l, h = new Date(1 * e + t * r), _ = this["ignore_" + this._mode], c = 0;
    for (i.render ? (c = this._get_date_index(i, n), l = this._get_date_index(i, h)) : l = Math.round(t / 60 / 60 / 1e3 / 24); l * r >= c * r;) {
        var u = scheduler.date.add(n, i.x_step * r, i.x_unit);
        _ && _(n) && (t += (u - n) * r, l += r), n = u, c += r
    }
    return t
    ...
    init: function () {
        ...
        return i.setDate(i.getDate() + t), !e.getHours() && i.getHours() && i.setTime(i.getTime() + 36e5 * (24 - i.getHours())), i
    }, add: function (e, t, i) {
        ...
        for (var i = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", s = e.match(/%[a-zA-Z]/g), n = 0; n < s.length; n++)switch (s[n]) {
            case"%j":
            case"%d":
                i += "set[2]=temp[" + n + "]||1;";
                break;
            ...
            case"%s":
                ...
                break;
            case"%M":
                i += "set[1]=scheduler.locale.date.month_short_hash[temp[" + n + "]]||0;";
                break;
            case"%F":
                i += "set[1]=scheduler.locale.date.month_full_hash[temp[" + n + "]]||0;"
        }
        ...
        var s = i.getFullYear(), n = Math.round((i.getTime() - new Date(s, 0, 1).getTime()) / 864e5), r = 1 + Math.floor(n / 7);
        return r
    ...
    var t = scheduler.date.date_to_str, i = scheduler.config, s = function (e, t) {
...
},scheduler.addEvent = function (e, t, i, s, n) {
    if (!arguments.length)return this.addEventNow();
    var r = e;
    1 != arguments.length && (r = n || {}, r.start_date = e, r.end_date = t, r.text = i, r.id = s), r.id = r.id || scheduler.uid(), r.text = r.text || "", "string" == typeof r.start_date && (r.start_date = this.templates.api_date(r.start_date)), "string" == typeof r.end_date && (r.end_date = this.templates.api_date(r.end_date));
    var a = 6e4 * (this.config.event_duration || this.config.time_step);
    r.start_date.valueOf() == r.end_date.valueOf() && r.end_date.setTime(r.end_date.valueOf() + a), r._timed = this.isOneDayEvent(r);
    ...
    if (t) {
        var i = e.end_date.getHours() >= this.config.first_hour && e.end_date.getHours() < this.config.last_hour || e.start_date.getHours() >= this.config.first_hour && e.start_date.getHours() < this.config.last_hour;
        if (i)return !0;
        var s = (e.end_date.valueOf() - e.start_date.valueOf()) / 36e5, n = 24 - (this.config.last_hour - this.config.first_hour);
        return s > n
    }
    return !1
    ...
    if (this.config.multi_day && !this._table_view) {
        for (var n = [], r = [], i = 0; i < e.length; i++)this._is_main_area_event(e[i]) ? n.push(e[i]) : r.push(e[i]);
    ...
    for (var t = this._rendered_location, i = this._lame_clone(e), s = e._sday; s < e._eday; s++) {
        ...
        var n = scheduler.date, r = scheduler._min_date;
        r = n.add(r, i._sweek, "week"), r = n.add(r, i._sday, "day");
        var a = scheduler.getEvents(r, n.add(r, 1, "day")).length, d = this._get_event_bar_pos(i), o = d.x2 - d.x, l = document.createElement("div");
        l.onclick = function (e) {
            scheduler._view_month_day(e || event)
        }, l.className = "dhx_month_link", l.style.top = d.y + "px", l.style.left = d.x + "px", l.style.width = o + "px", l.innerHTML = scheduler.templates.month_events_link(r, a), this._rendered.push(l), t.appendChild(l)
    }
    ...
    var i = this.xy.bar_height, s = this._colsS.heights, n = this._colsS.heights = [0, 0, 0, 0, 0, 0, 0], r = this._els.dhx_cal_data[0];
    if (e = this._table_view ? this._pre_render_events_table(e, t) : this._pre_render_events_line(e, t), this._table_view)if (t)this._colsS.heights = s; else {
        var a = r.firstChild;
        if (a.rows) {
            for (var d = 0; d < a.rows.length; d++) {
                ...
                if (n[d] * i > o) {
                    var l = a.rows[d].cells, h = o;
                    1 * this.config.max_month_events !== this.config.max_month_events || n[d] <= this.config.max_month_events ? h = n[d] * i : (this.config.max_month_events + 1) * i > o && (h = (this.config.max_month_events + 1) * i);
            ...
            if (n.unshift(0), a.parentNode.offsetHeight < a.parentNode.scrollHeight && !scheduler._colsS.scroll_fix && scheduler.xy.scroll_width) {
            ...
            var g = (a.parentNode.childNodes, (n[0] + 1) * i + 1), v = g, m = g + "px";
            this.config.multi_day_height_limit && (v = Math.min(g, this.config.multi_day_height_limit), m = v + "px"), r.style.top = this._els.dhx_cal_navline[0].offsetHeight + this._els.dhx_cal_header[0].offsetHeight + v + "px", r.style.height = this._obj.offsetHeight - parseInt(r.style.top, 10) - (this.xy.margin_top || 0) + "px";
            var p = this._els.dhx_multi_day[0];
            p.style.height = m, p.style.visibility = -1 == n[0] ? "hidden" : "visible";
            var x = this._els.dhx_multi_day[1];
            x.style.height = m, x.style.visibility = -1 == n[0] ? "hidden" : "visible", x.className = n[0] ? "dhx_multi_day_icon" : "dhx_multi_day_icon_small", this._dy_shift = (n[0] + 1) * i, n[0] = 0, v != g && (r.style.top = parseInt(r.style.top) + 2 + "px", p.style.overflowY = "auto", p.style.width = parseInt(p.style.width) - 2 + "px", x.style.position = "fixed", x.style.top = "", x.style.left = "")
        }
    }
    return e
    ...
    for (var n = 0; n < e.length; n++) {
        var r = e[n], a = r.start_date, d = r.end_date, o = a.getHours(), l = d.getHours();
        if (r._sday = this._get_event_sday(r), this._ignores[r._sday])e.splice(n, 1), n--; else {
            if (i[r._sday] || (i[r._sday] = []), !t) {
                r._inner = !1;
                for (var h = i[r._sday]; h.length;) {
                ...
                for (var u = h.length, f = !1, g = 0; g < h.length; g++) {
                    ...
                    if (c.valueOf() <= r.start_date.valueOf()) {
                        f = !0, r._sorder = _._sorder, u = g, r._inner = !0;
                        break
                    }
                }
                if (h.length && (h[h.length - 1]._inner = !0), !f)if (h.length)if (h.length <= h[h.length - 1]._sorder) {
                    if (h[h.length - 1]._sorder)for (g = 0; g < h.length; g++) {
                        for (var v = !1, m = 0; m < h.length; m++)if (h[m]._sorder == g) {
                            v = !0;
                            break
                        }
                        if (!v) {
                    ...
                    var p = h[0]._sorder;
                    for (g = 1; g < h.length; g++)h[g]._sorder > p && (p = h[g]._sorder);
                    r._sorder = p + 1, r._inner = !1
                } else r._sorder = 0;
                h.splice(u, u == h.length ? 0 : 1, r), h.length > (h.max_count || 0) ? (h.max_count = h.length, r._count = h.length) : r._count = r._count ? r._count : 1
            }
            (o < this.config.first_hour || l >= this.config.last_hour) && (s.push(r), e[n] = r = this._copy_event(r), o < this.config.first_hour && (r.start_date.setHours(this.config.first_hour), r.start_date.setMinutes(0)), l >= this.config.last_hour && (r.end_date.setMinutes(0), r.end_date.setHours(this.config.last_hour)), r.start_date > r.end_date || o == this.config.last_hour) && (e.splice(n, 1), n--)
        }
    }
    if (!t) {
        for (var n = 0; n < e.length; n++)e[n]._count = i[e[n]._sday].max_count;
        for (var n = 0; n < s.length; n++)s[n]._count = i[s[n]._sday].max_count
    }
    return e
    ...
    this._time_order(e);
    for (var i, s = [], n = [[], [], [], [], [], [], []], r = this._colsS.heights, a = this._cols.length, d = {}, o = 0; o < e.length; o++) {
        var l = e[o], h = l.id;
        ...
        if (l._sday = f % a, !this._ignores[l._sday] || !l._timed) {
            var g = this.locate_holder_day(u, !0, l) || a;
            l._eday = g % a || a, l._length = g - f, l._sweek = Math.floor((this._correct_shift(c.valueOf(), 1) - this._min_date.valueOf()) / (864e5 * a));
            var v, m = n[l._sweek];
            for (v = 0; v < m.length && !(m[v]._eday <= l._sday); v++);
            if (l._sorder && t || (l._sorder = v), l._sday + l._length <= a)i = null, s.push(l), m[v] = l, r[l._sweek] = m.length - 1, l._first_chunk = _.first_chunk, l._last_chunk = _.last_chunk;
            else {
                var p = this._copy_event(l);
                p.id = l.id, p._length = a - l._sday, p._eday = a, p._sday = l._sday, p._sweek = l._sweek, p._sorder = l._sorder, p.end_date = this.date.add(c, p._length, "day"), p._first_chunk = _.first_chunk, _.first_chunk && (_.first_chunk = !1), s.push(p), m[v] = p, i = p.end_date, r[l._sweek] = m.length - 1, o--
            }
        }
    }
    return s
    ...
    t = t || 0;
    var i = 60 * e.start_date.getHours() + e.start_date.getMinutes(), s = 60 * e.end_date.getHours() + e.end_date.getMinutes() || 60 * scheduler.config.last_hour, n = this._y_from_date(e.start_date), r = Math.max(t, (s - i) * this.config.hour_size_px / 60);
    return {top: n, height: r}
    ...
    if (!(e._sday < 0)) {
        ...
        if (s) {
            var n = this._calc_event_y(e, scheduler.xy.min_event_height), r = n.top, a = n.height, d = e._count || 1, o = e._sorder || 0, l = Math.floor((s.clientWidth - i) / d), h = o * l + 1;
            ...
            var f = this._render_v_bar(e, i + h, r, l, a, e._text_style, scheduler.templates.event_header(e.start_date, e.end_date, e), scheduler.templates.event_text(e.start_date, e.end_date, e));
            if (this._rendered.push(f), s.appendChild(f), h = h + parseInt(s.style.left, 10) + i, this._edit_id == e.id) {
                f.style.zIndex = 1, l = Math.max(l - 4, scheduler.xy.editor_width), f = document.createElement("DIV"), f.setAttribute("event_id", e.id), this.set_xy(f, l, a - 20, h, r + 14), f.className = "dhx_cal_event dhx_cal_editor";
                var g = scheduler.templates.event_class(e.start_date, e.end_date, e);
                g && (f.className += " " + g);
                var v = document.createElement("DIV");
                this.set_xy(v, l - 6, a - 26), v.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", f.appendChild(v), this._els.dhx_cal_data[0].appendChild(f), this._rendered.push(f), v.innerHTML = "<textarea class='dhx_cal_editor'>" + e.text + "</textarea>", this._quirks7 && (v.firstChild.style.height = a - 12 + "px"), this._editor = v.firstChild, this._editor.onkeydown = function (e) {
            ...
            if (0 !== this.xy.menu_width && this._select_id == e.id) {
                ...
                var w = this._render_v_bar(e, h - t + 1, r, t, 20 * m.length + 26 - 2, "", "<div style='" + x + b + "' class='dhx_menu_head'></div>", p, !0);
...
},scheduler._render_v_bar = function (e, t, i, s, n, r, a, d, o) {
    ...
    c && (_ = _ + " " + c);
    var u = e.color ? "background:" + e.color + ";" : "", f = e.textColor ? "color:" + e.textColor + ";" : "", g = '<div event_id="' + h + '" class="' + _ + '" style="position:absolute; top:' + i + "px; left:" + t + "px; width:" + (s - 4) + "px; height:" + n + "px;" + (r || "") + '"></div>';
    l.innerHTML = g;
    var v = l.cloneNode(!0).firstChild;
    if (!o && scheduler.renderEvent(v, e, s, n, a, d))return v;
    v = l.firstChild;
    var m = '<div class="dhx_event_move dhx_header" style=" width:' + (s - 6) + "px;" + u + '" >&nbsp;</div>';
    m += '<div class="dhx_event_move dhx_title" style="' + u + f + '">' + a + "</div>", m += '<div class="dhx_body" style=" width:' + (s - (this._quirks ? 4 : 14)) + "px; height:" + (n - (this._quirks ? 20 : 30) + 1) + "px;" + u + f + '">' + d + "</div>";
    var p = "dhx_event_resize dhx_footer";
    return o && (p = "dhx_resize_denied " + p), m += '<div class="' + p + '" style=" width:' + (s - 8) + "px;" + (o ? " margin-top:-1px;" : "") + u + f + '" ></div>', v.innerHTML = m, v
    ...
    var s = this.xy.bar_height, n = e._sorder;
    if (e.id == this._drag_id) {
        var r = this._colsS.heights[e._sweek + 1] - this._colsS.heights[e._sweek] - this.xy.month_head_height;
        n = scheduler._get_dnd_order(n, s, r)
    }
    var a = n * s, d = this._colsS.heights[e._sweek] + (this._colsS.height ? this.xy.month_scale_height + 2 : 2) + a;
    return {x: t, x2: i, y: d}
},scheduler.render_event_bar = function (e) {
    var t = this._rendered_location, i = this._get_event_bar_pos(e), s = i.y, n = i.x, r = i.x2, a = "";
    if (r) {
        ...
        (!e._timed || d) && (u = "dhx_cal_event_line"), l && (u += " dhx_cal_event_line_start"), h && (u += " dhx_cal_event_line_end"), _ && (a += "<div class='dhx_event_resize dhx_event_resize_start'></div>"), c && (a += "<div class='dhx_event_resize dhx_event_resize_end'></div>");
        var f = scheduler.templates.event_class(e.start_date, e.end_date, e);
        f && (u += " " + f);
        var g = e.color ? "background:" + e.color + ";" : "", v = e.textColor ? "color:" + e.textColor + ";" : "", m = ["position:absolute", "top:" + s + "px", "left:" + n + "px", "width:" + (r - n - 15) + "px", v, g, e._text_style || ""].join(";"), p = '<div event_id="' + e.id + '" class="' + u + '" style="' + m + '">';
        d && (p += a), "month" == scheduler.getState().mode && (e = scheduler.getEvent(e.id)), e._timed && (p += scheduler.templates.event_bar_date(e.start_date, e.end_date, e)), p += scheduler.templates.event_bar_text(e.start_date, e.end_date, e) + "</div>", p += "</div>", o.innerHTML = p, this._rendered.push(o.firstChild), t.appendChild(o.firstChild)
    }
    ...
    if (!e.parentNode) {
        var t = scheduler._els.dhx_cal_data[0], i = t.lastChild;
    ...
    var i = this.templates.drag_marker_class(e.start_date, e.end_date, e), s = this.templates.drag_marker_content(e.start_date, e.end_date, e);
    ...
    if (e = e || this._load_url) {
        ...
        if (t = t || this._date, this._load_mode) {
            ...
            i = t;
            for (var n = !0; i < this._max_date;)i = this.date.add(i, 1, this._load_mode), this._loaded[s(t)] && n ? t = this.date.add(t, 1, this._load_mode) : n = !1;
            var r = i;
            do i = r, r = this.date.add(i, -1, this._load_mode); while (r > t && this._loaded[s(r)]);
            if (t >= i)return !1;
    ...
    if (t = e.getXMLTopNode("data"), "data" != t.tagName)return [];
    var s = t.getAttribute("dhx_security");
    s && (dhtmlx.security_key = s);
    for (var n = e.doXPath("//coll_options"), r = 0; r < n.length; r++) {
        var a = n[r].getAttribute("for"), d = this.serverList[a];
        if (d) {
            d.splice(0, d.length);
            for (var o = e.doXPath(".//item", n[r]), l = 0; l < o.length; l++) {
    ...
    for (var g = e.doXPath("//userdata"), r = 0; r < g.length; r++) {
        var v = this._xmlNodeToJSON(g[r]);
        this._userdata[v.name] = v.text
    }
    var m = [];
    t = e.doXPath("//event");
    for (var r = 0; r < t.length; r++) {
        var p = m[r] = this._xmlNodeToJSON(t[r]);
    ...
    parse: function (e) {
        ...
        if (t.length) {
            ...
            for (var i, s = [], n = RegExp("(?:" + this.e_start + ")([^\f]*?)(?:" + this.e_end + ")", "g"); null !== (i = n.exec(t));) {
                for (var r, a = {}, d = /[^\r\n]+[\r\n]+/g; null !== (r = d.exec(i[1]));)this.parse_param(r.toString(), a);
                a.uid && !a.id && (a.id = a.uid), s.push(a)
            }
            return s
        }
        ...
        var i = e.indexOf(":");
        if (-1 != i) {
            var s = e.substr(0, i).toLowerCase(), n = e.substr(i + 1).replace(/\\\,/g, ",").replace(/[\r\n]+$/, "");
            "summary" == s ? s = "text" : "dtstart" == s ? (s = "start_date", n = this.parse_date(n, 0, 0)) : "dtend" == s && (s = "end_date", n = this.parse_date(n, 0, 0)), t[s] = n
        }
    }, parse_date: function (e, t, i) {
        var s = e.split("T");
        s[1] && (t = s[1].substr(0, 2), i = s[1].substr(2, 2));
        var n = s[0].substr(0, 4), r = parseInt(s[0].substr(4, 2), 10) - 1, a = s[0].substr(6, 2);
        return scheduler.config.server_utc && !s[1] ? new Date(Date.UTC(n, r, a, t, i)) : new Date(n, r, a, t, i)
    ...
    var n = document.getElementById(s.id), r = n.nextSibling, a = {
        section: s, header: n, node: r, getValue: function (e) {
            return scheduler.form_blocks[s.type].get_value(r, e || {}, s)
        }, setValue: function (e, t) {
            return scheduler.form_blocks[s.type].set_value(r, e, t || {}, s)
        }
    ...
    template: {
        ...
        render: function (e) {
            ...
            var n = e.firstChild;
            !n._dhx_onchange && s.onchange && (n.onchange = s.onchange, n._dhx_onchange = !0), "undefined" == typeof t && (t = (n.options[0] || {}).value), n.value = t || ""
        }, get_value: function (e) {
            return e.firstChild.value
        }, focus: function (e) {
            var t = e.firstChild;
        ...
        render: function (e) {
            ...
            var t = e.time_format, i = scheduler.config, s = this.date.date_part(scheduler._currentDate()), n = 1440, r = 0;
            ...
            for (var a = "", d = 0; d < t.length; d++) {
                ...
                switch (d > 0 && (a += " "), o) {
                    ...
                    case"%d":
                        ...
                        break;
                    case"%H:%i":
                        e._time_format_order[0] = d, a += "<select>";
                        var h = r, _ = s.getDate();
            ...
            function n(e, t, i) {
                for (var n = s._time_values, r = 60 * i.getHours() + i.getMinutes(), a = r, d = !1, o = 0; o < n.length; o++) {
                    var h = n[o];
                    if (h === r) {
                        d = !0;
                        break
                ...
                e[t + l[0]].value = d ? r : a, d || a || (e[t + l[0]].selectedIndex = -1), e[t + l[1]].value = i.getDate(), e[t + l[2]].value = i.getMonth(), e[t + l[3]].value = i.getFullYear()
            }

            var r, a, d = scheduler.config, o = e.getElementsByTagName("select"), l = s._time_format_order;
            if (d.full_day) {
                if (!e._full_day) {
                ...
                _.checked = 0 === scheduler.date.time_part(i.start_date) && 0 === scheduler.date.time_part(i.end_date), o[l[0]].disabled = _.checked, o[l[0] + o.length / 2].disabled = _.checked, _.onclick = function () {
                    if (_.checked) {
                        var t = {};
                        scheduler.form_blocks.time.get_value(e, t, s), r = scheduler.date.date_part(t.start_date), a = scheduler.date.date_part(t.end_date), (+a == +r || +a >= +r && (0 !== i.end_date.getHours() || 0 !== i.end_date.getMinutes())) && (a = scheduler.date.add(a, 1, "day"))
                    }
                    o[l[0]].disabled = _.checked, o[l[0] + o.length / 2].disabled = _.checked, n(o, 0, r || i.start_date), n(o, 4, a || i.end_date)
                }
            }
            if (d.auto_end_date && d.event_duration)for (var c = function () {
                r = new Date(o[l[3]].value, o[l[2]].value, o[l[1]].value, 0, o[l[0]].value), a = new Date(r.getTime() + 60 * scheduler.config.event_duration * 1e3), n(o, 4, a)
            }, u = 0; 4 > u; u++)o[u].onchange = c;
            n(o, 0, i.start_date), n(o, 4, i.end_date)
        }, get_value: function (e, t, i) {
            var s = e.getElementsByTagName("select"), n = i._time_format_order;
            return t.start_date = new Date(s[n[3]].value, s[n[2]].value, s[n[1]].value, 0, s[n[0]].value), t.end_date = new Date(s[n[3] + 4].value, s[n[2] + 4].value, s[n[1] + 4].value, 0, s[n[0] + 4].value), t.end_date <= t.start_date && (t.end_date = scheduler.date.add(t.start_date, scheduler.config.time_step, "minute")), {
    ...
    if (e) {
        ...
        var t = window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop, i = window.pageXOffset || document.body.scrollLeft || document.documentElement.scrollLeft, s = window.innerHeight || document.documentElement.clientHeight;
    ...
    var i = this.getEvent(e), s = t.getElementsByTagName("span");
    ...
    for (var n = this.config.lightbox.sections, r = 0; r < n.length; r++) {
        var a = n[r], d = document.getElementById(a.id).nextSibling, o = this.form_blocks[a.type], l = void 0 !== i[a.map_to] ? i[a.map_to] : a.default_value;
        o.set_value.call(this, d, l, i, a), n[r].focus && o.focus.call(this, d)
    }
    ...
    for (var t = this.config.lightbox.sections, i = 0; i < t.length; i++) {
        ...
        s = s ? s.nextSibling : s;
        var n = this.form_blocks[t[i].type], r = n.get_value.call(this, s, e, t[i]);
    ...
    this.getLightbox().onclick = function (e) {
        ...
        if (t.className || (t = t.previousSibling), t && t.className)switch (t.className) {
            ...
            case"dhx_cancel_btn":
                ...
                break;
            default:
                if (t.getAttribute("dhx_button"))scheduler.callEvent("onLightboxButton", [t.className, t, e]); else {
                    var s, n, r;
                    -1 != t.className.indexOf("dhx_custom_button") && (-1 != t.className.indexOf("dhx_custom_button_") ? (s = t.parentNode.getAttribute("index"), r = t.parentNode.parentNode) : (s = t.getAttribute("index"), r = t.parentNode, t = t.firstChild)), s && (n = scheduler.form_blocks[scheduler.config.lightbox.sections[s].type], n.button_click(s, t, r, r.nextSibling))
                }
        }
    ...
    if (!this._lightbox) {
        ...
        for (var s = 0; s < n.length; s++) {
            var r = this.form_blocks[n[s].type];
            if (r) {
                n[s].id = "area_" + this.uid();
                var a = "";
                n[s].button && (a = "<div class='dhx_custom_button' index='" + s + "'><div class='dhx_custom_button_" + n[s].button + "'></div><div>" + this.locale.labels["button_" + n[s].button] + "</div></div>"), this.config.wide_form && (t += "<div class='dhx_wrap_section'>");
                var d = this.locale.labels["section_" + n[s].name];
                "string" != typeof d && (d = n[s].name), t += "<div id='" + n[s].id + "' class='dhx_cal_lsection'>" + a + d + "</div>" + r.render.call(this, n[s]), t += "</div>"
            }
        }
    ...
    function n(e, t, i) {
        if (e && t) {
            ...
            n > i && (!s || n / s > 3) && (e.pageX > t.pageX ? scheduler._click.dhx_cal_next_button() : scheduler._click.dhx_cal_prev_button())
        }
    }
    ...
    var a, d, o, l, h, _, c = -1 != navigator.userAgent.indexOf("Android") && -1 != navigator.userAgent.indexOf("WebKit"), u = 0;
    s(document.body, e[0], function (e) {
        if (!i(e)) {
            if (l)return scheduler._on_mouse_move(t(e)), scheduler._update_global_tip(), e.preventDefault && e.preventDefault(), e.cancelBubble = !0, !1;
            if (d && c && n(d, t(e), 0), d = t(e), _)return d ? void((a.target != d.target || Math.abs(a.pageX - d.pageX) > 5 || Math.abs(a.pageY - d.pageY) > 5) && (h = !0, clearTimeout(o))) : void(h = !0)
        }
        ...
        if (!i(e)) {
            var s;
            if (l = h = !1, _ = !0, scheduler._temp_touch_block = !0, s = d = t(e), !s)return void(h = !0);
            var n = new Date;
            if (!h && !l && 250 > n - u)return scheduler._click.dhx_cal_data(s), window.setTimeout(function () {
            ...
            u = n, h || l || !scheduler.config.touch_drag || (o = setTimeout(function () {
                l = !0;
                var e = a.target;
                if (e && e.className && -1 != e.className.indexOf("dhx_body") && (e = e.previousSibling), scheduler._on_mouse_down(a, e), scheduler._drag_mode && "create" != scheduler._drag_mode) {
                    var t = -1;
                ...
                scheduler.config.touch_tip && scheduler._show_global_tip(), scheduler._on_mouse_move(a)
            }, scheduler.config.touch_drag), a = s)
        }
    }), s(this._els.dhx_cal_data[0], e[2], function (e) {
        return i(e) ? void 0 : (l || n(a, d, 200), l && (scheduler._ignore_next_click = !0), r(e), scheduler._block_next_stop ? (scheduler._block_next_stop = !1, e.preventDefault && e.preventDefault(), e.cancelBubble = !0, !1) : void 0)
    ...
    e._methods = ["_set_event_text_style", "", "changeEventId", "_dp_hook_delete"], this._dp_hook_delete = function (e) {
        ...
        var t = this.obj.getEvent(e), i = {};
        for (var s in t)0 !== s.indexOf("_") && (i[s] = t[s] && t[s].getUTCFullYear ? this.obj.templates.xml_format(t[s]) : t[s]);
        return i
    }, e._clearUpdateFlag = function () {
    }, e.attachEvent("insertCallback", scheduler._update_callback), e.attachEvent("updateCallback", scheduler._update_callback), e.attachEvent("deleteCallback", function (e, t) {
    ...
    var s = 0;
    if (!scheduler.skin || "classic" !== scheduler.skin && "glossy" !== scheduler.skin || (s = 1), this._configure(scheduler.config, scheduler._skin_settings, s), this._configure(scheduler.xy, scheduler._skin_xy, s), !s) {
        ...
        n && (n.padding = 14), scheduler.templates.event_bar_date = function (e) {
            ...
            if (scheduler.templates.month_day = function (i) {
                ...
                for (var i = scheduler._els.dhx_cal_navline[0].getElementsByTagName("div"), s = null, n = 211, r = 0; r < i.length; r++) {
                    var a = i[r], d = a.getAttribute("name");
                    if (d)switch (a.style.right = "auto", d) {
                        case"day_tab":
                            a.style.left = "14px", a.className += " dhx_cal_tab_first";
                            break;
                        case"week_tab":
                            a.style.left = "75px";
                            break;
                        case"month_tab":
                            a.style.left = "136px", a.className += " dhx_cal_tab_last";
                            break;
                        default:
                            a.style.left = n + "px", a.className += " dhx_cal_tab_standalone", n = n + 14 + a.offsetWidth
                    } else 0 === (a.className || "").indexOf("dhx_minical_icon") && a.parentNode == scheduler._els.dhx_cal_navline[0] && (s = a)
                }
                s && (s.style.left = n + "px")
            }
