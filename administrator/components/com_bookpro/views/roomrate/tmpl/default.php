...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate">     
    <div class="form-horizontal span3 pull-left">   
                   ...
                   <?php echo JHtml::calendar('', 'enddate', 'enddate','%Y-%m-%d','readonly="readonly"') ?>
                    ...
                    <label ><strong><?php echo JText::_('COM_BOOKPRO_NUMBER'); ?></strong> </label>
                    <input class="text_area required" type="text" name="number" id="number" size="60" maxlength="255" value="" />                    
</div>             
  ...
  <div class="form-horizontal span9" style="">
            <?php
                if($this->hotel){
            ?>
              <h3><?php echo JText::_('COM_BOOKPRO_HOTEL_').$this->hotel->title; ?></h3>  
            <?php
                }
              ?>
                <table class="table">
                            ...
                            ?>   <tbody>
                                    <tr class="record">
                                            ...
                                            <td><input type="text" class="span8" size="4" value="<?php echo $subject->dayrate ?>" name="updWeekday_0" id="updWeekday175" readonly="readonly"></td>
                                            <td><input type="text" class="span8" size="4" value="<?php echo $subject->endrate ?>" name="updWeekend_0" id="updWeekend175" readonly="readonly"></td>
                                                <?php if (! $this->selectable) { ?>
