<?php     
    ...
    JToolBarHelper::title($this->obj->id ? JText::_('COM_BOOKPRO_EDIT_ROOM') : JText::_('COM_BOOKPRO_ADD_ROOM'), 'object');
...
<script type="text/javascript">       
    Joomla.submitbutton = function(task) {
        ...
        if (document.formvalidator.isValid(form)) {
            ...
            alert('<?php echo JText::_('COM_BOOKPRO_FIELDS_HIGHLIGHTED_IN_RED_ARE_COMPULSORY'); ?>');
            return false;
        }
    }
</script>
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate">    		
    <div class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php
                    echo JHtmlSelect::integerlist(1, 10, 1, 'adult', 'class="required" id="adult"', $this->obj->adult);
                ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php
                    echo JHtmlSelect::integerlist(0, 10, 1, 'child', 'class="required" id="child"', $this->obj->child);
                ?>
            </div>
        </div>                                
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                ?>
                <?php echo JText::_('Children age less than max age will be free of charge')?>
            </div>
        </div>                 
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php
                    ...
                    echo $editor->display('desc', $this->obj->desc, '100%', '200', '60', '20', false);
                ?>
            </div>
        </div>
