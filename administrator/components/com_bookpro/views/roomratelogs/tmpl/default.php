...
<form action="index.php" method="post" name="adminForm" id="adminForm">
				...
				?>
				    	<tr>
				    		<td  style="text-align: right; white-space: nowrap;"><?php echo number_format($this->pagination->getRowOffset($i), 0, '', ' '); ?></td>
				    			...
				    			<?php } ?>
                                <td style="text-align: center;"><a href="<?php echo $link; ?>" title="<?php echo $titleEdit; ?>"><?php echo $subject->room_id ?></a></td>
	...
	<input type="hidden" name="controller" value="<?php echo CONTROLLER_ROOM_RATE_LOG; ?>"/>
