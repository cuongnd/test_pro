...
AImporter::helper('report','date','order');
...
<h2 class="titlePage"><?php echo JText::_('Booking List'); ?></h2><div class="abutton">	<?php		$filter_from = JRequest::getVar('filter_from','');		$filter_to = JRequest::getVar('filter_to','');	?>	<a style="float:right;" target="_blank" href="index.php?option=com_bookpro&controller=tourreport&layout=printdriver&tmpl=component&filter_from=<?php echo $filter_from; ?>&filter_to=<?php echo $filter_to ?>">		<span style="height:32px;width:32px;display: block;" class="icon-32-print"></span>				<?php echo JText::_('Print'); ?>	</a></div>
