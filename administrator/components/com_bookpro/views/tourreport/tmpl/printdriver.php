...
$itemsCount=count($this->items);$config = AFactory::getConfig();
?>
...
<h2 class="titlePage"><?php echo JText::_('Booking List'); ?></h2><?php echo $config->invoice_header;?>
...
</table><?php echo $config->invoice_footer; ?>
</div>
