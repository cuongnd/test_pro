...
class BookProViewBookPro extends BookproJViewLegacy {
    ...
    function display($tpl = null) {
        ...
        require_once JPATH_ROOT.'/administrator/components/com_bookpro/models/orders.php';
        ...
        require_once JPATH_ROOT.'/administrator/components/com_bookpro/helpers/request.php';
