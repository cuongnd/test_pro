...
echo <<<HTML
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_config"><i class="icon-genaral-setup"></i>Genaral Setup</a>
        </li>
        <li>
            <a href="index.php?option=com_template"><i class="icon-template"></i>Template</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=config"><i class="icon-api-setting"></i>API setting</a>
        </li>
        <li>
            <a href="index.php?option=com_tags"><i class="icon-seo-setting"></i>Seo setting</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_language"><i class="icon-language"></i>Language</a>
        </li>
        <li>
            <a href="index.php?option=com_modules"><i class="icon-module"></i>Module</a>
        </li>

    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_payment"><i class="icon-payment"></i>Payment</a>
        </li>
    </ul>
HTML;
...
echo <<<HTML
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=countries"><i class="icon-country-geo"></i>Country Geo</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=destination"><i class="icon-state-province"></i>State/Province City/Area</a>
        </li>
        <!--<li>-->
            <!--<a href="index.php?option=com_bookpro&view=destination"><i class="icon-city-area"></i>City/Area</a>-->
        <!--</li>-->
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_logistic"><i class="icon-group-size"></i>Group Size</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=tourclass"><i class="icon-tour-class"></i>Tour Class</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=activities"><i class="icon-activities"></i>Activities</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=tourtype"><i class="icon-tour-type"></i>Tour type</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=hotels"><i class="icon-hotel"></i>Hotel</a>
        </li>

        <li>
            <a href="index.php?option=com_bookpro&view=physicalgrade"><i class="icon-physical-grade"></i>Physical Grade</a>
        </li>
    </ul>
HTML;
...
echo <<<HTML
    <ul class="pull-left">
        ...
        <li>
            <a href="index.php?option=com_bookpro&view=hightlights"><i class="icon-highlights"></i>Highlights</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=itineraries"><i class="icon-itinerary"></i>Itinerary</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_media"><i class="icon-photos"></i>Photos</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=documents"><i class="icon-documents"></i>Documents</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=tourprices"><i class="icon-tour-price"></i>Tour price</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=relations"><i class="icon-relations"></i>Relations</a>
        </li>
    ...
    <ul class="pull-left">
        ...
        <li>
            <a href="index.php?option=com_bookpro&view=faqs"><i class="icon-faqs"></i>FAQs</a>
        </li>
    </ul>
HTML;
...
echo <<<HTML
    <ul class="pull-left">
        ...
        <li>
            <a href="index.php?option=com_bookpro&view=allocations"><i class="icon-allocation"></i>Allocation</a>
        </li>
        <li>
            <a href="index.php?option=com_payment"><i class="icon-payment"></i>Payment</a>
        </li>
    ...
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=promotions"><i class="icon-promotion"></i>Promotion</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=discounts"><i class="icon-discount"></i>Discount</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=hotels"><i class="icon-hotel-addon"></i>Hotel addon</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=stransfers"><i class="icon-stransfer-addon"></i>Stransfer addon</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=excursions"><i class="icon-excursion-addon"></i>Excursion addon</a>
        </li>
    </ul>
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_users&view=groups"><i class="icon-sssign"></i>Assign</a>
        </li>
    </ul>
HTML;
...
echo <<<HTML
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_bookpro&view=orders"><i class="icon-tour-listing"></i>Orders</a>
        </li>
        <li>
            <a href="index.php?option=com_bookpro&view=allocations"><i class="icon-allocation"></i>Allocation</a>
        </li>
    ...
    <ul class="pull-left">
        <li>
            <a href="index.php?option=com_users&view=groups"><i class="icon-assign"></i>Assign</a>
        </li>
    </ul>
HTML;
