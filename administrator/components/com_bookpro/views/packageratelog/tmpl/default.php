...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate">
		...
		<fieldset class="adminform">
    		<legend><?php echo JText::_('COM_BOOKPRO_ROOM_EDIT'); ?></legend>
    		<div class="form-horizontal">
    			<div class="control-group">
					<label class="control-label" for="hotels"><?php echo JText::_('Room'); ?>
					</label>
					<div class="controls">
						<?php echo $this->rooms ?>
					</div>
    			...
    			<div class="control-group">
					<label class="control-label" for="room_type"><?php echo JText::_('Start Date'); ?>
					</label>
					<div class="controls">
                        <?php
                                $startdate='';
                ...
                <div class="control-group">
                    <label class="control-label" for="room_type"><?php echo JText::_('End Date'); ?>
                    </label>
                    <div class="controls">
                        <?php
                                $enddate='';
