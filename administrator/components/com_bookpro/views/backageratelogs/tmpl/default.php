...
JToolBarHelper::title(JText::_('COM_BOOKPRO_PACKAGE_MANAGER'), 'object');
		...
		<table class="adminlist" >
			<thead>
				<tr>
					...
					<th class="title" width="30%">
				       <?php echo JText::_("Date & End Date");?>
					</th>
					<th class="title" width="15%">
				       <?php echo JText::_("Weedday");?>
					</th>
                    
                    <th class="title" width="15%">
                       <?php echo JText::_("Weedend");?>
                    </th>
			...
			<tbody>
				...
				<?php 
						 ...
						 for ($i = 0; $i < $itemsCount; $i++) { 
				    		...
				    		$link = JRoute::_(ARoute::edit(CONTROLLER_package_RATE_LOG, $subject->id));
				...
				?>
				    	<tr>
				    		<td  style="text-align: right; white-space: nowrap;"><?php echo number_format($this->pagination->getRowOffset($i), 0, '', ' '); ?></td>
				    			...
				    			<?php } ?>
                                <td style="text-align: center;"><a href="<?php echo $link; ?>" title="<?php echo $titleEdit; ?>"><?php echo $subject->package_id ?></a></td>
                                <td style="text-align: center;"><a href="<?php echo $link; ?>" title="<?php echo $titleEdit; ?>"><?php echo $subject->startdate.' to '.$subject->enddate; ?></a></td>
                                <td style="text-align: center;"><?php echo $subject->dayrate ?></td>
                                <td style="text-align: center;"><?php echo $subject->endrate ?></td>
