...
JToolBarHelper::title(JText::_('COM_BOOKPRO_PACKAGETYPE_MANAGER'), 'object');
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		...
		<div class="btn-group pull-left hidden-phone fltlft">
			 <input type="text" name="title"  value="<?php echo $this->lists['title']?>" placeholder="<?php echo JText::_('COM_BOOKPRO_PACKAGETYPE_TITLE')?>"> 
		...
		<table class="adminlist table-striped table">
			<thead>
				<tr>
					...
					<th class="title" width="10%"><?php echo JHTML::_('grid.sort', JText::_('COM_BOOKPRO_PACKAGETYPE_TITLE'), 'title', $orderDir, $order); ?>
					</th>
			...
			<tbody>
				...
				<?php 
						...
						for ($i = 0; $i < $itemsCount; $i++) {
							...
							$link = JRoute::_(ARoute::edit(CONTROLLER_PACKAGETYPE, $subject->id));
				...
				<tr>
					...
					<?php } ?>
					<td class="center">
								<?php echo JHtml::_('jgrid.published', $subject->state, $i, 'packagetypes.', true, 'cb', $subject->publish_up, $subject->publish_down); ?>
							</td>
