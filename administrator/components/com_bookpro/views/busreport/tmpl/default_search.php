...
function getFilter(start,end,layout){
	...
	document.adminForm.submit();
						...
						?> <a href="#"							onclick="getFilter('<?php echo date('Y-m-d H:i:s',$start_day); ?>','<?php echo date('Y-m-d H:i:s',$end_day) ?>','<?php echo $layout; ?>');"><?php echo JText::_('COM_BOOKPRO_BUSREPORT_TOMORROW') ?>						</a>						</li>						<li><?php 
						$start_day = DateHelper::dateBeginDay(time());
						$end_day = DateHelper::dateEndDay(time());

						?> <a href="#"							onclick="getFilter('<?php echo date('Y-m-d H:i:s',$start_day); ?>','<?php echo date('Y-m-d H:i:s',$end_day) ?>','<?php echo $layout; ?>');"><?php echo JText::_('COM_BOOKPRO_BUSREPORT_TODAY') ?>						</a>						</li>						<li><?php 
						$start_yesterday = DateHelper::dateBeginDay(strtotime('yesterday'));
						$end_yesterday = DateHelper::dateEndDay(strtotime('yesterday'));
						?> <a href="#"							onclick="getFilter('<?php echo date('Y-m-d H:i:s',$start_yesterday) ?>','<?php echo date('Y-m-d H:i:s',$end_yesterday) ?>','<?php echo $layout; ?>')"><?php echo JText::_('COM_BOOKPRO_BUSREPORT_YESTERDAY') ?>						</a>						</li>						<li><?php 
						$start_week = DateHelper::dateBeginWeek(time());
						$end_week = DateHelper::dateEndWeek(time());

						?> <a href="#"							onclick="getFilter('<?php echo date('Y-m-d H:i:s',$start_week); ?>','<?php echo date('Y-m-d H:i:s',$end_week); ?>','<?php echo $layout; ?>');"><?php echo JText::_('COM_BOOKPRO_BUSREPORT_THIS_WEEK') ?>						</a>						</li>						<li><?php 
