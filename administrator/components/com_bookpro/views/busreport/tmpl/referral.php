	...
	<fieldset>
	 <legend><?php echo JText::_('Referral report')?></legend>
      ...
      function drawTable() {
        ...
        data.addColumn('string', '<?php echo JText::_('COM_BOOKPRO_BUSREPORT_SOURCE') ?>');
        data.addColumn('number', '<?php echo JText::_('COM_BOOKPRO_BUSREPORT_NO_OF_BOOKINGS') ?>');
	 ...
	 <fieldset>
	 	<legend><?php echo JText::_('COM_BOOKPRO_BUSREPORT_REFERRAL_REPORT_TABLE') ?></legend>
