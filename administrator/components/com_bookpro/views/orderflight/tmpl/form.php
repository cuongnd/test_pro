...
<form action="index.php" method="post" name="adminForm" id="adminForm">
    		...
    		<div class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="text_area required" type="text" name="tx_id" id="tx_id" size="60" maxlength="255" value="<?php echo $this->obj->tx_id; ?>" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="text_area required" type="text" name="deposit" id="deposit" size="60" maxlength="255" value="<?php echo $this->obj->deposit; ?>" />
					</div>
				</div>
