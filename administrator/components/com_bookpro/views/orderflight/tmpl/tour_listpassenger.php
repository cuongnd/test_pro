        ...
        if (count($this->passengers) > 0) {
            ...
            foreach ($this->passengers as $pass) {
                ...
                <tr>
                    ...
                    <?php if (!$input->get('tmpl')) { ?>
                        <td><a href="index.php?option=com_bookpro&view=order&layout=passenger&tpl=edit&order_id=<?php echo $this->order->id ?>&passenger_id=<?php echo $pass->id ?>"  class="btn edit-passenger" ><?php echo JText::_('EDIT') ?></a></td>
                        <?php } ?>
                </tr>
                <?php
            }
