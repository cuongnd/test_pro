<?php
    ...
    AImporter::model('tours', 'tourpackages', 'tourpackage','tour','packageratedaytripjoingrouplogs');
    //import needed JoomLIB helpers
    AImporter::helper('bookpro', 'request','document','image','tour');
    AImporter::js('view-images');


    class BookProViewPackageRatedaytripjoingroup extends BookproJViewLegacy
    {
        /**
        ...
        */
        ...
        function _displayForm($tpl, $obj)
        {
            ...
            $model = new BookProModelPackageRatedaytripjoingroupLogs();
            $this->lists = array();
