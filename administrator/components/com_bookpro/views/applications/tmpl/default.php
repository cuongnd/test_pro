...
JToolBarHelper::title(JText::_('COM_BOOKPRO_APPLICATION'), 'object');
			...
			<thead>
				<tr>
					...
					<th class="title" width="10%">
				        <?php echo JHTML::_('grid.sort', JText::_("COM_BOOKPRO_APP_TITLE"), 'title', $orderDir, $order); ?>
					</th>
			...
			<tbody>
				...
				<?php 
						 ...
						 for ($i = 0; $i < $itemsCount; $i++) { 
				    		...
				    		$link = JRoute::_(ARoute::edit(CONTROLLER_APPLICATION, $subject->id));
				...
				?>
				    	<tr>
				    		<td  style="text-align: left; white-space: nowrap;"><?php echo number_format($this->pagination->getRowOffset($i), 0, '', ' '); ?></td>
				    			...
				    			<?php } ?>
				    		<td class="center">
								<?php echo JHtml::_('jgrid.published', $subject->state, $i, 'applications.', true, 'cb', $subject->publish_up, $subject->publish_down); ?>
							</td>
				    		<td>
					    		<a href="<?php echo $link; ?>" title="<?php echo $titleEdit; ?>"><?php echo $subject->title; ?></a>
				    		</td>
				    		<td style="text-align: center;"><?php echo $subject->code ?></td>
