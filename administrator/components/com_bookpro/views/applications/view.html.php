...
if (! defined('SESSION_PREFIX')) {
	if (IS_ADMIN) {
		define('SESSION_PREFIX', 'bookpro_application_list_');
	} elseif (IS_SITE) {
		define('SESSION_PREFIX', 'bookpro_site_application_list_');
	}
}

class BookProViewApplications extends BookproJViewLegacy
{
    /**
    ...
    function display($tpl = null)
    {
        ...
        $document->setTitle(JText::_('List of application'));
