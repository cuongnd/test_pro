...
AImporter::model('carcategories');
if (! defined('SESSION_PREFIX')) {
	define('SESSION_PREFIX', 'bookpro_car_categories_list_');
}
AHtml::importIcons();
class BookProViewCarCategories extends BookproJViewLegacy
{
    /**
    ...
    function display($tpl = null)
    {
        ...
        $document->setTitle(JText::_('List of category car'));
