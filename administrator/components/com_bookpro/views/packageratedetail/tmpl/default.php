                        ...
                        <tbody class="table-bordered">
                            <tr>
                                ...
                                for ($k = 0; $k <= $fromToto; $k++) {
                                    ...
                                    //$packagerate = $packagerateModel->getObjectByTourPackageIdAndDate($tourpackage->id, $date);  //var_dump($packagerate->state); die;
                                    ...
                                    <td class="center">    
                                        ...
                                        <input type="text" style="width:46px; height:22px; text-align:center; margin:1px 0 0px 0px; border: 2px solid #fe6612" value="<?php echo $packagerate->child3; ?>" id="<?php echo 'child3' . $packagerate->child3; ?>" name="child3[]">
                                        <br>
                                        ...
                                        <input type="text" style="width:46px; height:22px; text-align:center; margin:1px 1px 1px 0px; " size="7" value="<?php echo $packagerate->adult_promo; ?>" id="<?php echo 'adult_promo' . $packagerate->adult_promo; ?>" name="adult_promo[]">
                                        <br>

                                        <input type="text" style="width:46px; height:22px; text-align:center; margin:1px 0 0px 0px; " value="<?php echo $packagerate->teen_promo; ?>" id="<?php echo 'teen_promo' . $packagerate->teen_promo; ?>" name="teen_promo[]">
                                        <br>

                                        <input type="text" style="width:46px; height:22px; text-align:center; margin:1px 0 0px 0px; " value="<?php echo $packagerate->child_promo; ?>" id="<?php echo 'child_promo' . $packagerate->child_promo; ?>" name="child_promo[]">
                                        <br>
                                        
                                        
                                        <input type="text" style="border: 2px solid #53a853;width:46px; height:22px; text-align:center; margin:1px 1px 1px 0px;border: 2px solid #1a4079" size="7" value="<?php echo $packagerate->pretransfer; ?>" id="<?php echo 'pretransfer' . $packagerate->extra_bed; ?>" name="pretransfer[]">
                                        <br>

                                        <input type="text" style="border: 2px solid #53a853;width:46px; height:22px; text-align:center; margin:1px 1px 1px 0px;border: 2px solid #e19400" size="7" value="<?php echo $packagerate->posttransfer; ?>" id="<?php echo 'posttransfer' . $packagerate->posttransfer; ?>" name="posttransfer[]">
                                        <br>
                                                    ...
                                                    <?php 
                                                       // var_dump($packagerate->available); die;                           
                                                        ...
                                                        if($packagerate->available == 1){
                                                            $check_available_1 = 'checked="checked"' ;
                                                        }elseif($packagerate->available != null && $packagerate->available == 0){
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($packagerate->request == 1){      
                                                            $check_request_1 = 'checked="checked"' ;
                                                        }elseif($packagerate->request != null && $packagerate->request == 0){
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($packagerate->guaranteed == 1){
                                                            $check_guaranteed_1 = 'checked="checked"' ;
                                                        }elseif($packagerate->guaranteed != null && $packagerate->guaranteed == 0){
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($packagerate->close == 1){
                                                            $check_close_1 = 'checked="checked"' ;
                                                        }elseif($packagerate->close != null && $packagerate->close == 0){
