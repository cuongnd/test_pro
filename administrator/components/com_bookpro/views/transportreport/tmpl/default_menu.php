...
<div class='header'><?php echo JText::_('COM_BOOKPRO_REPORT_MENU')?></div>
		<ul>
		<li><span> <?php echo JHtml::link(JURI::base().'index.php?option=com_bookpro&view=transportreport&layout=manage', JText::_('COM_BOOKPRO_REPORT_ADMIN'),'class="mypage_link"') ?>
			</span></li>
			<li><span> <?php echo JHtml::link(JURI::base().'index.php?option=com_bookpro&view=transportreport&layout=driver', JText::_('COM_BOOKPRO_REPORT_DRIVER'),'class="mypage_link"') ?>
			</span></li>
			<li><span> <?php echo JHtml::link(JURI::base().'index.php?option=com_bookpro&view=transportreport&layout=default', JText::_('Sale Report'),'class="mypage_link"') ?>
			</span></li>	
					<!-- 
