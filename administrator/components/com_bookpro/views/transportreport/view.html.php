...
if (! defined('SESSION_PREFIX')) {
	define('SESSION_PREFIX', 'bookpro_transportreport_list_');
}

class BookProViewTransportReport extends JView
{
    /**
    ...
    function display($tpl = null)
    {
        ...
        $this->lists['pay_status']= ARequest::getUserStateFromRequest('pay_status', 'SUCCESS', 'string');
         $this->lists['tour_id']= ARequest::getUserStateFromRequest('tour_id', '', array());        
        $this->lists['type']="TRANSPORT";
