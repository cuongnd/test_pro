...
class BookProViewBookings extends BookproJViewLegacy
{
    /**
    ...
    function display($tpl = null)
    {
        ...
        $this->lists['pay_status']= ARequest::getUserStateFromRequest('pay_status', null , 'string');
        //$this->lists['total']= ARequest::getUserStateFromRequest('total', null , 'int');
        $model->init($this->lists);
        $this->items = &$model->getFullObject();
