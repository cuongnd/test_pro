...
if (! defined('SESSION_PREFIX')) {
	if (IS_ADMIN) {
		define('SESSION_PREFIX', 'bookpro_payment_list_');
	} 
}

class BookProViewPayments extends BookproJViewLegacy
{
    /**
    ...
    function display($tpl = null)
    {
        ...
        $document->setTitle(JText::_('List of payment method'));
        
        $model = new BookProModelPayments();
