...
?>
<div class="span10">
    <form action="<?php echo JRoute::_('index.php?option=com_bookpro&view=documents&obj_id='.JFactory::getApplication()->getUserStateFromRequest('obj_id', 'obj_id', 0)); ?>" method="post" name="adminForm" id="adminForm">
            ...
            <thead>
                <tr>
                    ...
                    <th class="title" width="30%">
                        <?php echo JHTML::_('grid.sort', JText::_('COM_BOOKPRO_DOCUMENT_TITLE'), 'title', $orderDir, $order); ?>
                    </th>
            ...
            <tbody>
                <?php if (!is_array($this->items) || !$itemsCount && $this->tableTotal) { ?>
                    ...
                    for ($i = 0; $i < $itemsCount; $i++) {
                        ...
                        $link = JRoute::_(ARoute::view('document', null, null, array('id' => $subject->id, 'layout' => 'edit')));
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <?php echo JHtml::_('jgrid.published', $subject->state, $i, 'documents.', true, 'cb', $subject->publish_up, $subject->publish_down); ?>
                            </td>
                            <td>
