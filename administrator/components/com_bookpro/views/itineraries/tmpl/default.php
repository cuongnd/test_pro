		...
		<table class="table" cellspacing="1">
			<thead>
				<tr>
					...
					<th width="10%">
                        <?php echo JText::_('COM_BOOKPRO_ADD_HOTEL'); ?>
                    </th>		
				...
				?>
				    	<tr>
				    		...
				    		<td>
                             ...
                             <td>
                              <?php $linkr = ARoute::view('addhotel',null,null,array('intinerary_id'=>$subject->id));?>
                                <a href="<?php echo $linkr;?>" title="New">
                                    <span title="Tour Package">
                                        <img src="<?php echo JURI::root().'components/com_bookpro/assets/images/room/room_manage.png'?>" alt="Add Hotel" class="room_manager">
                                    </span>
                                </a>
                             </td> 
