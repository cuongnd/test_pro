	...
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset>
				...
				<div class="control-group">
					<div class="control-label"><?php echo $this->form->getLabel('baggage_tip'); ?></div>
					<div class="controls"><?php echo $this->form->getInput('baggage_tip'); ?></div>
				</div>
				<div class="control-group">
					<div class="control-label"><?php echo $this->form->getLabel('fare_rule'); ?></div>
					<div class="controls"><?php echo $this->form->getInput('fare_rule'); ?></div>
				</div>
			</fieldset>
		</div>
