...
<form
    action="<?php echo JRoute::_('index.php?option=com_bookpro&view=facilities'); ?>"
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td>
                        <?php if ($item->checked_out) { ?>
                            ...
                            <?php } ?>
                        <a
                            href="<?php echo JRoute::_('index.php?option=com_bookpro&task=facility.edit&id='.$item->id);?>">
