...
<form action="index.php" method="post" name="adminForm" id="adminForm"
	...
	<div class="form-horizontal">
        ...
        jQuery(document).ready(function(){
            ...
            {
                  var tour_id = jQuery('select[name="tour_id"]').val();
                 if(tour_id){
                           jQuery.ajax({
                            type : 'POST',
                            url : 'index.php?option=com_bookpro&controller=tourpackage&task=CheckTourShared&format=raw',
                            data : 'tour_id='+tour_id,
                            async : true,    
                            success : function(result) {  
                                if(result == "shared"){
                                    jQuery("#NoTourShared").hide();
                                }else{
                                    jQuery("#NoTourShared").show();
                                }
                                    ;
                           }
                        });
		...
		<div class="control-group" id="NoTourShared">
