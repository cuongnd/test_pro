...
AImporter::model('tours','packagetypes','roomtypes','hotels');
...
class BookProViewTourPackage extends BookproJViewLegacy
{
	...
	function getTourBox($select, $field = 'tour_id', $autoSubmit = false){
		...
		$lists = $model->getData();
		return AHtml::getFilterSelect($field, JText::_('COM_BOOKPRO_TOUR_SELECT'), $lists, $select, $autoSubmit, 'onchange="CheckTourShared();"', 'id', 'title');
	}
