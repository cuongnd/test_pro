				...
				<tr>
				 ...
				 <!-- 	<th width="15%">
                    ...
                    <th class="center" width="20%">
                        <?php echo JText::_('COM_BOOKPRO_TOUR_RATE_MANAGER'); ?>
                    </th>
                    <th class="center" width="20%">
                        <?php echo JText::_('COM_BOOKPRO_TOUR_ROOM_MANAGER'); ?>
                    </th>					
				    	...
				    	<tr>
				    		...
				    		<td>
                             ...
                             <td class="center">       
                                    ...
                                    <?php $linkpackagerate = ARoute::view('packagerate',null,null,array('tour_id'=>JRequest::getVar('tour_id'),'tourpackage_id'=>$subject->id));?>
                                    <a href="<?php echo $linkpackagerate;?>" title="New"><span title="Rate Manager"><img src="<?php echo JURI::root().'components/com_bookpro/assets/images/room/new_rate.png'?>"
                                        alt="Room" class="rate_manager"></span></a>

                                    <?php $linkrpackageratedetail = ARoute::view('packageratedetail',null,null,array('tour_id'=>JRequest::getVar('tour_id'),'tourpackage_id'=>$subject->id));?>
                                    <a href="<?php echo $linkrpackageratedetail;?>" title="Edit"><span title="Edit Package"><img src="<?php echo JURI::root().'components/com_bookpro/assets/images/room/edit_room.png'?>"
                                ...
                                <td class="center">
                                    ...
                                    <?php $linkroomprice = ARoute::view('roomprice',null,null,array('tour_id'=>JRequest::getVar('tour_id'),'tourpackage_id'=>$subject->id));?>
                                    <a href="<?php echo $linkroomprice;?>" title="New"><span title="Rate Manager"><img src="<?php echo JURI::root().'components/com_bookpro/assets/images/room/new_rate.png'?>" alt="Room" class="rate_manager"></span></a>
                                    <?php $linkroompricedetail = ARoute::view('roompricedetail',null,null,array('tour_id'=>JRequest::getVar('tour_id'),'tourpackage_id'=>$subject->id));?>
                                    <a href="<?php echo $linkroompricedetail;?>" title="Edit"><span title="Edit Package"><img src="<?php echo JURI::root().'components/com_bookpro/assets/images/room/edit_room.png'?>" alt="Room" class="edit_room"></span></a>
                                </td>                                   
