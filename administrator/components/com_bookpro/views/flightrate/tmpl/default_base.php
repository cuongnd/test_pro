<fieldset>
	...
	<div class="control-group">
		<label class="control-label"><?php echo JText::_('COM_BOOKPRO_FLIGHT_ADULT_PRICE'); ?> 
		</label>
		<div class="controls">
			<input class="input-medium required" type="text" placeholder="<?php echo JText::_('COM_BOOKPRO_ADULT'); ?> " name="frate[base][adult]"
						id="adult" maxlength="255" value="" />
			<input class="input-medium required" placeholder="<?php echo JText::_('COM_BOOKPRO_ADULT_ROUNDTRIP'); ?>" type="text"
			name="frate[base][adult_roundtrip]" id="adult_roundtrip" size="60" maxlength="255"
			value="" />
