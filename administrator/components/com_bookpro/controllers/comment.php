...
class BookProControllerComment extends AController
{
	...
	function __construct($config = array())
	{
		...
		$this->_model = $this->getModel('comment');
		$this->_controllerName = CONTROLLER_COMMENT;
	}
	...
	function saveorder()
	{
		...
		ARequest::redirectList(CONTROLLER_COMMENT);
	}
	...
	function save($apply = false)
	{
		...
		if ($apply) {
			ARequest::redirectEdit(CONTROLLER_COMMENT, $id);
		} else {
			ARequest::redirectList(CONTROLLER_COMMENT);
		}
