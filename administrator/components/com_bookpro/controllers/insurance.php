...
class BookProControllerInsurance extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('insurance');
        $this->_controllerName = CONTROLLER_INSURANCE;
    }
    ...
    function display()
    {
        ...
        JRequest::setVar('view', 'insurances');
        parent::display();
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_INSURANCE);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_INSURANCE, $id);
        } else {
            ARequest::redirectList(CONTROLLER_INSURANCE);
        }
