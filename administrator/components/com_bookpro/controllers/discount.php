...
class BookProControllerDiscount extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('discount');
        $this->_controllerName = CONTROLLER_DISCOUNT;
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_DISCOUNT);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_DISCOUNT, $id);
        } else {
            ARequest::redirectList(CONTROLLER_DISCOUNT);
        }
