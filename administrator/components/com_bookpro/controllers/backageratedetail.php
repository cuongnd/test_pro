    ...
    class BookProControllerRoomRateDetail extends AController
    {
        ...
        */
        function save($apply = false)
        {
            ...
            $mainframe = &JFactory::getApplication();
            if($apply){
                $mainframe->redirect('index.php?option=com_bookpro&view=roomratedetail');    
            }else{
                $mainframe->redirect('index.php?option=com_bookpro&view=roomrate');
            }
