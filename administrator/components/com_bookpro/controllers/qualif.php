...
class BookProControllerQualif extends AController
{
	...
	function __construct($config = array())
	{
		...
		$this->_model = $this->getModel('qualif');
		$this->_controllerName = CONTROLLER_QUALIF;
	}
	...
	function saveorder()
	{
		...
		ARequest::redirectList(CONTROLLER_QUALIF);
	}
	...
	function save($apply = false)
	{
		...
		if ($apply) {
			ARequest::redirectEdit(CONTROLLER_QUALIF, $id);
		} else {
			ARequest::redirectList(CONTROLLER_QUALIF);
		}
