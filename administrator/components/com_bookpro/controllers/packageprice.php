 ...
 * @version 	$Id: packageprice.php 23 2012-07-08 02:20:56Z quannv $
 **/
...
class BookProControllerPackagePrice extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('packageprice');
        $this->_controllerName = CONTROLLER_PACKAGEPRICE;
    }
    ...
    function display()
    {
        ...
        JRequest::setVar('view', 'packageprices');
        parent::display();
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_PACKAGEPRICE);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_PACKAGEPRICE, $id);
        } else {
            ARequest::redirectList(CONTROLLER_PACKAGEPRICE);
        }
