...
class BookProControllerPackageType extends AController
{
	...
	function __construct($config = array())
	{
		...
		$this->_model = $this->getModel('packagetype');
		$this->_controllerName = CONTROLLER_PACKAGETYPE;
	}
	...
	function display()
	{
		switch ($this->getTask()) {
			...
			case 'trash':
				...
				break;
			default:
				JRequest::setVar('view', 'packagetypes');
		}
	...
	function saveorder()
	{
		...
		ARequest::redirectList(CONTROLLER_PACKAGETYPE);
	}
	...
	function save($apply = false)
	{
		...
		if ($apply) {
			ARequest::redirectEdit(CONTROLLER_PACKAGETYPE, $id);
		} else {
			ARequest::redirectList(CONTROLLER_PACKAGETYPE);
		}
