...
class BookProControllerMailTemplate extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('mailtemplate');
        $this->_controllerName = CONTROLLER_MAILTEMPLATE;
    }
    ...
    function display()
    {
        ...
        JRequest::setVar('view', 'mailtemplates');
        parent::display();
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_MAILTEMPLATE);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_MAILTEMPLATE, $id);
        } else {
            ARequest::redirectList(CONTROLLER_MAILTEMPLATE);
        }
