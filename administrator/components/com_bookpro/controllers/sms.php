 ...
 * @version 	$Id: sms.php 66 2012-07-31 23:46:01Z quannv $
 **/
...
class BookProControllerSms extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('sms');
        $this->_controllerName = CONTROLLER_SMS;
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_SMS);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_SMS, $id);
        } else {
            ARequest::redirectList(CONTROLLER_SMS);
        }
