...
class BookProControllerRoomType extends AController
{
	...
	function __construct($config = array())
	{
		...
		$this->_model = $this->getModel('roomtype');
		$this->_controllerName = CONTROLLER_ROOMTYPE;
	}
	...
	function display()
	{
		switch ($this->getTask()) {
			...
			case 'trash':
				...
				break;
			default:
				JRequest::setVar('view', 'roomtypes');
		}
	...
	function saveorder()
	{
		...
		ARequest::redirectList(CONTROLLER_ROOMTYPE);
	}
	...
	function save($apply = false)
	{
		...
		if ($apply) {
			ARequest::redirectEdit(CONTROLLER_ROOMTYPE, $id);
		} else {
			ARequest::redirectList(CONTROLLER_ROOMTYPE);
		}
