 ...
 * @version 	$Id: payment.php 66 2012-07-31 23:46:01Z quannv $
 **/
...
class BookProControllerPayment extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('payment');
        $this->_controllerName = CONTROLLER_PAYMENT;
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_PAYMENT);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_PAYMENT, $id);
        } else {
            ARequest::redirectList(CONTROLLER_PAYMENT);
        }
