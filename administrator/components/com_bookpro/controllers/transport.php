...
class BookProControllerTransport extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('transport');
        $this->_controllerName = CONTROLLER_TRANSPORT;
    }
    ...
    function display()
    {
        ...
        JRequest::setVar('view', 'transports');
        parent::display();
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_TRANSPORT);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_TRANSPORT, $id);
        } else {
            ARequest::redirectList(CONTROLLER_TRANSPORT);
        }
