<?php
    ...
    AImporter::model('flightratelogs', 'flightratelog');

    class BookProControllerFlightRateLog extends AController
    {
        ...
        function __construct($config = array())
        {
            ...
            $this->_model = $this->getModel('flightratelog');
            $this->_controllerName = CONTROLLER_FLIGHT_RATE_LOG;
        }
        ...
        function display()
        {
            switch ($this->getTask()) {
                ...
                case 'trash':
                    ...
                    break;
                default:
                    JRequest::setVar('view', 'flightratelogs');
            }
        ...
        */
        function saveorder()
        {
            ...
            ARequest::redirectList(CONTROLLER_FLIGHT_RATE_LOG);
        }
...
/*            if($post['startdate']){
            ...
            if ($apply) {
                ARequest::redirectEdit(CONTROLLER_FLIGHT_RATE_LOG, $id);
            } else {
                ARequest::redirectList(CONTROLLER_FLIGHT_RATE_LOG);
            }
