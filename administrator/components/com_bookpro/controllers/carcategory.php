...
class BookProControllerCarCategory extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('carcategory');
        $this->_controllerName = CONTROLLER_CAR_CATEGORY;
    }
    ...
    function display()
    {
        ...
        JRequest::setVar('view', 'carcategories');
        parent::display();
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_CAR_CATEGORY);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_CAR_CATEGORY, $id);
        } else {
            ARequest::redirectList(CONTROLLER_CAR_CATEGORY);
        }
