...
class BookProControllerCarDestination extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('cardestination');
        $this->_controllerName = CONTROLLER_CAR_DESTINATION;
    }
    ...
    function display()
    {
        ...
        JRequest::setVar('view', 'cardestinations');
        parent::display();
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_CAR_DESTINATION);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_CAR_DESTINATION, $id);
        } else {
            ARequest::redirectList(CONTROLLER_CAR_DESTINATION);
        }
