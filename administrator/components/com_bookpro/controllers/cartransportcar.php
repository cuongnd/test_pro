...
class BookProControllerCarTransportCar extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('cartransportcar');
        $this->_controllerName = CONTROLLER_CAR_TRANSPORT_CAR;
    }
    ...
    function display()
    {
        ...
        JRequest::setVar('view', 'cartransportcars');
        parent::display();
    }
    ...
    function editing()
    {
        parent::editing('cartransportcar');
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_CAR_TRANSPORT_CAR);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_CAR_TRANSPORT_CAR, $id);
        } else {
            ARequest::redirectList(CONTROLLER_CAR_TRANSPORT_CAR);
        }
