...
class BookProControllerRegion extends AController
{
 var $_model;
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('region');
        $this->_controllerName = CONTROLLER_REGION;
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_REGION);
    }
    ...
    function save($apply = false)
    {
       ...
       // $post['desc'] = JRequest::getVar('desc', '', 'post', 'string', JREQUEST_ALLOWRAW);
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_REGION, $id);
        } else {
            ARequest::redirectList(CONTROLLER_REGION);
        }
