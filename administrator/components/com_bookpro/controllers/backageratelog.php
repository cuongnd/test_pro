<?php
    ...
    AImporter::model('roomratelogs', 'roomratelog');

    class BookProControllerRoomRateLog extends AController
    {
        ...
        function __construct($config = array())
        {
            ...
            $this->_model = $this->getModel('roomratelog');
            $this->_controllerName = CONTROLLER_ROOM_RATE_LOG;
        }
        ...
        function display()
        {
            switch ($this->getTask()) {
                ...
                case 'trash':
                    ...
                    break;
                default:
                    JRequest::setVar('view', 'roomratelogs');
            }
        ...
        */
        function saveorder()
        {
            ...
            ARequest::redirectList(CONTROLLER_ROOM_RATE_LOG);
        }
...
/*            if($post['startdate']){
            ...
            if ($apply) {
                ARequest::redirectEdit(CONTROLLER_ROOM_RATE_LOG, $id);
            } else {
                ARequest::redirectList(CONTROLLER_ROOM_RATE_LOG);
            }
