 ...
 * @version 	$Id: cgroup.php 66 2012-07-31 23:46:01Z quannv $
 **/
...
class BookProControllerCGroup extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('cgroup');
        $this->_controllerName = CONTROLLER_CGROUP;
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_CGROUP);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_CGROUP, $id);
        } else {
            ARequest::redirectList(CONTROLLER_CGROUP);
        }
