...
class BookProControllerCar extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('car');
        $this->_controllerName = CONTROLLER_CAR;
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_CAR);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_CAR, $id);
        } else {
            ARequest::redirectList(CONTROLLER_CAR);
        }
