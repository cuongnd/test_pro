...
class BookProControllerAirport extends AController
{
    ...
    function __construct($config = array())
    {
        ...
        $this->_model = $this->getModel('airport');
        $this->_controllerName = CONTROLLER_AIRPORT;
    }
    ...
    function saveorder()
    {
        ...
        ARequest::redirectList(CONTROLLER_AIRPORT);
    }
    ...
    function save($apply = false)
    {
        ...
        if ($apply) {
            ARequest::redirectEdit(CONTROLLER_AIRPORT, $id);
        } else {
            ARequest::redirectList(CONTROLLER_AIRPORT);
        }
