...
if ($Itemid) {
    ...
    $show_main_menu = $params->get('show_main_menu', 1);
    $displayHeader = $params->get('show_page_heading', 1);
...
$doc->addScriptVersion(Juri::root() . 'administrator/templates/' . $this->template . '/js/template.js');

// Add Stylesheets
$doc->addStyleSheetVersion(Juri::root() . 'administrator/templates/' . $this->template . '/css/template' . ($this->direction == 'rtl' ? '-rtl' : '') . '.css');
...
<body
    ...
    <?php if ($stickyToolbar) : ?>data-spy="scroll" data-target=".subhead" data-offset="87"<?php endif; ?>>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand hidden-desktop hidden-tablet" href="<?php echo JUri::root(); ?>"
                ...
                <div<?php echo ($this->params->get('admin_menus') != '0') ? ' class="nav-collapse"' : ''; ?>>
                    ...
                    <a class="brand visible-desktop visible-tablet" href="<?php echo JUri::root(); ?>"
                       title="<?php echo JText::sprintf('TPL_ISIS_PREVIEW', $sitename); ?>"
                       target="_blank"><?php echo JHtml::_('string.truncate', $sitename, 14, false, false); ?>
                        <span class="icon-out-2 small"></span></a>
                </div>
...
<?php else : ?>
    <div class="space-toolbar" style="margin-bottom: 20px;<?php echo $show_toolbar ? 'display:none;' : '' ?>"></div>
<?php endif; ?>
<!-- container-fluid -->
