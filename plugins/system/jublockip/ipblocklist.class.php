...
/*
**  class IpList( <list_str> );
**
**      Must provide the IP list string
**
**  Methods:
...
class IpList {
	...
	public function __construct( $list_str ) {
		$contents = array();
		$this->ip_str = $list_str;
		$lines = $this->strtoarray( $list_str );
	...
	*/
	...
	/*
	** private function that convert string into array
	*/
...
/*
**  class IpBlockList( <whitelist_str>, <blacklist_str> );
**
** 
**  methods:
...
class IpBlockList {
	...
	public function __construct( $whitelist_str = '', 
									$blacklist_str = '' ) {
		$this->whitelist_str = $whitelist_str;
		$this->blacklist_str = $blacklist_str;
		
		$this->whitelist = new IpList( $whitelist_str );
		$this->blacklist = new IpList( $blacklist_str );
	}
