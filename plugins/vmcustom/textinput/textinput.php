 ...
 * http://virtuemart.org
 */
if (!class_exists( 'VmcConfig' )) require(JPATH_VMC .DS.'helpers'.DS.'config.php');
$config= VmcConfig::loadConfig();
if (!class_exists('vmCustomPlugin')) require(JPATH_VMC_PLUGINS . DS . 'vmcustomplugin.php');
