...
abstract class JHtmlBehavior
{
	...
	public static function colorpicker()
	{
		...
		$doc=JFactory::getDocument();
		$scriptId='lib_sms_html_behavior_colorpicker';
		$ajaxCallFunction='setMinicolors';
		ob_start();
		?>
	...
	public static function simplecolorpicker()
	{
		...
		$doc=JFactory::getDocument();
		$scriptId='lib_cms_html_form_behavior_simplecolorpicker';
		$ajaxCallFunction='setSimpleColors';
		ob_start();
		?>
		<script type="text/javascript" id="<?php echo $scriptId ?>">
			<?php
