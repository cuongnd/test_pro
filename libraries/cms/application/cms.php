...
require_once JPATH_ROOT.'/libraries/joomla/application/web.php';
/**
...
class JApplicationCms extends JApplicationWeb
{
	...
	public static function getInstance($name = null)
	{
		if (empty(static::$instances[$name]))
		{
			...
			{
                require_once JPATH_ROOT.'/libraries/loader.php';
                require_once JPATH_ROOT.'/libraries/joomla/language/text.php';
	...
	public function redirect($url, $moved = false)
	{
        ...
        JLog::addLogger(array('text_file' =>'juri_flow1.text','text_file_path'=>'logs'),JLog::ALL,array('juri_flow1'));
        JLog::add('class:'.__CLASS__, JLog::DEBUG);
        JLog::add('legacy $url:'.$url, JLog::DEBUG);
