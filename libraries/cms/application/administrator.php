 ...
 */
require_once JPATH_ROOT.'/libraries/cms/application/cms.php';
...
class JApplicationAdministrator extends JApplicationCms
{
	...
	public function dispatch($component = null)
	{
		if ($component === null)
		{
            require_once JPATH_ROOT.'/administrator/includes/helper.php';
	...
	public function getTemplate($params = false)
	{
		...
		$query = $db->getQuery(true)
			->select('s.template, s.params,s.home')
	...
	public function login($credentials, $options = array())
	{
		...
		{
			$options['entry_url'] = JUri::root() . 'index.php?option=com_users&task=login';
		}
