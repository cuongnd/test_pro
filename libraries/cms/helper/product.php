...
/**
 * Helper for standard Product style extensions.
...
class JHelperProduct
{
	 ...
	 *
	 * @since   3.1
	 * @deprecated  3.2  Use JHelperProduct::getActions() instead
	 */
	public static function _getActions($categoryId = 0, $id = 0, $assetName = '')
	{
		// Log usage of deprecated function
		JLog::add(__METHOD__ . '() is deprecated, use JHelperProduct::getActions() with new arguments order instead.', JLog::WARNING, 'deprecated');
