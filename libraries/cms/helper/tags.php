...
class JHelperTags extends JHelper
{
	 ...
	 * @since   3.1
	 */
	public function addTagMapping($ucmId, JObservableInterface $table, $tags = array())
	{
		$db = $table->getDbo();
	 ...
	 * @since   3.1
	 */
	public function deleteTagData(CategoriesTableCategory $table, $contentItemId)
	{
	 ...
	 * @since   3.1
	 */
	public function postStoreProcess(JObservableInterface $table, $newTags = array(), $replace = true)
	{
	 ...
	 * @since   3.1
	 */
	public function preStoreProcess(JObservableInterface $table, $newTags = array())
	{
		if ($newTags != array())
		{
	 ...
	 * @since   3.1
	 */
	public function tagItem($ucmId, JObservableInterface $table, $tags = array(), $replace = true)
	{
	 ...
	 * @since   3.1
	 */
	public function unTagItem($contentId, JObservableInterface $table, $tags = array())
	{
		$key = $table->getKeyName();
		$id = $table->$key;
		$db = JFactory::getDbo();
