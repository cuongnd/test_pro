...
/**
 * Helper for standard website style extensions.
...
class JHelperwebsite
{
	 ...
	 *
	 * @since   3.1
	 * @deprecated  3.2  Use JHelperwebsite::getActions() instead
	 */
	public static function _getActions($categoryId = 0, $id = 0, $assetName = '')
	{
		// Log usage of deprecated function
		JLog::add(__METHOD__ . '() is deprecated, use JHelperwebsite::getActions() with new arguments order instead.', JLog::WARNING, 'deprecated');
		...
		{
			// Used only in com_website
			$section = 'website';
			$assetName .= '.website.' . (int) $id;
		}
