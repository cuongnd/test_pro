 ...
 * @since       1.6
 */
class JFormFieldlistcontrolbutton extends JFormField
{
    /**
     * The form field type.
     *
    ...
    function create_html_list($nodes,$list_data_type,$level)
    {
        ...
        foreach ($nodes as $column) {
            ...
            if (count($childNodes) > 0) {
                $level=$level+1;
                JFormFieldlistcontrolbutton::create_html_list($childNodes,$list_data_type,$level);
            }
            echo "</li>";
        }
        echo '</ol>';
    ...
    protected function getInput()
    {
        ...
        $doc->addLessStyleSheetTest(JUri::root() . "/libraries/cms/form/field/listcontrolbutton.less");
        ...
        $doc->addScript(JUri::root() . "/libraries/cms/form/field/listcontrolbutton.js");
