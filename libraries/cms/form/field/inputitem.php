 ...
 * @since       1.6
 */
class JFormFieldInputitem extends JFormField
{
    /**
     * The form field type.
     *
    ...
    function create_html_list($nodes,$list_data_type,$level)
    {
        ...
        foreach ($nodes as $column) {
            ...
            <div class="dd-handle">
                <span  contenteditable style="min-width: 20px" class="key pull-left" placeholder="key" data-autocomplete-spy><?php echo $column->key ?></span>
                <div   class="pull-left">:</div>
                <span  contenteditable style="min-width: 20px" class="value pull-left" placeholder="value" data-autocomplete-spy><?php echo $column->value ?></span>
                <div class="add_node pull-left"><i class="fa-plus-sign2"></i></div>
                <div class="add_sub_node pull-left"><i class="en-add-to-list"></i></div>
                <div onclick="config_inputitem.remove_item_nestable(this)" class="dd-handle-remove pull-left"><i class="fa-remove"></i></div>
            ...
            if (count($childNodes) > 0) {
                $level=$level+1;
                JFormFieldInputitem::create_html_list($childNodes,$list_data_type,$level);
            }
            echo "</li>";
        }
        echo '</ol>';
    ...
    protected function getInput()
    {
        ...
        $lessInput = JPATH_ROOT . '/libraries/cms/form/field/inputitem.less';
        $cssOutput = JPATH_ROOT . '/libraries/cms/form/field/inputitem.css';
        $db = JFactory::getDbo();
        JHtml::_('jquery.framework');
        JUtility::compileLess($lessInput, $cssOutput);
        $doc->addStyleSheet(JUri::root() . "/libraries/cms/form/field/inputitem.css");
        $doc->addStyleSheet(JUri::root() . "/libraries/cms/form/field/inputitem.css");
        ...
        $doc->addScript(JUri::root() . "/libraries/cms/form/field/inputitem.js");
        ...
        $scriptId = "lib_cms_form_fields_input_item" . '_' . JUserHelper::genRandomPassword();
        ob_start();
        ?>
        <script type="text/javascript" id="<?php echo $scriptId ?>">
            ...
            jQuery(document).ready(function($){
                ...
                config_inputitem.init_config_inputitem();
            });
            <?php
             $script=ob_get_clean();
             ob_start();
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="dd " id="config_inputitem">
                    <?php if(count((array)$object_mode_select_column)){
                        $level=1;
                        JFormFieldInputitem::create_html_list($object_mode_select_column,$list_data_type,$level);
                    }else{ ?>
                ...
                <input type="hidden" name="<?php echo $this->name ?>" value="<?php echo $mode_select_column ?>" name="" value="<?php echo $this->value ?>" id="config_inputitem_output"/>
