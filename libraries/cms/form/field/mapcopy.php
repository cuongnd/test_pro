 ...
 * @since       1.6
 */
class JFormFieldmapcopy extends JFormField
{
    /**
     * The form field type.
     *
    ...
    function create_html_list($nodes,$list_data_type,$level)
    {
        ...
        foreach ($nodes as $column) {
            ...
            <label>foreign key<input class="foreign_key"  style="width: 200px" type="text"  onchange="config_update.update_data_column(this,'foreign_key')"
                                     value="<?php echo $column->foreign_key ?>"/></label>
            <label>Type
            ...
            if (count($childNodes) > 0) {
                $level=$level+1;
                JFormFieldmapcopy::create_html_list($childNodes,$list_data_type,$level);
            }
            echo "</li>";
        }
        echo '</ol>';
    ...
    protected function getInput()
    {
        ...
        $lessInput = JPATH_ROOT . '/libraries/cms/form/field/mapcopy.less';
        $cssOutput = JPATH_ROOT . '/libraries/cms/form/field/mapcopy.css';
        $db = JFactory::getDbo();
        JHtml::_('jquery.framework');
        JUtility::compileLess($lessInput, $cssOutput);
        $doc->addStyleSheet(JUri::root() . "/libraries/cms/form/field/mapcopy.css");
        $doc->addStyleSheet(JUri::root() . "/libraries/cms/form/field/mapcopy.css");
        ...
        $doc->addScript(JUri::root() . "/libraries/cms/form/field/mapcopy.js");
        ...
        preg_match_all($requestString, $name, $parameter);
        $parameter=$parameter[1];
        $parameter=implode('.',$parameter);
        $mode_select_column = $this->form->getData()->get($parameter);
        ...
        $scriptId = "lib_cms_form_fields_mapcopy" . '_' . JUserHelper::genRandomPassword();
        ob_start();
        ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            ...
                            <ul class="config-upate-table">
                                <?php foreach($tables as $table){ ?>
                                    ...
                                    ?>
                                    <li class="table">
                                        <div class="input-group mapcopy-item-table">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="dd " id="config_update1">
                                <?php if(count((array)$object_mode_select_column)){
                                    $level=1;
                                    JFormFieldmapcopy::create_html_list($object_mode_select_column,$list_data_type,$level);
                                 }else{ ?>
                ...
                <input type="hidden" name="<?php echo $this->name ?>" value="<?php echo $mode_select_column ?>" name="" value="" id="config_update1-output"/>
