    ...
    list_control_button_config={
        ...
        option_droppable:{
            ...
            drop: function(ev,ui){
                ...
                {
                    list_control_button_config.render_table_fields(uiDraggable,droppable);
                }else if(uiDraggable.hasClass('configupdate-item-field')){
                    list_control_button_config.render_table_field(uiDraggable,droppable);
                }
            }
        },
        option_nestable:{
            ...
            dragStop:function(e,el,dragEl){
                //list_control_button_config.move_element(e,el,dragEl);
            }
        },

        init_config_nestable:function(){
            $('#field_block').nestable(list_control_button_config.option_nestable)
                .on('change', list_control_button_config.updateOutput);
        ...
        init_list_control_button_config:function(){
            $('.add_node').click(function add_node_click(){
                list_control_button_config.add_node($(this));
            });
            $('.add_sub_node').click(function add_sub_node_click(){
                list_control_button_config.add_sub_node($(this));
            });
            ...
            $(document).on('change','.menu_access_level',function(){
                ...
                list_control_button_config.update_menu_item(id,list_keys_values);

            });

            list_control_button_config.set_auto_complete();
            // activate Nestable for list 1
            list_control_button_config.init_config_nestable();
            list_control_button_config.init_append_grid();
            list_control_button_config.update_nestable();
        ...
        init_append_grid:function(){
            $('.tbl_append_grid').each(function(){
                ...
                list_control_button_config.append_grid_option.initData=config_params;
                $('#'+id).appendGrid( list_control_button_config.append_grid_option);
            ...
            $('.tbl_append_grid_config_property').each(function(){
                ...
                list_control_button_config.append_grid_option_config_property.initData=config_property;
                $('#'+id).appendGrid( list_control_button_config.append_grid_option_config_property);
        ...
        save_fields:function(close){
            ...
            list_control_button_config.update_data_grid();
        ...
        {
            list_control_button_config.save_fields(1);

        },
        save:function()
        {
            list_control_button_config.save_fields(0);
        },
        cancel:function()
        {
            $('.panel.extension-module-config').remove();
        ...
        add_node:function(self){
            ...
            li_clone.find(".icon").select2(list_control_button_config.icon_option);
            ...
            li_clone.find(".select_field_name").select2(list_control_button_config.field_name_option);
            ...
            list_control_button_config.reset_append_grid_option(li_clone);
            list_control_button_config.reset_append_grid_config_property(li_clone);
        ...
        reset_append_grid_option:function(element){
            ...
            var id=  list_control_button_config.makeid();
            ...
            list_control_button_config.append_grid_option.initData=[];
            element.find('.tbl_append_grid').appendGrid(list_control_button_config.append_grid_option);
        ...
        reset_append_grid_config_property:function(element){
            ...
            list_control_button_config.append_grid_option_config_property.initData=[];
            element.find('.tbl_append_grid_config_property').appendGrid(list_control_button_config.append_grid_option_config_property);
        ...
        add_sub_node:function(self){
            ...
            li_clone.find('.select2-container.icon').remove();
            li_clone.find('input.icon').removeClass('select2-offscreen').removeData();
            li_clone.find("input.icon").select2(list_control_button_config.icon_option);

            li_clone.find('.select2-container.select_field_name').remove();
            li_clone.find('input.select_field_name').removeClass('select2-offscreen').removeData();
            li_clone.find("input.select_field_name").select2(list_control_button_config.field_name_option);
        ...
        call_on_change:function(self){
            ...
            $('input[type="radio"][name="'+name+'"]').each(function(){
                list_control_button_config.update_data_column(this,'home','radio');
            });
        },
        set_auto_complete:function(){
            $(".select_field_name").select2(list_control_button_config.field_name_option);
            $(".icon_menu_item").select2(list_control_button_config.icon_option);
            $(".column_access").select2(list_control_button_config.access_option);
            $(".field_type").select2();
        },
        update_nestable:function(){
            list_control_button_config.updateOutput($('#field_block').data('output', $('#field_block-output')));
