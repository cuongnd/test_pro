...
defined('JPATH_PLATFORM') or die(__FILE__);
...
class JTwitterStatuses extends JTwitterObject
{
	 ...
	 * @param   boolean  $omit_script  Specifies whether the embedded Tweet HTML should include a <script type="text/javascript"> element pointing to widgets.js. In cases where
