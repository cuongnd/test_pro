...
abstract class JDatabaseDriver extends JDatabase implements JDatabaseInterface
{
	...
	public function setNullCallStacks()
	{
		$this->callStacks=array();
	}
	...
	public function replaceTableProduct($query,$website_id)
	{
		$query=str_replace('#__product','#__product_'.$website_id,$query);
		return $query;
	}
	/**
