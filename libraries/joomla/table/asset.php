	...
	public function getRootId()
	{
        ...
        if(!$result)
        {
            $query->clear()
                ...
                ->set('name='.$query->q('root.1'))
                ->set('alias='.$query->q('root'))
                ->set('title='.$query->q('Root Asset'))
                ->set('rules='.$query->q('{"core.login.site":{"6":1,"2":1},"core.login.admin":{"6":1},"core.login.offline":[],"core.admin":{"8":1},"core.manage":{"7":1},"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'))
                ;
            $this->_db->setQuery($query);
            if(!$this->_db->execute())
            {
