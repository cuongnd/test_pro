...
class JFormFieldColor extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $doc->addScript(JUri::root() . '/media/system/js/colorpicker/js/colorpicker.js');
        $doc->addStyleSheet(JUri::root().'/media/system/js/colorpicker/css/colorpicker.css');
...
// Initialize some field attributes.
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                $('input[name="<?php echo $this->name ?>"]').ColorPicker({
