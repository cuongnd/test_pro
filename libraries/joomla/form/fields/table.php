...
class JFormFieldTable extends JFormField
{
	...
	protected function getInput()
	{
		...
		<select name="<?php echo $this->name ?>" id="<?php echo $this->id ?>" <?php echo $class ?> >
			...
			<?php foreach($list_table as $item){ ?>
				<?php

				$item=str_replace($db->getPrefix(),'',$item);
				?>
