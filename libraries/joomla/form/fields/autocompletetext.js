...
(function ($) {
    ...
    // here we go!
    $.autocomplete_text = function (element, options) {
    ...
    $.fn.autocomplete_text = function (options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function () {
            // if plugin has not already been attached to the element
            if (undefined == $(this).data('autocomplete_text')) {
                var plugin = new $.autocomplete_text(this, options);
                $(this).data('autocomplete_text', plugin);
