...
require_once JPATH_ROOT.'/libraries/google-api-php-client-master/src/Google/IO/Exception.php';
require_once JPATH_ROOT.'/libraries/google-api-php-client-master/src/Google/Http/CacheParser.php';
