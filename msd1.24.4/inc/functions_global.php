...
function MSDHeader($kind=0)
{
	...
	$r.='<script language="JavaScript" src="js/jquery-1.8.2.min.js" type="text/javascript"></script>'."\n";
	$r.='<script language="JavaScript" src="js/script.js" type="text/javascript"></script>'."\n";
	$r.='<script language="JavaScript" src="js/jquery.shiftcheckbox.js" type="text/javascript"></script>'."\n";
