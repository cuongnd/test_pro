...
$doc->addLessStyleSheet(JUri::root() . '/components/com_components/views/component/tmpl/assets/less/view_component_config.less');
$db = JFactory::getDbo();
...
$doc->addScript(JUri::root() . "/components/com_components/views/component/tmpl/assets/js/view_component_config.js");
