 ...
 * @since       1.6
 */
class websitetemplateproModelraovat extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_websitetemplatepro.raovat', 'raovat', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_websitetemplatepro.edit.raovat.data', array());
		...
		$this->preprocessData('com_websitetemplatepro.raovat', $data);
