 ...
 * @since       1.6
 */
class websitetemplateproModelmywebsite extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_websitetemplatepro.mywebsite', 'mywebsite', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_websitetemplatepro.edit.mywebsite.data', array());
		...
		$this->preprocessData('com_websitetemplatepro.mywebsite', $data);
