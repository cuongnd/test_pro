 ...
 * @since       1.6
 */
class websitetemplateproModelproduct extends JModelAdmin
{
	/**
	 * @var     string  The help screen key for the module.
	 * @since   1.6
	 */
	protected $helpKey = 'JHELP_EXTENSIONS_product_MANAGER_EDIT';
	...
	/**
	 * @var     array  An array of cached product items.
	 * @since   1.6
	 */
	protected $_cache;
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_websitetemplatepro.product', 'product', array('control' => 'jform', 'load_data' => $loadData));
    ...
    public function save($data){
        ...
        if($ok)
        {
            ...
            $product_path="webstore/$product.ini";
            jimport('joomla.filesystem.file');
            $write_ok=JFile::write(JPATH_ROOT.DS.$product_path,$website_id);
            if(!$write_ok)
            {
                $this->setError('cannot write file product');
            }
        }
        return $ok;
    }
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_websitetemplatepro.edit.product.data', array());
		...
		$this->preprocessData('com_websitetemplatepro.product', $data);
