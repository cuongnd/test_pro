 ...
 * @since       1.5
 */
class websitetemplateproViewdomains extends JViewLegacy
{
	protected $items;
	...
	{
		require_once JPATH_ROOT.DS.'components/website/website_websitetemplatepro/com_websitetemplatepro/helpers/domains.php';
