...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_websitetemplatepro&task=ddomains.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-domains-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_websitetemplatepro&view=domains'); ?>" method="post" name="adminForm" id="adminForm">
                            ...
                            <td>
                                ...
                                <?php if ($canEdit) : ?>
                                    <a class="quick-edit-title"
                                       href="<?php echo JRoute::_('index.php?option=com_websitetemplatepro&task=domain.edit&id=' . (int)$item->id); ?>">
