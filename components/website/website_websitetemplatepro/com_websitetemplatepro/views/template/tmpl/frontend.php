...
$doc->addLessStyleSheetTest(JUri::root().'/components/website/website_websitetemplatepro/com_websitetemplatepro/assets/less/view_product_frontend.less');
$doc->addScript(JUri::root().'/media/system/js/BobKnothe-autoNumeric/autoNumeric.js');
$doc->addScript(JUri::root().'/components/website/website_websitetemplatepro/com_websitetemplatepro/assets/js/view_product_frontend.js');
...
<div class="view-product-frontend">
    ...
    <div class="row form-group" >
        <div class="col-md-8" style="text-align: center">
            <a href="<?php echo JRoute::_('index.php?option=com_websitetemplatepro&view=product&layout=demo&id='.$this->item->id) ?>" class="btn btn-primary btn-lg demo"><i class="im-earth"></i><?php echo JText::_('Demo') ?></a>
        </div>
