...
$input=$app->input;
$template_id=$input->getInt('template_id',0);
JHtml::_('behavior.formvalidation');
JHtml::_('formbehavior.chosen', 'select');
$doc=JFactory::getDocument();
$doc->addLessStyleSheetTest(JUri::root().'components/website/website_websitetemplatepro/com_websitetemplatepro/assets/less/view_template_demo.less');
...
$doc->addScript(JUri::root().'components/website/website_websitetemplatepro/com_websitetemplatepro/assets/js/view_template_demo.js');
$script_id = "script_view_product_demo";
ob_start();
?>
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        $('.view-template-demo').view_template_demo({
...
<div class="view-template-demo">
    ...
    <div class="row form-group" >
        <div class="col-md-12" style="text-align: center">
            <iframe class="demo" src="http://www.<?php echo  $this->item->link_demo ?>"></iframe>
        </div>
