 ...
 * @since       1.5
 */
class websitetemplateproViewlistraovat extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		if (!count($this->items))
		{
			JFactory::getApplication()->enqueueMessage(
				JText::_('com_websitetemplatepro_MSG_MANAGE_NO_websitetemplatepro'),
				'warning'
			);
		}
	...
	{
		require_once JPATH_ROOT.'/components/website/website_websitetemplatepro/com_websitetemplatepro/helpers/listraovat.php';
		$canDo = listraovatHelper::getActions('com_websitetemplatepro');
