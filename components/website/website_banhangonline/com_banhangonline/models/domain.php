 ...
 * @since       1.6
 */
class banhangonlineModeldomain extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_banhangonline.domain', 'domain', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_banhangonline.edit.domain.data', array());
		...
		$this->preprocessData('com_banhangonline.domain', $data);
