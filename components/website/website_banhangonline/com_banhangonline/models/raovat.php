 ...
 * @since       1.6
 */
class banhangonlineModelraovat extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_banhangonline.raovat', 'raovat', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_banhangonline.edit.raovat.data', array());
		...
		$this->preprocessData('com_banhangonline.raovat', $data);
