 ...
 * @since       1.6
 */
class banhangonlineModelmywebsite extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_banhangonline.mywebsite', 'mywebsite', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_banhangonline.edit.mywebsite.data', array());
		...
		$this->preprocessData('com_banhangonline.mywebsite', $data);
