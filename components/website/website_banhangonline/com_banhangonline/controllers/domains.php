...
/**
 * banhangonline list controller class.
 *
 * @package     Joomla.Administrator
 * @subpackage  com_banhangonline
 * @since       1.6
 */
class banhangonlineControllerdomains extends JControllerAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'domain', $prefix = 'banhangonlineModel', $config = array('ignore_request' => true))
	{
    ...
    public function ajaxSaveForm()
    {
        ...
        try {
            ...
            {
                $return=array(
                    JText::_('COM_banhangonline_ERROR_NO_banhangonline_SELECTED')
                );
            ...
            $return=array(
                JText::plural('COM_banhangonline_N_banhangonline_DUPLICATED', count($pks))
            );
            die(json_encode($return));
        } catch (Exception $e)
        {
    ...
    public function ajax_load_component(){
        $view = &$this->getView('banhangonline', 'html', 'banhangonlineView');
