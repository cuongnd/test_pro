...
<div class="view-website-edit">
    <form action="<?php echo JRoute::_('index.php?option=com_supperadmin&view=user&id='.(int) $this->item->id); ?>" method="post"  name="adminForm" id="adminForm" class="form-validate">
