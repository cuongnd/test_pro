...
$doc->addLessStyleSheet(JUri::root().'/components/website/website_banhangonline/com_banhangonline/assets/less/view_raovat_default.less');
$doc->addScript(JUri::root().'/components/website/website_banhangonline/com_banhangonline/assets/js/view_raovat_default.js');
