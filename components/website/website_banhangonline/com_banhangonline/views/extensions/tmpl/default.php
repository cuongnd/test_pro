...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_banhangonline&task=extensions.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-extensions-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_banhangonline&view=extensions'); ?>" method="post"
