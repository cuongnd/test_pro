 ...
 * @since       1.6
 */
class cpanelModeldomain extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_cpanel.domain', 'domain', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_cpanel.edit.domain.data', array());
		...
		$this->preprocessData('com_cpanel.domain', $data);
