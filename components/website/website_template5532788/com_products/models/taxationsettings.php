...
class productsModelTaxationSettings extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_supperadmin.taxationsettings', 'taxationsettings', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_products.edit.taxationsettings.data', array());
		...
		$this->preprocessData('com_supperadmin.taxationsettings', $data);
