...
class productsModelConfig extends JModelAdmin
{
	 ...
	 * @since   1.6
	 */
	protected $helpKey = 'JHELP_EXTENSIONS_config_MANAGER_EDIT';
	...
	/**
	 * @var     array  An array of cached config items.
	 * @since   1.6
	 */
	protected $_cache;
	...
	*/
	...
	/**
	 * Custom clean cache method, configs are cached in 2 places for different clients
	 *
	 * @since   1.6
	 */
	protected function cleanCache($group = null, $client_id = 0)
	{
		parent::cleanCache('com_config');
	}
}
