...
class productsModelMetadata extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_supperadmin.metadata', 'metadata', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_products.edit.metadata.data', array());
		...
		$this->preprocessData('com_supperadmin.metadata', $data);
