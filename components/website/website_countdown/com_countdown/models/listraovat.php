 ...
 * @since       1.6
 */
class cpanelModellistraovat extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_cpanel');
	...
	protected function translate(&$items)
	{
		...
		{
			$source = JPATH_cpanel . '/' . $item->folder . '/' . $item->element;
	...
	protected function getListQuery()
	{
		...
		$query->select(
			...
			->from($db->quoteName('#__cpanel_raovat') . ' AS a');
