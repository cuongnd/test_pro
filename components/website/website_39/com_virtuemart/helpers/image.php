...
if (!class_exists('VmMediaHandler')) require(JPATH_VM_SITE.DS.'helpers'.DS.'mediahandler.php');
...
//		$height = min($height, 2000);
		...
		if (file_exists($fullSizeFilenamePath)) {
			if (!class_exists('Img2Thumb')) require(JPATH_VM_SITE.DS.'helpers'.DS.'img2thumb.php');
