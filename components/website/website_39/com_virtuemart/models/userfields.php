...
// Load the helpers
if(!class_exists('ParamHelper')) require(JPATH_VM_SITE.DS.'helpers'.DS.'paramhelper.php');
...
class VirtueMartModelUserfields extends VmModel {
	...
	public function prepareFieldDataSave($field, &$data) {
		...
		switch(strtolower($fieldType)) {
			...
			default:
				...
				// require(JPATH_VM_SITE.DS.'library'.DS.'htmlpurifier'.DS.'HTMLPurifier.auto.php');
	...
	*/
	 ...
	 *                   [...]
	 *                )
	 *    'functions' => array() // Optional javascript functions without <script type="text/javascript"> tags.
