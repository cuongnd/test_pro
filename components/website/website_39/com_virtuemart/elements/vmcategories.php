 ...
 * @version $Id: $
 */
$com_vituemart=JPath::get_component_path('com_virtuemart');
if (!class_exists('VmConfig'))
    require($com_vituemart . DS . 'helpers' . DS . 'config.php');

if (!class_exists('ShopFunctions'))
    require($com_vituemart . DS . 'helpers' . DS . 'shopfunctions.php');
if (!class_exists('TableCategories'))
    require($com_vituemart . DS . 'tables' . DS . 'categories.php');

if (!class_exists('VmElements'))
    require($com_vituemart . DS . 'elements' . DS . 'vmelements.php');
/*
