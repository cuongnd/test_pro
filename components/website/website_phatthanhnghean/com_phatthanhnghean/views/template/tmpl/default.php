...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_phatthanhnghean&task=ddomains.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-domains-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&view=domains'); ?>" method="post"
                            ...
                            <td>
                                ...
                                <?php if ($canEdit) : ?>
                                    <a class="quick-edit-title"
                                       href="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&task=component.edit&id=' . (int)$item->id); ?>">
