...
$doc->addScript(JUri::root().'/components/website/website_template5532788/com_phatthanhnghean/assets/js/view_general_default.js');
...
<div class="view-general-default">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&view=general&layout=edit&id=' . (int) $this->item->id); ?>" method="post"  name="adminForm" id="adminForm" class="form-validate">
