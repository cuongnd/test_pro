...
$doc->addScript(JUri::root().'components/website/website_template5532788/com_phatthanhnghean/assets/js/view_product_edit.js');
...
<div class="view-product-edit">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&view=product&layout=edit&id=' . (int) $this->item->id); ?>" method="post"  name="adminForm" id="adminForm" class="form-validate">
        <?php if($debug){ ?>
