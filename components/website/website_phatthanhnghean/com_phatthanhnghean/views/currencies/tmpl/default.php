...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_phatthanhnghean&task=productcategories.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-productcategories-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&view=productcategories'); ?>" method="post"
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped" id="itemList">
                                    ...
                                    <tr>
                                        ...
                                        <th class="title">
                                            <?php echo JHtml::_('grid.sort', 'Currency name', 'a.currency_name', $listDirn, $listOrder); ?>
                                        </th>
                                        <th class="title">
                                            <?php echo JHtml::_('grid.sort', 'Currency code', 'a.currency_code', $listDirn, $listOrder); ?>
                                        </th>
                                        <th class="title">
                                            <?php echo JHtml::_('grid.sort', 'Currency symbol', 'a.currency_symbol', $listDirn, $listOrder); ?>
                                        </th>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($canEdit) : ?>
                                                    <a class="quick-edit-title"
                                                       href="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&task=productcategory.edit&id=' . (int)$item->id); ?>">
                                                        <?php echo $item->currency_name; ?></a>
                                                <?php else : ?>
