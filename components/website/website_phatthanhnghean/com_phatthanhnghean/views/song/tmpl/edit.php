...
$scriptId = "script_view_song_default";
ob_start();
?>
...
<div class="view-song-default">
    <form action="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&view=song&id='.(int) $this->item->id); ?>" method="post"  name="adminForm" id="adminForm" class="form-validate">
