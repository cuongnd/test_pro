...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_phatthanhnghean&task=albums.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-albums-default">
        <?php echo $this->render_toolbar() ?>
        <form action="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&view=albums'); ?>" method="post"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped" id="itemList">
                                    ...
                                    <tr>
                                        ...
                                        <th class="title">
                                            <?php echo JHtml::_('grid.sort', 'album name', 'name', $listDirn, $listOrder); ?>
                                        </th>
                                        <th class="title">
							...
							<i class="icon-menu"></i>
                                            ...
                                            <td class="center">
                                                <?php echo JHtml::_('jgrid.published', $item->enabled, $i, 'albums.', $canChange); ?>
                                            </td>
                                            <td>
                                                ...
                                                <?php if ($canEdit) : ?>
                                                    <a class="quick-edit-title"
                                                       href="<?php echo JRoute::_('index.php?option=com_phatthanhnghean&task=album.edit&id=' . (int)$item->id); ?>">
                                                        <?php echo $item->album_name; ?></a>
                                                <?php else : ?>
                                            ...
                                            <td class="center">
                                                <?php echo JHtml::_('jgrid.is_system', $item->issystem, $i, 'albums.', $canChange); ?>
                                            </td>
