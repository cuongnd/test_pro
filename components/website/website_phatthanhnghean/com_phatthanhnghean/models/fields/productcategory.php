...
class JFormFieldproductcategory extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $query->clear()
            ->select('product_category.id,product_category.parent_id,product_category.product_category_name as text,product_category.website_id')
        ...
        $doc->addScript(JUri::root().'/components/website/website_template5532788/com_phatthanhnghean/models/fields/jquery.productcategory.js');
