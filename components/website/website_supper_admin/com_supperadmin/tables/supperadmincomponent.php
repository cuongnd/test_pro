...
class JTableSupperadmincomponent extends JTable
{
    /**
     * Constructor
     *
    ...
    public function check()
    {
        ...
        $this->_website_id=extensions_Supper_Admin_Helper::get_website_id_by_extension_id($this->extension_id);
        if(!$this->name)
        {
        ...
        $query->select('component.id')
            ...
            ->where('extension.website_id='.(int)$this->_website_id)
        ;
