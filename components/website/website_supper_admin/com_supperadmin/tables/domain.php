...
require_once JPATH_ROOT.'/libraries/legacy/table/datasourcenested.php';
/**
 * product table
 *
 * @package     Joomla.Legacy
 ...
 */
class JTableDataSource extends JTableDataSourceNested
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__datasource', 'id', $db);
    ...
    public function store($updateNulls = false)
    {
        ...
        if($rootId==false)
        {
            $this->setError('cannot create root');
            return false;
        }
        if(!$this->parent_id)
        {
        ...
        {
            $this->setError('cannot store record');
            return false;
        }
