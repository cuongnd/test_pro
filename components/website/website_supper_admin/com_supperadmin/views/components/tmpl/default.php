...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_supperadmin&task=components.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-components-default">
        <?php echo $this->render_toolbar() ?>
        <form action="<?php echo JRoute::_('index.php?option=com_supperadmin&view=components'); ?>" method="post"
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped" id="itemList">
                                    ...
                                    <tr>
                                        ...
                                        <th class="title">
                                            <?php echo JHtml::_('grid.sort', 'component title', 'name', $listDirn, $listOrder); ?>
                                        </th>
                                        <th class="title">
                                            <?php echo JHtml::_('grid.sort', 'component name', 'name', $listDirn, $listOrder); ?>
                                        </th>
                                        <th class="title">
