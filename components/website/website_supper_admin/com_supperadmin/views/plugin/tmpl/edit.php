...
$scriptId = "script_view_plugin_default";
ob_start();
?>
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        $('.view-plugin-default').view_plugin_default({
...
$doc->addScript(JUri::root().'/components/website/website_supper_admin/com_supperadmin/assets/js/view_plugin_default.js');


?>
<div class="view-plugin-default">
