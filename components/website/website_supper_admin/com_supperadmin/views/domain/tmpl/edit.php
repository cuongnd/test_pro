...
<div class="view-extension-default">
    <form action="<?php echo JRoute::_('index.php?option=com_supperadmin&view=domain&id='.(int) $this->item->id); ?>" method="post"  name="adminForm" id="adminForm" class="form-validate">
