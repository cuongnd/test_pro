...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_supperadmin&task=usergroups.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-usergroups-default">
        <?php echo $this->render_toolbar() ?>
        <form action="<?php echo JRoute::_('index.php?option=com_supperadmin&view=usergroups'); ?>" method="post"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
							...
							<i class="icon-menu"></i>
                                            ...
                                            <td class="center">
                                                <?php echo JHtml::_('jgrid.published', $item->enabled, $i, 'usergroups.', $canChange); ?>
                                            </td>
                                            <td>
                                            ...
                                            <td class="center">
                                                <?php echo JHtml::_('jgrid.is_system', $item->issystem, $i, 'usergroups.', $canChange); ?>
                                            </td>
