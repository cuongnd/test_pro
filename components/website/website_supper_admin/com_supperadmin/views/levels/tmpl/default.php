...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_supperadmin&task=levels.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-levels-default">
        <?php echo $this->render_toolbar() ?>
        <form action="<?php echo JRoute::_('index.php?option=com_supperadmin&view=levels'); ?>" method="post"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
							...
							<i class="icon-menu"></i>
                                            ...
                                            <td class="center">
                                                <?php echo JHtml::_('jgrid.published', $item->enabled, $i, 'levels.', $canChange); ?>
                                            </td>
                                            <td>
                                                ...
                                                <?php if ($canEdit) : ?>
                                                    <a class="quick-edit-title"
                                                       href="<?php echo JRoute::_('index.php?option=com_supperadmin&task=level.edit&id=' . (int)$item->id); ?>">
                                            ...
                                            <td class="center">
                                                <?php echo JHtml::_('jgrid.is_system', $item->issystem, $i, 'levels.', $canChange); ?>
                                            </td>
