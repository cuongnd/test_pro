 ...
 * @since       1.5
 */
class supperadminViewlevels extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        $this->listWebsite=websiteHelperFrontEnd::getOptionListWebsite('levels.quick_assign_website');
		$this->addToolbar();
    ...
    function addCommand()
    {
        ...
        $this->controller_task='levels.ajaxSaveForm';
    }
	/**
	...
	{
		require_once JPATH_ROOT.'/components/website/website_supper_admin/com_supperadmin/helpers/levels.php';
        ...
        if ($canDo->get('core.create'))
        {
            JToolbarHelper::custom('levels.add', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
        }
		JToolbarHelper::duplicate('levels.duplicate');
		if ($canDo->get('core.edit.state'))
		{
			JToolbarHelper::publish('levels.publish', 'JTOOLBAR_ENABLE', true);
			JToolbarHelper::unpublish('levels.unpublish', 'JTOOLBAR_DISABLE', true);
        ...
        JToolbarHelper::publish('levels.issystem','Is system');
        JToolbarHelper::unpublish('levels.isnotsystem','Is system');
