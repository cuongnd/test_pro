 ...
 * @since       1.6
 */
class supperadminControllerusergroups extends JControllerAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'usergroup', $prefix = 'supperadminModel', $config = array('ignore_request' => true))
	{
    ...
    public function rebuild()
    {
        ...
        {
            // Rebuild succeeded.
            $this->setMessage(JText::_('COM_USERS_REBUILD_SUCCESS'));
        ...
        {
            // Rebuild failed.
            $this->setMessage(JText::_('COM_USERS_REBUILD_FAILURE'));
