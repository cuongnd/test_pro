...
class JFormFieldplugin extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $doc->addScript(JUri::root().'components/website/website_supper_admin/com_supperadmin/models/fields/jquery.plugin.js');
        $scriptId = "script_field_plugin_" . $this->id;
        $element_id='field_plugin_'.$this->id;
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                $('#<?php echo $element_id ?>').field_plugin({
                    field:{
