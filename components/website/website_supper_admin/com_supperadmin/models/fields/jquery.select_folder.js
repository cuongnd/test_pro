//huong dan su dung
/*
 $('.field_select_folder').field_select_folder();

 field_select_folder=$('.field_select_folder').data('field_select_folder');
 console.log(field_select_folder);
 */

// jQuery Plugin for SprFlat admin field_select_folder
// Control options and basic function of field_select_folder
...
(function($) {
    ...
    // here we go!
    $.field_select_folder = function(element, options) {
        ...
        var defaults = {
            ...
            element_id:'',
            list_extension:[]
            //main color scheme for field_select_folder
    ...
    $.fn.field_select_folder = function(options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function() {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('field_select_folder')) {
                var plugin = new $.field_select_folder(this, options);

                 $(this).data('field_select_folder', plugin);
