...
class JFormFieldModule extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $doc->addScript(JUri::root().'components/website/website_supper_admin/com_supperadmin/models/fields/jquery.module.js');
        $scriptId = "script_field_module_" . $this->id;
        $element_id='field_module_'.$this->id;
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                $('#<?php echo $element_id ?>').field_module({
                    field:{
