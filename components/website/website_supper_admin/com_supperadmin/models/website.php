...
class supperadminModelWebsite extends JModelAdmin
{
    ...
    {
        $data['default_template']=implode(',',$data['default_template']);
        $id= parent::save($data); // TODO: Change the autogenerated stub
        if($id)
        {
            ...
            foreach($list_domain as $domain){
                ...
                $content="$id:$name";
                $write_ok=JFile::write(JPATH_ROOT.DS.$domain_path,$content);
                if(!$write_ok)
                {
    ...
    public function set_state_supper_admin_request_update(&$pk, $value = 1)
    {
        ...
        $table->supper_admin_request_update=$value;
