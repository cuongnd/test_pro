 ...
 * @since       1.6
 */
class supperadminModelSupperadminconfig extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_supperadmin.domain', 'domain', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_supperadmin.edit.domain.data', array());
		...
		$this->preprocessData('com_supperadmin.domain', $data);
