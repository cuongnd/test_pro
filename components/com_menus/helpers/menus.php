...
class MenusHelperFrontEnd
{
    ...
    public static function remove_all_menu_type_not_exists_menu_item(){
        $db=JFactory::getDbo();
        $query=$db->getQuery(true);
        $query->delete_all('#__menu_types AS menu_types','menu_types.*')
            ->leftJoin('#__menu_type_id_menu_id AS menu_type_id_menu_id ON menu_type_id_menu_id.menu_type_id=menu_types.id')
    ...
    public static function remove_all_menu_not_exists_menu_type_by_website_id($website_id)
    {
        $db=JFactory::getDbo();
        $query=$db->getQuery(true);
        $query->select('menu_type_id_menu_id.menu_id, menu_type_id_menu_id.menu_type_id')
