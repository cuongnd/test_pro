...
class MenusModelMenus extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		{
			$query->where('a.client_id='.(int)$client_id);
		}
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$client_id = $this->getUserStateFromRequest($this->context . '.filter.client_id', 'client_id', 0, 'int');
		$this->setState('filter.client_id', $client_id);
