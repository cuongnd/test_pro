		...
		<table class="table table-striped">
			...
			?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td>
						<a href="<?php echo JRoute::_('index.php?option=com_menus&view=items&menu_type_id='.$item->id) ?> ">
                    ...
                    <?php if($supperAdmin){ ?>
                        <td class="center">
                            <?php echo JHtml::_('jgrid.is_system', $item->issystem, $i, 'menus.', $canChange); ?>
                        </td>
                    <?php } ?>
					<td class="center btns">
					...
					<td class="left">
						<?php if (isset($this->modules[$item->menutype])) : ?>
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<?php foreach ($this->modules[$item->menu_type_id] as &$module) : ?>
										<li>
											<?php if ($canEdit) : ?>
						...
						<a href="<?php echo JRoute::_('index.php?option=com_modules&task=module.add&eid=' . $modMenuId . '&params[menu_type_id]='.$item->id); ?>">
