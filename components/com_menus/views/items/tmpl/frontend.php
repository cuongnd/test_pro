...
echo "<pre>";
print_r($active_menu_item);
echo "</pre>";
die;
defined('_JEXEC') or die;
$configviewlayout=$this->item->configviewlayout;
echo "<pre>";
print_r($configviewlayout);
echo "</pre>";
die;
//menu_type_id
				...
				foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent_id;?>" item-id="<?php echo $item->id?>" parents="<?php echo $parentsStr?>" level="<?php echo $item->level?>">
						...
						<td>
							...
							<?php endif; ?>
							<?php if ($canEdit) : ?>
								<a class="quick-edit-title" href="<?php echo JRoute::_('index.php?option=com_menus&task=item.edit&id='.(int) $item->id);?>">
					...
					<td class="small hidden-phone">
						...
						<td class="center hidden-phone">
							<span title="<?php echo sprintf('%d-%d', $item->lft, $item->rgt);?>">
								<?php echo (int) $item->id; ?>(<?php echo sprintf('%d-%d', $item->lft, $item->rgt);?>)</span>
						</td>
					</tr>
					<?php endforeach; ?>
				</tbody>
