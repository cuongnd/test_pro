    ...
    view_config_menu_item={
        ...
        option_droppable:{
            ...
            drop: function(ev,ui){
                ...
                {
                    view_config_menu_item.render_table_fields(uiDraggable,droppable);
                }else if(uiDraggable.hasClass('configupdate-item-field')){
                    view_config_menu_item.render_table_field(uiDraggable,droppable);
                }
            }
        },
        option_nestable:{
            ...
            dragStop:function(e,el,dragEl){
                view_config_menu_item.move_element(e,el,dragEl);
            }
        },
        ...
        init_config_nestable:function(){
            $('#field_block').nestable(view_config_menu_item.option_nestable)
                .on('change', view_config_menu_item.updateOutput);
        ...
        init_view_config_menu_item:function(){
            $('.add_node').click(function add_node_click(){
                view_config_menu_item.add_node($(this));
            });
            $('.add_sub_node').click(function add_sub_node_click(){
                view_config_menu_item.add_sub_node($(this));
            });
            ...
            $(document).on('change','.menu_access_level',function(){
                ...
                view_config_menu_item.update_menu_item(id,list_keys_values);

            });

            view_config_menu_item.set_auto_complete();
            // activate Nestable for list 1
            view_config_menu_item.init_config_nestable();
            view_config_menu_item.init_append_grid();
            view_config_menu_item.update_nestable();
        ...
        init_append_grid:function(){
            $('.tbl_append_grid').each(function(){
                ...
                view_config_menu_item.append_grid_option.initData=config_params;
                $('#'+id).appendGrid( view_config_menu_item.append_grid_option);
            ...
            $('.tbl_append_grid_config_property').each(function(){
                ...
                view_config_menu_item.append_grid_option_config_property.initData=config_property;
                $('#'+id).appendGrid( view_config_menu_item.append_grid_option_config_property);
        ...
        save_fields:function(close){
            ...
            view_config_menu_item.update_data_grid();
            ...
            ajax_web_design=$.ajax({
                ...
                data: (function () {
                    ...
                    dataPost = {
                        option: 'com_menus',
                        task: 'item.ajax_save_field_params',
                        fields: fields
        ...
        {
            view_config_menu_item.save_fields(1);

        },
        save:function()
        {
            view_config_menu_item.save_fields(0);
        },
        cancel:function()
        {
            $('.panel.menu-item-config').remove();
        ...
        add_node:function(self){
            ...
            li_clone.find(".icon").select2(view_config_menu_item.icon_option);
            ...
            li_clone.find(".select_field_name").select2(view_config_menu_item.field_name_option);
            ...
            view_config_menu_item.reset_append_grid_option(li_clone);
            view_config_menu_item.reset_append_grid_config_property(li_clone);
        ...
        reset_append_grid_option:function(element){
            ...
            var id=  view_config_menu_item.makeid();
            ...
            view_config_menu_item.append_grid_option.initData=[];
            element.find('.tbl_append_grid').appendGrid(view_config_menu_item.append_grid_option);
        ...
        reset_append_grid_config_property:function(element){
            ...
            view_config_menu_item.append_grid_option_config_property.initData=[];
            element.find('.tbl_append_grid_config_property').appendGrid(view_config_menu_item.append_grid_option_config_property);
        ...
        add_sub_node:function(self){
            ...
            li_clone.find('.select2-container.icon').remove();
            li_clone.find('input.icon').removeClass('select2-offscreen').removeData();
            li_clone.find("input.icon").select2(view_config_menu_item.icon_option);

            li_clone.find('.select2-container.select_field_name').remove();
            li_clone.find('input.select_field_name').removeClass('select2-offscreen').removeData();
            li_clone.find("input.select_field_name").select2(view_config_menu_item.field_name_option);
        ...
        call_on_change:function(self){
            ...
            $('input[type="radio"][name="'+name+'"]').each(function(){
                view_config_menu_item.update_data_column(this,'home','radio');
            });
        },
        set_auto_complete:function(){
            $(".select_field_name").select2(view_config_menu_item.field_name_option);
            $(".icon_menu_item").select2(view_config_menu_item.icon_option);
            $(".column_access").select2(view_config_menu_item.access_option);
            $(".field_type").select2();
        },
        update_nestable:function(){
            view_config_menu_item.updateOutput($('#field_block').data('output', $('#field_block-output')));
