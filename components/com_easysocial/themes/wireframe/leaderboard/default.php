...
<div class="es-leaderboard">
	...
	<ul class="unstyled es-item-list mt-20">
		<?php $i = 1; ?>
		...
		<li>
			<div class="es-item">
				...
				<div class="es-avatar-wrap">
					<a href="<?php echo $user->getPermalink();?>" class="es-avatar es-avatar-medium pull-left mr-10">
				...
				<div class="es-item-body">
					<div class="es-item-detail pull-left">
						<ul class="unstyled">
							...
							<?php } ?>
							<li class="mt-10">
								<a href="<?php echo FRoute::friends( array( 'userid' => $user->getAlias() ) );?>" class="small muted mr-10">
									<i class="ies-users-2 ies-small"></i>  <?php echo $user->getTotalFriends();?> <?php echo JText::_( 'COM_EASYSOCIAL_FRIENDS' ); ?>
								</a>

								<a href="<?php echo FRoute::followers( array( 'userid' => $user->getAlias() ) );?>" class="small muted mr-10">
