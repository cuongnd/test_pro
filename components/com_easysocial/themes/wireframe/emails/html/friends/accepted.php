	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			<div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_FRIENDS_REQUEST_APPROVED' ); ?>
			</div>
			<div style="font-size:12px; color: #798796;font-weight:normal">
				<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_FRIENDS_REQUEST_APPROVED_SUBHEADING' , $friendName ); ?>
			</div>
		</div>
	</td>
</tr>
			...
			<tr>
				<td>
					<span style="display:block;margin: 0px auto 20px;border:1px solid #f5f5f5;width:64px;padding:3px;border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff">
						<a href="<?php echo $friendLink;?>"><img src="<?php echo $friendAvatar;?>" alt="<?php echo $this->html( 'string.escape' , $friendName );?>" style="border-radius:50%; -moz-border-radius:50%; -webkit-border-radius:50%;background:#fff" width="64" height="64"/></a>
					</span>
				</td>
				<td>
					<table style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
						<tr>
							<td>
								<a href="<?php echo $friendLink;?>" style="color: #798796;text-decoration:none;"><strong><?php echo $friendName;?></strong></a>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<a href="<?php echo $friendLink;?>" style="
