	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			...
			<div style="font-size:12px; color: #798796;font-weight:normal">
				<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_NEW_LIKES_ON_YOUR_STATUS' , $posterName ); ?>
			</div>
		</div>
	</td>
</tr>
		...
		<table width="540" cellspacing="0" cellpadding="0" border="0" align="center">
			<tr>
				<td>
					...
					<p style="text-align:left;">
						<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_NEW_LIKES_ON_YOUR_STATUS_DESC' , $posterName );?>
					</p>
				</td>
			</tr>	
		</table>
