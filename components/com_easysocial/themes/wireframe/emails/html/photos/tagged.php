	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			<div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_TAGGED_IN_PHOTO' ); ?>
			</div>
			<div style="font-size:12px; color: #798796;font-weight:normal">
				<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_TAGGED_IN_PHOTO_BY' , $actorName ); ?>
			</div>
		</div>
	</td>
</tr>
...
<tr>
	<td style="text-align: center;font-size:12px;color:#888">
		...
		<table width="540" cellspacing="0" cellpadding="0" border="0" align="center">
			<tr>
				<td>
					...
					<p style="text-align:left;">
						<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_TAGGED_IN_PHOTO_INFO' , $actorPermalink , $actorName );?>:
					</p>
				</td>
			</tr>	
		</table>
		...
		<a style="
				...
				" href="<?php echo $photoPermalink;?>"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_VIEW_PHOTO' );?></a>
