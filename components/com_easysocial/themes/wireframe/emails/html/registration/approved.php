	...
	<td style="text-align: center;padding: 40px 10px 0;">
		<div style="margin-bottom:15px;">
			<div style="font-family:Arial;font-size:32px;font-weight:normal;color:#333;display:block; margin: 4px 0">
				<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_REGISTRATION_APPLICATION_APPROVED_HEADING' ); ?>
			</div>
			<div style="font-size:12px; color: #798796;font-weight:normal">
				<?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_REGISTRATION_APPLICATION_APPROVED_SUBHEADING' ); ?>
			</div>
		</div>
	</td>
</tr>
...
<tr>
	<td style="text-align: center;">
		...
		<p style="margin-bottom: 50px;">
			<?php echo JText::sprintf( 'COM_EASYSOCIAL_EMAILS_REGISTRATION_APPROVED' , $site ); ?>
		</p>
		...
		<a href="<?php echo FRoute::login( array( 'external' => true ) );?>" style="
		...
		"><?php echo JText::_( 'COM_EASYSOCIAL_EMAILS_LOGIN_NOW' ); ?></a>
