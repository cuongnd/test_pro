...
<div class="es-container">
	<div class="controls-group-wrap">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="input-full" name="title" value="<?php echo $this->html( 'string.escape' , $list->title );?>"
		...
		<div class="controls">
			<label for="defaultList">
				...
				<span class="small"><?php echo JText::_( 'COM_EASYSOCIAL_FRIENDS_LIST_FORM_SET_AS_DEFAULT_LIST' ); ?></span>
			</label>
		</div>
