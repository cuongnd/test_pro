...
<div class="friends-list es-widget">
	<div class="es-widget-head">
		<div class="pull-left widget-title"><i class="icon-es-clipboard"></i> <?php echo JText::_( 'COM_EASYSOCIAL_FRIENDS_YOUR_LIST' );?></div>
	...
	<div class="es-widget-body" data-friends-list>
		<?php if( $lists ){ ?>
		<ul class="widget-list es-nav es-nav-stacked" data-friends-listItems>
