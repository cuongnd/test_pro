...
<div data-friends-content>
	...
	<div class="es-filterbar">
		...
		>
			<a href="javascript:void(0);" class="btn btn-es" data-foundry-toggle="dropdown"><?php echo JText::_( 'COM_EASYSOCIAL_MANAGE_LIST_BUTTON' );?> <b class="caret"></b></a>
	...
	<ul class="es-item-grid friend-items es-item-grid_2col<?php echo !$friends ? ' is-empty' : '';?>" data-friends-items>
	<?php if( $friends ){ ?>
