...
<?php if( $items ){ ?>
	...
	<div class="es-notifications">
		...
		<ul class="unstyled es-item-list">
			...
			>
				<div class="es-notification">
					...
					<i class="icon-es-app mr-5"></i> <a href="<?php echo FRoute::notifications( array( 'id' => $item->id , 'layout' => 'route' ) );?>" class="es-time"><?php echo $item->title;?></a>
					...
					<div class="pull-right es-notice-action">
						<a href="javascript:void(0);" class="btn btn-mini btn-es" data-foundry-toggle="dropdown">
