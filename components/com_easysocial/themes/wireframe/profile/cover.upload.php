...
<dialog>
	...
	<bindings type="javascript">
	{
		"{uploadButton} click": function(button) {
			...
			var task = 
				EasySocial.ajax(
					"site/controllers/photos/uploadCover",
					{
						files: file
					},
					{
	...
	<content>
		<div class="es-cover-form" data-cover-form>
			...
			<span class="es-cover-filename es-loading" data-cover-filename></span>
		</div>
	</content>
	...
	<buttons>
		...
		<button data-upload-button type="button" class="btn btn-es-primary"><?php echo JText::_('COM_EASYSOCIAL_UPLOAD_BUTTON'); ?></button>
	</buttons>
</dialog>