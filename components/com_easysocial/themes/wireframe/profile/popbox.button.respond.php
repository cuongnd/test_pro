...
?>
<a class="btn-es btn-friends" href="javascript:void(0);" data-popbox-friends-respond data-foundry-toggle="dropdown">
	<i class="ies-loop ies-small mr-5"></i> <?php echo JText::_( 'COM_EASYSOCIAL_PROFILE_POPOVER_RESPOND' );?>
</a>
