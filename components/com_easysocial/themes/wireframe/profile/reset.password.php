	...
	<div class="es-remind-form-wrap">
		<form name="remindUsername" method="post" action="<?php echo JRoute::_( 'index.php' );?>">
			<div class="input-prepend">
				<span class="add-on"><?php echo JText::_( 'COM_EASYSOCIAL_PROFILE_REMIND_PASSWORD_USERNAME' );?></span>
				<input type="text" name="es-username" value="" placeholder="<?php echo JText::_( 'COM_EASYSOCIAL_PROFILE_REMIND_PASSWORD_USERNAME_PLACEHOLDER' , true );?>" />
			</div>
			<div class="input-prepend">
				<span class="add-on"><?php echo JText::_( 'COM_EASYSOCIAL_PROFILE_REMIND_PASSWORD_VERIFICATION' );?></span>
				<input type="text" name="es-code" value="" placeholder="<?php echo JText::_( 'COM_EASYSOCIAL_PROFILE_REMIND_PASSWORD_VERIFICATION_PLACEHOLDER' , true );?>" />
			</div>
			<hr />
