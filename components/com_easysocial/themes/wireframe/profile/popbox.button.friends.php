...
?>
<a class="btn-es btn-friends" href="javascript:void(0);" data-id="<?php echo $user->id;?>" data-popbox-friends-friends data-foundry-toggle="dropdown">
	<i class="ies-checkmark ies-small mr-5"></i> <?php echo JText::_( 'COM_EASYSOCIAL_PROFILE_POPOVER_FRIENDS' );?>
</a>
