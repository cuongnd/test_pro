...
<dialog>
	...
	<title><?php echo JText::_( 'COM_EASYSOCIAL_ACTIVITIES_DELETE_ACTIVITY_DIALOG_TITLE' ); ?></title>
	<content>
		<p><?php echo JText::_( 'COM_EASYSOCIAL_ACTIVITIES_DELETE_ACTIVITY_CONFIRMATION' ); ?></p>
	</content>
	<buttons>
