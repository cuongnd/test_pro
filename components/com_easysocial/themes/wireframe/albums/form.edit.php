	...
	<div class="sentence">
		...
		<div data-album-date class="es-album-date words has-data">
			...
			<span data-album-date-caption
			      data-foundry-toggle="dropdown"
			      class="with-data">
				<?php echo $this->html( 'string.date', $album->getCreationDate() , "COM_EASYSOCIAL_ALBUMS_DATE_FORMAT" ); ?>
			</span>
			...
			<div class="es-album-date-form dropdown-menu dropdown-static dropdown-arrow-topleft">
				<?php echo $this->html( 'grid.dateform' , 'date-form', $album->getCreationDate() ); ?>
			</div>
		</div>
		<?php } ?>
