	...
	<div class="es-album-header">
		<div data-album-title class="es-album-title">
			<a data-album-link href="<?php echo FRoute::albums( array( 'id' => $album->getAlias() ) );?>">
				...
				<?php } else { ?>
					<?php echo JText::_( 'Untitled Album' ); ?>
				<?php } ?>
			</a>
		</div>
		...
		<div data-album-privacy><?php echo Foundry::privacy()->form( $album->id , SOCIAL_TYPE_ALBUM , $album->uid, 'albums.view' );?></div>
	</div>
	...
	<div class="es-album-content">
		...
		<div data-album-cover class="es-album-cover <?php echo ($album->hasCover()) ? '' : 'no-cover'; ?>">
				<i data-album-cover-image class="es-album-image"
				     ...
				     style="background-image: url('<?php echo $album->getCover()->getSource( 'thumbnail' ); ?>');"
				     <?php } ?>
				>
				</i>
		</div>
		...
		<div data-album-menu class="es-media-item-menu btn-group show-on-hover">
			<div class="es-media-item-menu-item btn btn-media dropdown_" data-item-actions-menu>
				...
				<ul class="dropdown-menu">
					<li>
						<?php echo Foundry::get( 'Sharing' , array( 'url' => FRoute::albums( array( 'id' => $album->getAlias() , 'layout' => 'item' ) ) , 'text' => JText::_( 'COM_EASYSOCIAL_SHARE_ALBUM' ) ) )->getHTML(); ?>
					</li>
					...
					<li data-album-report-button>
						<?php echo Foundry::reports()->getForm( 'com_easysocial' , SOCIAL_TYPE_ALBUM , $album->id , $album->get( 'title' ) , JText::_( 'COM_EASYSOCIAL_REPORT_ALBUM' ) , $album->getPermalink( true , true ) , JText::_( 'COM_EASYSOCIAL_REPORT_ALBUM_DESC' ) ); ?>
					</li>
		...
		<div data-item-actions class="es-item-actions">
			<span data-album-like-button class="btn-like<?php echo Foundry::likes()->hasLiked( $album->id , SOCIAL_TYPE_ALBUM ) ? ' liked' : '';?>">
			...
			<b>&bull;</b>
			<span data-album-comment-button class="btn-comment" data-foundry-toggle="dropdown"><?php echo JText::_("COM_EASYSOCIAL_COMMENT"); ?></span>
			<span data-album-counts-button class="btn-counts" data-foundry-toggle="dropdown">
				<span>
					<i class="ies-heart"></i>
