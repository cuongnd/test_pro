...
<div class="es-container">
	...
	<div class="controls-group-wrap mt-20">
		...
		<div class="control-group" data-composer-message>
			...
			<div class="controls">
				<div class="composer-textarea input-wrap">
					<textarea class="input-shape" name="message" data-composer-editor placeholder="<?php echo JText::_( 'COM_EASYSOCIAL_CONVERSATIONS_MESSAGE_PLACEHOLDER' );?>"><?php echo $message;?></textarea>
				</div>
			</div>
		</div>
		...
		<div class="form-actions">
			<div class="row-fluid">
				<div class="pull-right">
					<a href="<?php echo FRoute::conversations();?>" class="btn btn-es btn-medium"><?php echo JText::_( 'COM_EASYSOCIAL_CANCEL_BUTTON' ); ?></a>
					<button class="btn btn-es-primary btn-medium" data-composer-submit><?php echo JText::_( 'COM_EASYSOCIAL_SUBMIT_BUTTON' );?></button>
				</div>
			</div>
		</div>
