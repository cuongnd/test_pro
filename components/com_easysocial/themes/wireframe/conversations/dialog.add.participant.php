...
<dialog>
		...
		init: function() {
			...
			this.suggest()
				.addController(
					...
					{
						exclusion: <?php echo Foundry::json()->encode( $ids ); ?>
					}
				);
		},
	...
	<buttons>
		...
		<button data-add-button type="button" class="btn btn-es-primary"><?php echo JText::_('COM_EASYSOCIAL_INVITE_USERS_BUTTON'); ?></button>
	</buttons>
</dialog>
