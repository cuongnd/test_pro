...
<form name="createOauth" action="<?php echo JRoute::_( 'index.php' );?>" method="post" data-oauth-preferences>
	<div class="row-fluid vertical-line vertical-line-50 mt-20">
		<div class="span6">
			<div class="pr-15">
				<div class="form-horizontal">
					<div class="control-group">
						<label for="oauth-username"><?php echo JText::_( 'COM_EASYSOCIAL_OAUTH_REGISTRATION_USERNAME' );?>:</label>
						<input name="oauth-username" type="text" placeholder="<?php echo JText::_( 'COM_EASYSOCIAL_OAUTH_REGISTRATION_USERNAME_PLACEHOLDER' , true );?>" id="oauth-username" class="full-width" value="<?php echo $meta[ 'username' ];?>" />
					...
					<div class="control-group mt-20<?php echo $emailExists ? ' error' : '';?>">
						...
						<input name="oauth-email" type="text" placeholder="<?php echo JText::_( 'COM_EASYSOCIAL_OAUTH_REGISTRATION_EMAIL_PLACEHOLDER' , true );?>" id="oauth-email" class="full-width" value="<?php echo $meta[ 'email' ];?>" />
					...
					<div class="control-group mt-20>">
						...
						<input name="oauth-password" type="password" id="oauth-password" class="full-width" value="" />
		...
		<div class="span6">
			<div class="form-horizontal ml-10">
				<div class="control-group">
					<label class="small"><?php echo JText::_( 'COM_EASYSOCIAL_OAUTH_IMPORT_AVATAR_' . strtoupper( $clientType ) );?></label>
					<?php echo $this->html( 'grid.boolean' , 'import' , true ); ?>
				</div>
				<div class="control-group mt-20">
					<label class="small"><?php echo JText::_( 'COM_EASYSOCIAL_OAUTH_SYNC_' . strtoupper( $clientType ) );?></label>
	...
	<div class="form-actions">
		<button class="btn btn-es-primary btn-large pull-right"><?php echo JText::_( 'COM_EASYSOCIAL_COMPLETE_REGISTRATION_BUTTON' );?></button>
	</div>
