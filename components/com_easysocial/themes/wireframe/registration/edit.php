...
<div id="ezs-page" class="profile-edit mtl">
    ...
    <div id="ezs-main">
        ...
        <div class="ezs-panel">
		    <div class="panel-title"><?php echo JText::_( $group->title ); ?> <span class="small">- <?php echo $group->description;?></span></div>
            <?php if( $group->childs ) { ?>
    		        ...
    		        <tr>
    		            ...
    		            <td class="value">
                            <div class="hasTips">
                                ...
                                <?php echo Foundry::get( 'Tooltips' , $field->title , $field->description ); ?>
                            </div>
                        </td>
    		        </tr>
    		        <?php } ?>
