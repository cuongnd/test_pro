...
<li data-photo-report-button>
	<?php echo Foundry::reports()->getForm( 'com_easysocial' , SOCIAL_TYPE_PHOTO , $photo->id , $photo->get( 'title' ) , JText::_( 'COM_EASYSOCIAL_REPORT_PHOTO' ) , '' , JText::_( 'COM_EASYSOCIAL_REPORT_PHOTO_DESC' ) , $photo->getPermalink( true , true ) ); ?>
</li>
