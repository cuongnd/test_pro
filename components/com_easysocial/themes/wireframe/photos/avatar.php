...
<dialog>
	...
	<content>
		<div class="es-photos-avatar"
			...
			<div data-photo-image
			     ...
			     <div data-photo-avatar-viewport
			          class="es-photo-avatar-viewport"></div>
			</div>
			<input type="hidden" data-photo-id value="<?php echo $photo->id; ?>"></div>
			<input type="hidden" data-user-id  value="<?php echo $user->id; ?>"></div>
		</div>
	</content>
	...
	<buttons>
		...
		<button data-create-button type="button" class="btn btn-es-primary disabled" disabled><?php echo JText::_('COM_EASYSOCIAL_PHOTOS_CREATE_AVATAR'); ?></button>
	</buttons>
</dialog>
