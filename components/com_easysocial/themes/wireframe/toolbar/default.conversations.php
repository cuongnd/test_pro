...
?>
<li class="toolbarItem<?php echo $newConversations > 0 ? ' has-notice' : '';?>" data-popbox="module://easysocial/conversations/popbox" data-popbox-toggle="click">
	<a href="javascript:void(0);"
		data-original-title="<?php echo JText::_( 'COM_EASYSOCIAL_TOOLBAR_RECENT_CONVERSATIONS' , true );?>"
		data-placement="top"
		data-es-provide="tooltip"
	>
		<i class="icon-es-tb-msg"></i>
