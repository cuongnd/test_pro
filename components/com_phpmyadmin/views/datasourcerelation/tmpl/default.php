...
$doc->addStyleSheet(JUri::root() . '/components/com_phpmyadmin/views/datasourcerelation/tmpl/assets/less/view_datasourcerelation_default.less', 'text/css', '', array('rel' => 'stylesheet/less'));
...
$doc->addScript(JUri::root() . '/components/com_phpmyadmin/views/datasourcerelation/tmpl/assets/js/jquery.datasource_realtion_ship.js');
...
$datasource_id=$app->input->get('datasource_id');
$type = $website->website_id;
$table_datasource->load($datasource_id);
$xml_input = $table_datasource->diagram;
...
<script type="application/javascript">
    jQuery(document).ready(function ($) {
        ...
        $('#drag-drop-demo').datasource_realtion_ship({
            list_table:<?php echo json_encode($list_table) ?>,
            datasource_id:<?php echo $datasource_id ?>
        });
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 diagrams  demo drag-drop-demo">
            ...
            <div id="controls">
                <div id="bar">
                    ...
                    <hr/>
                    <button class="btn btn-danger save-datasource-ralationship  save-close-datasource-ralationship "  type="button"><i class="fa-save"></i>Save&amp;close</button>
                    <hr/>
                    <button class="btn save-datasource-ralationship btn-danger apply-datasource-ralationship "  type="button"><i class="fa-save"></i>Save</button>
                    <hr/>
                    <button class="btn btn-danger cancel-datasource-ralationship "  type="button"><i class="fa-save"></i>Cancel</button>
                    <hr/>
                    ...
                    <tr>
                        ...
                        <td style="width:40%">
                            <fieldset>
                                ...
                                <label for="backend" id="backendlabel"></label> <select disableChosen="true"
                                                                                        id="backend">
                                    <option></option>
                                </select>
                                <hr/>
