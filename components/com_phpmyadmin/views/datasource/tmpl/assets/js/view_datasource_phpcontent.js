jQuery(document).ready(function ($) {
    var editor;
    ajax_datasource_php_content_loader = {
        option_draggable: {
            appendTo: 'body',
            /*helper: function(){
        ...
        option_droppable: {
            ...
            drop: function (ev, ui) {
                ...
                if (uiDraggable.hasClass('configupdate-item-table')) {
                    ajax_datasource_php_content_loader.render_table_fields(uiDraggable, droppable);
                } else if (uiDraggable.hasClass('configupdate-item-field')) {
                    ajax_datasource_php_content_loader.render_table_field(uiDraggable, droppable);
                }
            }
        },
        option_nestable: {
            ...
            dragStop: function (e, el, dragEl) {
                ajax_datasource_php_content_loader.move_element(e, el, dragEl);
            }
        },
        ...
        format_code:function(self){
            ...
            var range = ajax_datasource_php_content_loader.getSelectedRange();
        ...
        init_config_nestable: function () {
            $('.a_menu_type').each(function () {
                ...
                $('#' + id_menu_type).nestable(ajax_datasource_php_content_loader.option_nestable)
                    .on('change', ajax_datasource_php_content_loader.updateOutput);
            });
...
*/
        ...
        add_node: function (self) {
            ...
            li_clone.removeData();
            li_clone.find(".icon").select2(ajax_datasource_php_content_loader.icon_option);
            ajax_datasource_php_content_loader.update_nestable();
        ...
        add_sub_node: function (self) {
            ...
            li_clone.find("input.icon").select2(ajax_datasource_php_content_loader.icon_option);
            ajax_datasource_php_content_loader.update_nestable();
            id = li.attr('data-id');
            ajax_web_design = $.ajax({
                type: "GET",
        ...
        update_data_column: function (self, key, type_input) {
            ...
            ajax_datasource_php_content_loader.update_menu_item(id, list_keys_values);
        ...
        call_on_change: function (self) {
            ...
            $('input[type="radio"][name="' + name + '"]').each(function () {
                ajax_datasource_php_content_loader.update_data_column(this, 'home', 'radio');
            });
        },
        set_auto_complete: function () {
            $(".icon_menu_item").select2(ajax_datasource_php_content_loader.icon_option);
        },
        update_nestable: function () {
            $('.a_menu_type').each(function render_nestable() {
                id_menu_type = $(this).attr('id');
                ajax_datasource_php_content_loader.updateOutput($('#' + id_menu_type).data('output', $('#' + id_menu_type + '_output')));
            });
