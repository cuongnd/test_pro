...
$doc->addStyleSheet(JUri::root() . '/components/com_phpmyadmin/views/projectrelation/tmpl/assets/less/view_projectrelation_default.less', 'text/css', '', array('rel' => 'stylesheet/less'));
...
$doc->addScript(JUri::root() . '/components/com_phpmyadmin/views/projectrelation/tmpl/assets/js/jquery.project_realtion_ship.js');
...
<script type="application/javascript">
    jQuery(document).ready(function ($) {
        ...
        $('#drag-drop-demo').project_realtion_ship({
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 diagrams  demo drag-drop-demo">
            ...
            <div id="controls">
                <div id="bar">
                    ...
                    <hr/>
                    <button class="btn save-project-ralationship btn-danger apply-project-ralationship "  type="button"><i class="fa-save"></i>Save</button>
                    <hr/>
                    <button class="btn btn-danger cancel-project-ralationship"  type="button"><i class="fa-save"></i>Cancel</button>
                    <hr/>
