...
?>
<?php echo websiteHelperFrontEnd::getGenericlistWebsite('website_id',' onchange="changeWebsite()" ',$this->item->website_id); ?>
...
<ul class="nav nav-list">
	...
	<?php foreach ($this->components as $component) : ?>
		<li>
			<a href="index.php?option=com_config&view=component&component=<?php echo $component->element; ?>"><?php echo JText::_($component->element); ?><br/>[<?php echo $component->website ?>]</a>
		</li>
	<?php endforeach; ?>
</ul>
