...
<div class="kmsgbody">
	<div class="kmsgtext">
        <?php $this->message->message=str_replace(array('<','>'),array('[',']'),$this->message->message); ?>
		<?php echo KunenaHtmlParser::parseBBCode (html_entity_decode($this->message->message), $this) ?>
	</div>
</div>
<div>
