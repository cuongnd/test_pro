...
$doc->addScript(JUri::root().'/media/system/js/jQuery-Inplace-WYSIWYG-Rich-Text-Editor-notebook/src/js/jquery.notebook.js');
$doc->addStyleSheet(JUri::root().'/media/system/js/jQuery-Inplace-WYSIWYG-Rich-Text-Editor-notebook/src/js/jquery.notebook.css');
$doc->addScript(JUri::root().'/components/com_content/assets/js/view-article-default.js');
$uri=JFactory::getURI();
                ...
                <?php if ($params->get('show_title')) : ?>
                    <?php if ($params->get('link_titles') && !empty($this->item->readmore_link)) : ?>
                        <a href="<?php echo $this->item->readmore_link; ?>"
                           itemprop="url"> <?php echo $this->escape($this->item->title); ?></a>
                    <?php else : ?>
