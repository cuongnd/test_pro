...
class paypal_class {
	...
	function paypalPayment(){
		...
		//$buy  	= $app->input->get('buy', '', 'string');	//either buy credit or plan
		...
		//$link_return = JRoute::_(JURI::base().'index.php?option=com_jblance&view=membership&layout=thankpayment&oid='.$orderid.'&buy='.$buy.'&Itemid='.$Itemid);
		//$link_status = JRoute::_(JURI::base().'index.php?option=com_jblance&task=membership.returnafterpayment&oid='.$orderid.'&buy='.$buy.'&gateway=paypal&Itemid='.$Itemid);
