...
<div align="center">
	...
	<div class="jbl_footer" id="showcredit" <?php echo $creditvisible; ?>><img src="administrator/components/com_jblance/images/joombri-logo-48.png" border="0" width="22" align="middle"/> Powered By JoomBri Freelance - <a href="http://www.joombri.in" target="_blank">Freelance Directory Component</a></div>	
	<?php 
