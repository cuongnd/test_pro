...
?>
	<input onclick="window.print()" type="button" value="<?php echo JText::_('COM_JBLANCE_PRINT'); ?>" class="button" />
	...
	<table width="100%" cellpadding="4" cellspacing="2">
		...
		<tr>
			...
			<td style="text-align:right;"><?php echo JblanceHelper::formatCurrency($this->row->amount, $currencysym); ?></td>
		</tr>
			<?php 
		...
		<tr>
			...
			<td><?php echo JblanceHelper::getPaymentStatus($this->row->approved); ?></td>
			<td style="text-align:right;"><?php echo JblanceHelper::formatCurrency($this->row->price, $currencysym); ?></td>
		</tr>
			<?php 
		...
		<tr>
			...
			<td colspan="1" align="right">
				<?php echo JblanceHelper::formatCurrency($subtotalAmt, $currencysym); ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="1" align="right">
				<?php echo '<b>'.JblanceHelper::formatCurrency($total, $currencysym, $currencycode).'</b>'; ?>
			</td>
		</tr>
		<tr>
