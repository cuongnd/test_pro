 ...
 */
 ...
 if(empty($accountInfo)){
 	...
 	$accountInfo['firstname'] = $user->name;
 }
	...
	<fieldset class="jblfieldset">
		...
		<table class="jbltable">
			...
			<tr>
				...
				<td>
					<?php echo $accountInfo['firstname']; ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input class="inputbox required" type="text" name="biz_name" id="biz_name" size="50" maxlength="100" value="" />
				</td>
			</tr>
			<?php endif; ?>
			...
			<tr>
				...
				<td>
					...
					<input class="inputbox required" type="text" name="rate" id="rate" size="6" maxlength="10" value="" />
					<?php echo $currencycod.' / '.JText::_('COM_JBLANCE_HOUR'); ?>
				</td>
			</tr>
			<tr>
			<td class="key"><label for="id_category"><?php echo JText::_('COM_JBLANCE_SKILLS'); ?><span class="redfont">*</span>:</label>
			</td>
			<td >						
				<?php 
