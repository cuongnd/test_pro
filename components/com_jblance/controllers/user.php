...
class JblanceControllerUser extends JControllerLegacy {
	...
	function saveProfile(){
		...
		$link = JRoute::_('index.php?option=com_jblance&view=user&layout=dashboard&Itemid='.$Itemid, false);
	...
	function savePortfolio(){
		...
		$return	= JRoute::_('index.php?option=com_jblance&view=user&layout=editportfolio&Itemid='.$Itemid, false);
