...
<form action="<?php echo acymailing_completeLink('archive&listid='.$this->list->listid); ?>" method="post" name="adminForm" id="adminForm" >
	...
	<?php } ?>
		<tr>
			...
			?>
				<p class="acynewbutton"><a class="btn" href="<?php echo acymailing_completeLink('newsletter&task=add&listid='.$this->list->listid); ?>" title="<?php echo JText::_('CREATE_NEWSLETTER',true); ?>" ><img class="icon16" src="<?php echo ACYMAILING_IMAGES; ?>icons/icon-16-add.png" alt="<?php echo JText::_('CREATE_NEWSLETTER',true); ?>" /> <?php echo JText::_('CREATE_NEWSLETTER'); ?></a></p>
			<?php } ?>
