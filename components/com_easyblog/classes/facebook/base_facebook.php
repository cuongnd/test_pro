 ...
 */
class EasyBlogFacebookApiException extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class EasyBlogBaseFacebook
{
  /**
   * Version.
   */
  ...
  protected function getUserFromAccessToken() {
    try {
      ...
      return $user_info['id'];
    } catch (EasyBlogFacebookApiException $e) {
      return 0;
    }
  }
   ...
   *
   * @return mixed The decoded response object
   * @throws EasyBlogFacebookApiException
   */
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new EasyBlogFacebookApiException(array(
