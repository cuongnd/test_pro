...
<div id="ezblog-body">
	...
	<div class="blog-head mtm">
		...
		<?php } ?>
		<h1 id="title_<?php echo $blog->id; ?>" class="blog-title<?php echo ($isFeatured) ? ' featured-item' : '';?> rip"><?php echo $blog->title; ?></h1>
	</div>
		...
		<div class="in">
			...
			<div class="blog-option">
				<ul class="reset-ul float-li small fsm">
					...
					<?php if( $system->config->get('main_comment') && $blog->totalComments !== false && $this->getParam( 'show_comments', true ) ){ ?>
					...
					<?php if( $system->config->get( 'main_reporting') && $system->my->id > 0 ){ ?>
	...
	<div class="blog-content">
		...
		<div class="blog-text clearfix prel mbm">
