...
<div id="ezblog-body">
	<!-- Entry wrapper -->
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read micro-quote clearfix">
		...
		<div class="blog-brief ptl pbl mbl clearfix">
			<div class="in">
				<!-- Post metadata -->
				<?php echo $this->fetch( 'blog.meta.php' , array( 'row' => $blog, 'postedText' => JText::_( 'COM_EASYBLOG_QUOTE_SHARED' ) ) ); ?>
		...
		<div class="blog-text clearfix prel mtm mbm">
			...
			<?php if( in_array( $system->config->get( 'main_socialbutton_position' ) , array( 'top' , 'left' , 'right' ) ) ){ ?>
				<?php echo EasyBlogHelper::showSocialButton( $blog , true ); ?>
			<?php } ?>
