...
<div id="ezblog-body">
	<!-- Entry wrapper -->
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read micro-twitter clearfix">
		...
		<div class="blog-head mtm">
			...
			<?php } ?>
			<h1 id="title-<?php echo $blog->id; ?>" class="blog-title<?php echo ($isFeatured) ? ' featured-item' : '';?> rip"><?php echo $blog->title; ?></h1>
		</div>

		<div class="blog-brief clearfix ptl pbl mbl clearfix">
			<div class="in">
				<!-- Post metadata -->
				<?php echo $this->fetch( 'blog.meta.php' , array( 'row' => $blog, 'postedText' => JText::_( 'COM_EASYBLOG_TWEETED' ) ) ); ?>
