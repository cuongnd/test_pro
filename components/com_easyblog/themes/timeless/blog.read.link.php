...
<div id="ezblog-body">
	<!-- Entry wrapper -->
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read micro-link clearfix">
		...
		<div class="blog-calendar float-l prel tac mtm mbl mrl">
			<div class="blog-calendar-day"><?php echo $this->formatDate( '%d' , $blog->created ); ?></div>
			<div class="blog-calendar-month"><?php echo $this->formatDate( '%b' , $blog->created ); ?></div>
		</div>
		...
		<div class="blog-brief ptl pbl mbl clearfix">
			<div class="in">
				<!-- Post metadata -->
				<?php echo $this->fetch( 'blog.meta.php' , array( 'row' => $blog, 'postedText' => JText::_( 'COM_EASYBLOG_LINK_SHARED' ) ) ); ?>
		...
		<div class="blog-text clearfix prel mtm mbm">
			...
			<div class="blog-link">
				<h1 id="title-<?php echo $blog->id; ?>" class="blog-title<?php echo ($isFeatured) ? ' featured-item' : '';?> rip">
					<?php echo EasyBlogHelper::getHelper('String')->htmlAnchorLink( $blog->title, $blog->title); ?>
				</h1>
				<p class="mtm"><?php echo $blog->content; ?></p>
			</div>
