...
<div id="entry-<?php echo $row->id; ?>" class="blog-post micro-quote clearfix prel<?php echo (!empty($row->team)) ? ' teamblog-post' : '' ;?>" itemscope itemtype="http://schema.org/Blog">
	<div class="blog-post-in">
		...
		<div class="blog-header clearfix">
			...
			<div class="blog-cap">
				...
				<div class="blog-quote">
					<!-- Post title -->
					<h2 id="title-<?php echo $row->id; ?>" class="blog-title<?php echo ($row->isFeatured) ? ' featured' : '';?> rip">
		...
		<div class="blog-content clearfix">
			...
			<!-- Bottom metadata -->
			<?php echo $this->fetch( 'blog.meta.bottom.php' , array( 'row' => $row, 'postedText' => JText::_( 'COM_EASYBLOG_POSTED' ) ) ); ?>
