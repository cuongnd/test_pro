...
?>
<li class="blog-post micro-link<?php echo isset( $customClass ) ? ' item-' . $customClass : '';?>" itemscope itemtype="http://schema.org/Blog">
	<div class="blog-link">
	...
	<?php echo $this->fetch( 'blog.meta.simple.php' , array( 'entry' => $entry, 'postedText' => JText::_( 'COM_EASYBLOG_LINK_SHARED_BY' ) ) ); ?>
