...
<?php echo JText::_( 'COM_EASYBLOG_NOTIFICATION_NEW_BLOG_REJECTED_TEXT' ); ?>
...
<?php echo JText::_( 'COM_EASYBLOG_NOTIFICATION_REVIEW_YOUR_POST_TEXT' );?>: <?php echo $blogEditLink;?>