...
<div style="color:#555;border-bottom:1px solid #ddd;padding-bottom:20px;margin-bottom:20px">
	...
	<br /><br />
	<?php echo JText::_( 'COM_EASYBLOG_NOTIFICATION_NEW_COMMENT_POSTED' ); ?> 
	<br />
	<br />
...
<div style="float:left;display:inline-block;width:100%;padding-bottom:20px;">
	...
	<div style="clear:both;border-top:1px solid #ddd;padding:20px 0">
		<a href="<?php echo $commentLink;?>" target="_blank" style="display:inline-block;padding:5px 15px;background:#fc0;border:1px solid #caa200;border-bottom-color:#977900;color:#534200;text-shadow:0 1px 0 #ffe684;font-weight:bold;box-shadow:inset 0 1px 0 #ffe064;-moz-box-shadow:inset 0 1px 0 #ffe064;-webkit-box-shadow:inset 0 1px 0 #ffe064;border-radius:2px;moz-border-radius:2px;-webkit-border-radius:2px;text-decoration:none!important">
		<?php echo JText::_( 'COM_EASYBLOG_NOTIFICATION_VIEW_COMMENT' ); ?>
		</a>
	</div>
</div>
