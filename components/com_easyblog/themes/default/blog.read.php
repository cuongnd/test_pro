...
<div id="ezblog-body" itemscope itemtype="http://schema.org/Blog">
	...
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read clearfix">
		...
		<div class="blog-text clearfix prel mtm mbm">
			...
			<div class="easyblog-thumb-preview">
				<a href="<?php echo $blog->getImage()->getSource('original');?>" title="<?php echo $this->escape( $blog->title );?>"><img src="<?php echo $blog->getImage()->getSource( 'entry' );?>" class="blog-image" /></a>
			</div>
			<?php } ?>
