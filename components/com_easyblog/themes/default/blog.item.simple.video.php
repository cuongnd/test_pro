...
?>
<li class="blog-post micro-video<?php echo isset( $customClass ) ? ' item-' . $customClass : '';?>" itemscope itemtype="http://schema.org/Blog">
	...
	<?php echo $this->fetch( 'blog.meta.simple.php' , array( 'entry' => $entry, 'postedText' => JText::_( 'COM_EASYBLOG_VIDEO_SHARED_BY' ) ) ); ?>
