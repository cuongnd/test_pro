	...
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read micro-quote clearfix">
		...
		<div class="blog-head mtm">
			...
			<div class="blog-quote">
				<!-- Post title -->
				<h1 id="title-<?php echo $blog->id; ?>" class="blog-title<?php echo ($blog->isFeatured) ? ' featured' : '';?> rip">
					<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=entry&id='.$blog->id); ?>" itemprop="name"><?php echo $blog->title; ?></a>
