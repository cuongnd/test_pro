...
<div id="ezblog-body" itemscope itemtype="http://schema.org/Blog">
	...
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read micro-link clearfix">
		...
		<!-- Post metadata -->
		<?php //echo $this->fetch( 'blog.meta.php' , array( 'row' => $blog, 'postedText' => JText::_( 'COM_EASYBLOG_LINK_SHARED' ) , 'loadFontSize' => true ) ); ?>
		...
		<div class="blog-text clearfix prel mtm mbm">
			...
			<div class="blog-link">
				<h1 id="title-<?php echo $blog->id; ?>" class="blog-title<?php echo ($isFeatured) ? ' featured-item' : '';?> rip" itemprop="name">
