...
?>
<!-- Post item wrapper -->
<div id="entry-<?php echo $row->id; ?>" class="blog-post micro-twitter clearfix prel<?php echo (!empty($row->team)) ? ' teamblog-post' : '' ;?>">
	<div class="blog-post-in">
		...
		<div class="blog-content clearfix">
			...
			<div class="blog-text clearfix prel">
				...
				<!-- Post content -->
				<div class="blog-tweet"><?php echo $row->text; ?></div>
