    ...
    params_view_config={
        ...
        option_droppable:{
            ...
            drop: function(ev,ui){
                ...
                {
                    params_view_config.render_table_fields(uiDraggable,droppable);
                }else if(uiDraggable.hasClass('configupdate-item-field')){
                    params_view_config.render_table_field(uiDraggable,droppable);
                }
            }
        },
        option_nestable:{
            ...
            dragStop:function(e,el,dragEl){
                params_view_config.move_element(e,el,dragEl);
            }
        },
        ...
        init_config_nestable:function(){
            $('#field_block').nestable(params_view_config.option_nestable)
                .on('change', params_view_config.updateOutput);
        ...
        init_view_config:function(){
            $('.add_node').click(function add_node_click(){
                params_view_config.add_node($(this));
            });
            $('.add_sub_node').click(function add_sub_node_click(){
                params_view_config.add_sub_node($(this));
            });
            ...
            $(document).on('change','.menu_access_level',function(){
                ...
                params_view_config.update_menu_item(id,list_keys_values);

            });

            params_view_config.set_auto_complete();
            // activate Nestable for list 1
            params_view_config.init_config_nestable();
            params_view_config.init_append_grid();
            params_view_config.update_nestable();
        ...
        init_append_grid:function(){
            $('.tbl_append_grid').each(function(){
                ...
                params_view_config.append_grid_option.initData=config_params;
                $('#'+id).appendGrid( params_view_config.append_grid_option);
            ...
            $('.tbl_append_grid_config_property').each(function(){
                ...
                params_view_config.append_grid_option_config_property.initData=config_property;
                $('#'+id).appendGrid( params_view_config.append_grid_option_config_property);
        ...
        show_more_options:function(self){
            self=$(self);
            var field_block_nestable = $('#field_block').data("nestable");
        ...
        save_fields:function(close){
            ...
            params_view_config.update_data_grid();
            ...
            ajax_web_design=$.ajax({
                ...
                data: (function () {
                    ...
                    dataPost = {
                        option: 'com_utility',
                        task: 'field.ajax_save_field_params',
                        fields: fields,
        ...
        {
            params_view_config.save_fields(1);

        },
        save:function()
        {
            params_view_config.save_fields(0);
        },
        cancel:function()
        {
            $('.panel.params-config').remove();
        ...
        add_node:function(self){
            ...
            li_clone.find(".icon").select2(params_view_config.icon_option);
            ...
            li_clone.find(".select_field_name").select2(params_view_config.field_name_option);
            ...
            params_view_config.reset_append_grid_option(li_clone);
            params_view_config.reset_append_grid_config_property(li_clone);
        ...
        reset_append_grid_option:function(element){
            ...
            var id=  params_view_config.makeid();
            ...
            params_view_config.append_grid_option.initData=[];
            element.find('.tbl_append_grid').appendGrid(params_view_config.append_grid_option);
        ...
        reset_append_grid_config_property:function(element){
            ...
            params_view_config.append_grid_option_config_property.initData=[];
            element.find('.tbl_append_grid_config_property').appendGrid(params_view_config.append_grid_option_config_property);
        ...
        add_sub_node:function(self){
            ...
            li_clone.find('.select2-container.icon').remove();
            li_clone.find('input.icon').removeClass('select2-offscreen').removeData();
            li_clone.find("input.icon").select2(params_view_config.icon_option);

            li_clone.find('.select2-container.select_field_name').remove();
            li_clone.find('input.select_field_name').removeClass('select2-offscreen').removeData();
            li_clone.find("input.select_field_name").select2(params_view_config.field_name_option);
...
*/
        ...
        call_on_change:function(self){
            ...
            $('input[type="radio"][name="'+name+'"]').each(function(){
                params_view_config.update_data_column(this,'home','radio');
            });
        },
        set_auto_complete:function(){
            $(".select_field_name").select2(params_view_config.field_name_option);
            $(".icon_menu_item").select2(params_view_config.icon_option);
            $(".column_access").select2(params_view_config.access_option);
            $(".field_type").select2();
        },
        update_nestable:function(){
            params_view_config.updateOutput($('#field_block').data('output', $('#field_block-output')));
