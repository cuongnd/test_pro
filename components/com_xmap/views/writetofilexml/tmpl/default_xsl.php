...
<style type="text/css">
    ...
    .sortup {
        ...
        background-image: url(<?php echo JUri::root(); ?>components/com_xmap/assets/images/sortup.gif);
    ...
    .sortdown {
        background-position: right center;
        background-image: url(<?php echo JUri::root(); ?>components/com_xmap/assets/images/sortdown.gif);
        background-repeat: no-repeat;
        font-style:italic;
        white-space:pre;
    }
    ...
    .editable {
        cursor:pointer;
        background: url(<?php echo JUri::root(); ?>components/com_xmap/assets/images/arrow.gif) top right no-repeat;
        padding-right:18px;
        padding-right:18px;
        border:1px solid #ffffff;
    }
    ...
    .toggle-excluded {
        ...
        background: url(<?php echo JUri::root(); ?>components/com_xmap/assets/images/tick.png) no-repeat;
    }
    .excluded {
      text-decoration:line-through;
    }
    .excluded .toggle-excluded {
        background: url(<?php echo JUri::root(); ?>components/com_xmap/assets/images/unpublished.png) no-repeat;
    }
    div.imagelist {
        border: 1px solid #ccc;
