...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_gianhang&task=ddomains.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-domains-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_gianhang&view=domains'); ?>" method="post"
