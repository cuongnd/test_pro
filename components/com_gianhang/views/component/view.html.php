 ...
 * @since       1.5
 */
class gianhangViewcomponent extends JViewLegacy
{
	protected $item;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::sprintf('com_gianhang_MANAGER_component', JText::_($this->item->name)), 'power-cord component');
