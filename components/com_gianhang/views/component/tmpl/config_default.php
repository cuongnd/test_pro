...
$doc->addLessStyleSheet(JUri::root() . '/gianhang/com_gianhang/views/component/tmpl/assets/less/view_component_config.less');
$db = JFactory::getDbo();
...
$doc->addScript(JUri::root() . "/gianhang/com_gianhang/views/component/tmpl/assets/js/view_component_config.js");
...
require_once JPATH_ROOT . '/gianhang/com_phpmyadmin/tables/updatetable.php';
...
$list_path = array(
    ...
    'administrator/gianhang/com_virtuemart/elements'
);
...
<script type="text/javascript" id="<?php echo $scriptId ?>">
    ...
    jQuery(document).ready(function ($) {
        ...
        view_component_config.field_name_option.tags =<?php echo json_encode($list_field_table_position_config) ?>;
        view_component_config.init_view_component_config();
    });
    <?php
     $script=ob_get_clean();
     ob_start();
...
<li class="dd-item"
    ...
    <div class="dd-handle">
        ...
        <button onclick="view_component_config.remove_item_nestable(this)" class="dd-handle-remove dd-nodrag pull-right"><i
                class="fa-remove"></i></button>
        <button onclick="view_component_config.expand_item_nestable(this)" class="dd-handle-expand dd-nodrag pull-right"><i
    ...
    <div class="more_options ">
        ...
        <label>Name<input class="form-control select_field_name" style="width: 200px"
                          onchange="view_component_config.update_data_column(this,'name')"
                          value="<?php echo $item->name ?>" type="text"/></label>
        <label>default<input class="form-control" onchange="view_component_config.update_data_column(this,'default')"
                             value="<?php echo $item->default ?>" type="text"/></label>
        <label>label<input class="form-control" onchange="view_component_config.update_data_column(this,'label')"
        ...
        <label>Icon<input class="icon_menu_item" style="width: 200px" type="text"
                          onchange="view_component_config.update_data_column(this,'icon')"
                          value="<?php echo $item->icon ?>"/></label>
        <label>Description<textarea class="description" style="width: 200px"
                                    onchange="view_component_config.update_data_column(this,'description')"
        ...
        <label>
            ...
            <select disableChosen="true" style="width: 200px"
                    onchange="view_component_config.update_data_column(this,'type');view_component_config.update_data_column(this,'addfieldpath');view_component_config.update_atrribute_param_config(this)"
        ...
        <label>Read only<input <?php echo $item->readonly == 1 ? 'checked' : '' ?> type="checkbox"
                                                                                   onchange="view_component_config.update_data_column(this,'readonly','checkbox')"
                                                                                   value="1"/></label>
    ...
    ?>
    <div class="view-component-config-default">
        <div class="row">
            <div class="col-md-12">
                <label>show more option<input onchange="view_component_config.show_more_options(this);" type="checkbox"
                                              checked
        ...
        <button class="btn btn-danger save-block-property pull-right" onclick="view_component_config.save_and_close(self)">
            <i class="fa-save"></i>Save&close
        </button>
        &nbsp;&nbsp;
        <button class="btn btn-danger apply-block-property pull-right" onclick="view_component_config.save(self)"><i
                class="fa-save"></i>Save
        </button>
        &nbsp;&nbsp;
        <button class="btn btn-danger cancel-block-property pull-right" onclick="view_component_config.cancel(self)"><i
