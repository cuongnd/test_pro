...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_gianhang&task=extensions.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-extensions-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_gianhang&view=extensions'); ?>" method="post"
