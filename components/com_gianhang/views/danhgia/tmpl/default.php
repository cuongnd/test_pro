...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_gianhang&task=danhgia.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-danhgia-default">
        <?php echo $this->render_toolbar() ?>
        <form action="<?php echo JRoute::_('index.php?option=com_gianhang&view=danhgia'); ?>" method="post"
                ...
                <table class="table table-striped" id="itemList">
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" item-id="<?php echo $item->id ?>"
                            ...
                            <td class="center">
                                <?php echo JHtml::_('jgrid.published', $item->enabled, $i, 'danhgia.', $canChange); ?>
                            </td>
                            <td>
                            ...
                            <td class="center">
                                <?php echo JHtml::_('jgrid.is_system', $item->issystem, $i, 'danhgia.', $canChange); ?>
                            </td>
