...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_gianhang&task=chinhsach.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-chinhsach-default">
        <?php echo $this->render_toolbar() ?>
        <form action="<?php echo JRoute::_('index.php?option=com_gianhang&view=chinhsach'); ?>" method="post"
                ...
                <table class="table table-striped" id="itemList">
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" item-id="<?php echo $item->id ?>"
                            ...
                            <td class="center">
                                <?php echo JHtml::_('jgrid.published', $item->enabled, $i, 'chinhsach.', $canChange); ?>
                            </td>
                            <td>
                                ...
                                <?php if ($canEdit) : ?>
                                    <a class="quick-edit-title"
                                       href="<?php echo JRoute::_('index.php?option=com_gianhang&task=component.edit&id=' . (int)$item->id); ?>">
                            ...
                            <td class="center">
                                <?php echo JHtml::_('jgrid.is_system', $item->issystem, $i, 'chinhsach.', $canChange); ?>
                            </td>
