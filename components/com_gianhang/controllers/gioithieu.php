 ...
 * @since       1.6
 */
class gianhangControllergioithieu extends JControllerAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'gioithieu', $prefix = 'gianhangModel', $config = array('ignore_request' => true))
	{
