 ...
 * @since       1.6
 */
class gianhangModelcomponent extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_gianhang.component', 'component', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_gianhang.edit.component.data', array());
		...
		$this->preprocessData('com_gianhang.component', $data);
    ...
    public function duplicate(&$pks)
    {
        ...
        // Access checks.
        if (!$user->authorise('core.create', 'com_gianhang'))
        {
...
/*        // Access checks.
	...
	public function getItem($pk = null)
	{
		...
		if (!isset($this->_cache[$pk]))
		{
			...
			$path = JPath::clean(JPATH_gianhang . '/' . $table->folder . '/' . $table->element . '/' . $table->element . '.xml');
	...
	*/
	...
	/**
	 * Custom clean cache method, gianhang are cached in 2 places for different clients
	 *
	 * @since   1.6
	 */
	protected function cleanCache($group = null, $client_id = 0)
	{
		parent::cleanCache('com_gianhang');
	}
}
