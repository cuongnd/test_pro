...
<div class="sourcecoast" id="jfbc_loginregister">
    <div class="container-fluid">
        ...
        <div class="row-fluid" id="jfbc_loginregister_userinfo" class="<?php echo $this->displayType; ?>">
            <div class="<?php echo $this->displayType == "vertical" ? 'span12' : 'span6'; ?>" id="jfbc_loginregister_existinguser">
                <form action="" method="post" name="form">
                    ...
                    <?php foreach ($this->altProviders as $p)
                        echo $p->loginButton(array('providers' => $p->name));
                    ?>
                </form>
            </div>
            <?php if ($this->displayType == 'vertical') { ?>
        </div>
        <div class="row-fluid">
            <?php } ?>
            <div class="<?php echo $this->displayType == "vertical" ? 'span12' : 'span6'; ?>" id="jfbc_loginregister_newuser">
