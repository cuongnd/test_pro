...
$lessInput = JPATH_ROOT . '/components/com_website/views/website/tmpl/assets/less/view_website_config.less';
$cssOutput = JPATH_ROOT . '/components/com_website/views/website/tmpl/assets/less/view_website_config.css';
$db = JFactory::getDbo();
JHtml::_('jquery.framework');
JUtility::compileLess($lessInput, $cssOutput);
$doc->addStyleSheet(JUri::root() . "/components/com_website/views/website/tmpl/assets/less/view_website_config.css");
...
$doc->addScript(JUri::root() . "/components/com_website/views/website/tmpl/assets/js/view_website_config.js");
