...
abstract class JHtmlproductAdministrator
{
	...
	public static function association($articleid)
	{
		...
		if ($associations = JLanguageAssociations::getAssociations('com_product', '#__product', 'com_product.item', $articleid))
		{
			...
			if ($items)
			{
				foreach ($items as &$item)
				{
					...
					$url = JRoute::_('index.php?option=com_product&task=article.edit&id=' . (int) $item->id);
					$tooltipParts = array(
