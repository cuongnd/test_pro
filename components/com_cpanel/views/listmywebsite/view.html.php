 ...
 * @since       1.5
 */
class cpanelViewlistmywebsite extends JViewLegacy
{
	protected $items;
	...
	{
		require_once JPATH_ROOT.'/components/com_cpanel/helpers/listmywebsite.php';
		$canDo = listmywebsiteHelper::getActions('com_cpanel');
