...
$doc->addLessStyleSheetTest(JUri::root().'/components/com_cpanel/assets/less/view_product_demo.less');
...
$doc->addScript(JUri::root().'/components/com_cpanel/assets/js/view_product_demo.js');
