...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_cpanel&task=dlisttemplatecategory.saveOrderAjax&tmpl=component';
...
<?php } else { ?>
    ...
    <div class="view-listtemplatecategory-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_cpanel&view=listtemplate'); ?>" method="post"
            ...
            <div id="main-container">
                ...
                <table class="table table-striped" id="itemList">
                    ...
                    <tr>
                        ...
                        <th class="title">
                            <?php echo JHtml::_('grid.sort', 'Website', 'website_title', $listDirn, $listOrder); ?>
                        </th>
                        <th class="title">
                            <?php echo JText::_('Enable create template') ?>
                        </th>
                            ...
                            <td>
                                ...
                                <?php if ($canEdit) : ?>
                                    <a class="quick-edit-title"
                                       href="<?php echo JRoute::_('index.php?option=com_cpanel&task=template.edit&id=' . (int)$item->id); ?>">
