 ...
 * @since       1.5
 */
class cpanelViewlisttemplatecategory extends JViewLegacy
{
	protected $items;
	...
	{
		require_once JPATH_ROOT.DS.'components/com_cpanel/helpers/listtemplatecategory.php';
		$canDo = listtemplatecategoryHelper::getActions('com_cpanel');
