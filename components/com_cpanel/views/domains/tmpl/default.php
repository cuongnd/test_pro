...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_cpanel&task=ddomains.saveOrderAjax&tmpl=component';
...
?>
    ...
    <div class="view-domains-default">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_cpanel&view=domains'); ?>" method="post" name="adminForm" id="adminForm">
                            ...
                            <td>
                                ...
                                <?php if ($canEdit) : ?>
                                    <a class="quick-edit-title"
                                       href="<?php echo JRoute::_('index.php?option=com_cpanel&task=domain.edit&id=' . (int)$item->id); ?>">
