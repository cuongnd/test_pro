 ...
 * @since       1.6
 */
class cpanelModelproduct extends JModelAdmin
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_cpanel.product', 'product', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_cpanel.edit.product.data', array());
		...
		$this->preprocessData('com_cpanel.product', $data);
