 ...
 * @version 	$Id: payment.php 50 2012-07-14 16:47:39Z quannv $
 **/
...
class BookProModelPayment extends AModelFrontEnd
{
	var $_table;
	...
	{
		parent::__construct();
		if (! class_exists('TablePayment')) {
			AImporter::table('payment');
		}
