...
class BookProModelRoomPriceLog extends AModelFrontEnd
{
    var $_table;
    ...
    {
        parent::__construct();
        if (! class_exists('TableRoomPriceLog')) {
            AImporter::table('roompricelog');
        }
        $this->_table = $this->getTable('roompricelog');
    }
