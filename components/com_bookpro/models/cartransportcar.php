...
class BookProModelCarTransportCar extends AModelFrontEnd
{
	var $_table;
	...
	{
		parent::__construct();
		if (! class_exists('TableCarTransportCar')) {
			AImporter::table('cartransportcar');
		}
		$this->_table = $this->getTable('cartransportcar');
	}
