...
jimport('joomla.packagetype.component.model');
//import needed JoomLIB helpers
AImporter::helper('bookpro', 'model');
//import needed tables

class BookProModelPackageType extends AModelFrontEnd
{
	var $_table;
	...
	{
		parent::__construct();
		if (! class_exists('TablePackageType')) {
			AImporter::table('packagetype');
		}
