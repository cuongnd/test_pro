...
class BookProModelPackageRateLog extends AModelFrontEnd
{
	var $_table;
	...
	{
		parent::__construct();
		if (! class_exists('TablePackageRateLog')) {
			AImporter::table('packageratelog');
		}
		$this->_table = $this->getTable('packageratelog');
	}
