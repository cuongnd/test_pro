...
class BookProModelCarDestination extends AModelFrontEnd
{
	var $_table;
	...
	{
		parent::__construct();
		if (! class_exists('TableCarDestination')) {
			AImporter::table('cardestination');
		}
	...
	function getFullList()
	{
		...
		return $this->_getList('select dest.id as value, dest.value as text  FROM ' . $this->_table->getTableName() . ' as dest');
