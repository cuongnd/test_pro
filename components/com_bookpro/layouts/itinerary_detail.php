...
<p class="itinerary_head"><?php echo JText::_('COM_BOOKPRO_TOUR_ITINERARY_DETAIL') ?></p>
								
 <?php 
    $sl = 0;
    $classpage = "itinerarydetail";
            ...
            foreach ($displayData->itis as $t => $data) { 
                ...
                <div class="itinerary-row <?php echo $classpage.$sl;?> <?php echo $classpage;?>">
	                <div class="content_div2_overview">
		                ...
		                <div class="intinerary-desc"><?php echo $data->desc ?></div>       
		                <div class="row-fluid">
			                <div class="dest-title span4 offset3">
				                <?php echo JText::sprintf('COM_BOOKPRO_TOUR_ORVERNIGHT',$data->city_title); ?>	
			                </div>
			                <div class="meal-title span5">
				                <?php echo JText::sprintf('COM_BOOKPRO_TOUR_MEALS',TourHelper::getMealIntinerary($data->meal)); ?>
			                </div>
		                </div>     
	                </div>      
                </div>
...
<div class="pull-right" style="padding-top:10px;padding-bottom:10px; padding-right:10px;">
    <div class="slide-title pull-left"><a href="javascript:void(0);" class="action_item" key="<?php echo $classpage;?>all"></a></div>
