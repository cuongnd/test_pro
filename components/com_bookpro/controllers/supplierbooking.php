<?php
    ...
    class BookProControllersupplierbooking extends JControllerLegacy{

        public function BookProControllersupplierbooking(){
            parent::__construct();
        }
        ...
        function showmodulehotelsearch()
        {
            ...
            $cart->load();
            $view=$this->getView('supplierbooking','html','BookProView');
        ...
        function savehotelbooking()
        {
            ...
            $customer['state']=1;
            AImporter::helper('hotel');
            $customer['created_by']=HotelHelper::getCustomerIdByUserLogin();
