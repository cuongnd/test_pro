<?php
    ...
    class BookProControllermypage extends JControllerForm
    {
        ...
        function __construct($config = array())
        {
            ...
            $this->_model = $this->getModel('mypage');
            $this->_controllerName = mypage;
        }
