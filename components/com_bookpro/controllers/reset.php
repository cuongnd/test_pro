...
require_once JPATH_COMPONENT_FRONT_END.'/controller.php';
 ...
 * @since       1.6
 */
class BookProControllerReset extends JControllerLegacy
{
	/**
	...
	{        
		...
		$model = $this->getModel('Reset', 'BookProModel');
		...
		if ($return instanceof Exception)
		{
			...
			$route	= 'index.php?option=com_bookpro&view=reset'.$itemid;
		...
		else
		{
			...
			$itemid = JRequest::getVar('Itemid');   
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_bookpro&view=reset&layout=confirm'.$itemid;
	...
	public function confirm()
	{
		...
		else
		{
			...
			$itemid = JRequest::getVar('Itemid');
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_bookpro&view=reset&layout=complete'.$itemid;
	...
	public function complete()
	{
		...
		else
		{
			...
			$itemid = JRequest::getVar('Itemid');
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_bookpro&view=login'.$itemid;
