...
abstract class JHtmlTourAdministrator {
    ...
    public static function featured($value = 0, $i, $canChange = true) {
        ...
        $states = array(
            0 => array('unfeatured', 'tours.featured', 'COM_BOOKPRO_UNFEATURED', 'COM_BOOKPRO_TOGGLE_TO_FEATURE'),
            1 => array('featured', 'tours.unfeatured', 'COM_BOOKRPO_FEATURED', 'COM_BOOKPRO_TOGGLE_TO_UNFEATURE'),
        );
