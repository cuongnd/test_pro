    ...
    class ExpediaHotelHelper {
        ...
        */
        ...
        static function getMinPriceHotelInMonth($hotel_id){
            ...
            $endMonth->add(new DateInterval('P10M'));
        ...
        static function displayHotelMap($hotel_id) {
            $link=JUri::root().'index.php?option=com_bookpro&view=displaymap&tmpl=component&hotel_id='.$hotel_id;
        ...
        static function getSupplierSelect($select=null)
        {
            ...
            $lists = array('group_id'=>$config->supplierUsergroup,'order'=>'firstname','order_Dir'=>'ASC');
            $model->init($lists);
            $list = $model->getData();
            return AHtmlFrontEnd::getFilterSelect('userid', JText::_('COM_BOOKPRO_SELECT_SUPPLIER'), $list, $select, $autoSubmit, '', 'id', 'fullname');
        }
