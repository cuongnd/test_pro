...
class Expedia
{
    ...
    //protected $api_url = 'api.ean.com/ean-services/rs/hotel/v3/';
    protected $api_url = 'api.eancdn.com/ean-services/rs/hotel/v3/';
    ...
    public function __call($name, $args)
    {
        ...
        {
            throw new EXPEDIAException( $response['EanWsError'] );
        }
