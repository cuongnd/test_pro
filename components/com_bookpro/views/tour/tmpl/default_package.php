        ...
        <div class="div2_overview_nav_tabs text-left">
            ...
            <div class="content_div2_overiew_nav_tabs">
                ...
                <div class="content_div2_date_private">
                    ...
                    <div class="div_content_table_tours_class">
                        ...
                        ?>
                        <?php echo $this->loadTemplate('package_' . $stype . '_price') ?>
                        ...
                        <table  class="table">
                            ...
                            if ($itineraries) {
                                for ($t = 0; $t < count($itineraries); $t++) {
                                    ...
                                    $dest = $destModel->getObject($itineraries[$t]->dest_id);
            ...
            <!--                                                <td colspan="4" class="firt_title"><?php echo $itineraries[$t]->title . ' - ' . $dest->title; ?></td>-->
                    ...
                    <div class="pull-right" style="padding-bottom:10px; padding-right:10px;">
                        <div class="slide-title pull-left"><a href="javascript:void(0);" class="action_item" key="<?php echo $classpage; ?>all"><span style="color:#007799;text-transform:uppercase;font-weight:bold;padding-right:8px;"><?php echo JText::_('COM_BOOKPRO_ALL_HOTELS'); ?></span></a></div>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        function submitbookingtourpackage($data)
        {
            ...
            $form.find('input[name="stype"]').val($data.stype);
