...
<!--<img alt="" src="images/print_1.png">-->
    ...
    $galleriesModel->setState('filter.obj_id', $this->tour->id);
    $galleries = $galleriesModel->getItems(); 

    ?>     
    <div class="span4 col_right tour-right hidden-phone">     

            <?php
            	$this->tour->type=1;
	            $layout = new JLayoutFile('gallery', $basePath = JPATH_ROOT . '/components/com_bookpro/layouts');
	            $html = $layout->render($this->tour);
	            echo $html;
            ?>
