    ...
    <div class="sub-wrapper-content">
        ...
        <div class="row-fluid wapper-booking-detail">
            <div class="wapper depart pull-left">
                ...
                <div><?php echo JFactory::getDate($cart->start)->format('l jS F Y') ?></div>
            </div>
            <div class="wapper arrival pull-right">
                ...
                <div><?php echo JFactory::getDate($cart->end)->format('l jS F Y') ?></div>
            </div>
        </div>
        <div>
        ...
        <div class="trip-details">
            <div class="header trip-details"><a  data-toggle="collapse" data-target=".trip-detail" href="javascript:void(0)"><?php echo JText::_('Trip details') ?></a></div>
            <div class="body">
                <div class="trip-detail collapse"><?php echo $this->bookingBustrip->trip_information ?></div>
                <div class="row-fluid">
