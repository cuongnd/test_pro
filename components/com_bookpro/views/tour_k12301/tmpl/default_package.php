                        ...
                        <thead style="background:#95a5a5; color:#fff;">
                            <tr>
                                ...
                                <?php foreach ($arr_person as $array_person_item) { ?>
                                    <th> <?php echo $array_person_item ?>.&nbsp; pers</th>
                                <?php } ?>
                                    ...
                                    if ($packagetypes) {
                                        ...
                                        <tbody style="background:#f6f9fa;" class="toursl<?php echo $sl; ?> toursl">
                                            ...
                                            for ($i = 0; $i < count($packagetypes); $i++) {
                                                $packageHotel = TourHelper::getPackageHotelByTou_idAndItinerary_idAndPackagetype_id($this->tour->id, $itineraries[$t]->id, $packagetypes[$i]->id);
                                                $hotel = '';
                                                ...
                                                <tr>
                                                    <?php if ($hotel) { ?>
                                                        <td class="div1_tour_class"><?php echo $packagetypes[$i]->title; ?></td>     
