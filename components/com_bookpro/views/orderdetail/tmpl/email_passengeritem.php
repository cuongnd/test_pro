...
<div class="passenger_form row-fluid">
	...
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><?php echo JHtml::link('index.php?option=com_bookpro&view=orderdetail&layout=voucher&tpl=posttrip&type=posttrip&order_id=' . $this->order->id.'&passenger_id='.$passenger->id, JText::_('Print voucher')); ?> </li>
			<li><a href="#">Edit</a></li>
