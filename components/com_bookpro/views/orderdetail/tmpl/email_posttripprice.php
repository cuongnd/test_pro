<h3 style="text-transform: uppercase; color: #9A0000; text-align: left"><?php echo JText::_('COM_BOOKPRO_POST_TRIP_HOTEL') ?></h3>
<?php $k = 0; ?>
<table class="table table-bordered">
    <?php foreach ($this->list_post_trip_acommodaton as $bookroom) { ?>
        <tr>
                            ...
                            <td class="action_item">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><?php echo JHtml::link('index.php?option=com_bookpro&view=orderdetail&layout=voucher&tpl=posttrip&order_id=' . $this->order->id.'&roomtypepassenger_id='.$room->id, JText::_('Print voucher')); ?> </li>
                                        <li><a href="#">Edit</a></li>
