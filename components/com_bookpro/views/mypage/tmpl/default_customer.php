...
<div class="form-horizontal">
    <fieldset>
        <legend> <?php echo JText::_('COM_BOOKPRO_CUSTOMER') ?></legend>
        ...
        <?php if ($config->rsCountry) { ?>
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo BookProHelper::getCountryList('country_id',$this->customer->country_id, 'placeholder="' . JText::_('COM_BOOKPRO_CUSTOMER_COUNTRY') . '"',  '') ?>
                </div>
            </div>
