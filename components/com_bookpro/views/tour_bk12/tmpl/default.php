    ...
    <div class="span8 col_left">
        ...
        <div class="div3_col_left">
            ...
            <div class="social-share row-fluid">
                ...
                <div class="span6">
                <div class="spshare pull-right" style="margin-right: 20px;">
                	<img alt="" src="images/print.png">
                </div>
                ...
                <div class="content_relate text-left">
                    <div class="content_title">
                    	...
                    	<div class="related-row">
							...
							<p style="font-size:11px;line-height:12px;">Travelling around Vietnam to catch impressive images of Ha N?i Captital City, ancient Hue Town, enchanting Hoian..</p>
                    	</div>
