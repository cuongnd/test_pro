...
<form id="adminForm" name="adminForm" method="post" action="index.php">
    <fieldset class="adminform"><legend><?php echo JText::_('COM_BOOKPRO_CUSTOMER_DETAIL'); ?></legend>
        <div class="form-horizontal">
            ...
            <?php } ?>
            <div class="control-group">
                <label class="control-label" for="created"><?php echo JText::_('Rirthday'); ?>
                </label>
                <div class="controls">
                    <?php echo $this->customer->birthday; ?>
                </div>
            </div>
        </div>
