	...
	_generateMonth: function(target, inst, year, month, renderer, first) {
		...
		for (var week = 0; week < numWeeks; week++) {
			...
			for (var day = 0; day < 7; day++) {
				...
				var str_fulldate=year.toString().concat(month,drawDate.getDate());
				...
				days += this._prepare(renderer.day, inst).replace(/\{day\}/g,
					...
					(selectable ? '</a>' : '</span>')+
					(htmls[str_fulldate] !== undefined ?htmls[str_fulldate].status :'')+
					(htmls[str_fulldate] !== undefined ?htmls[str_fulldate].qty :'')
					
					).replace(/\{style\}/g,(htmls[str_fulldate] !== undefined ?('style="'+htmls[str_fulldate].style)+'"' :''))
					.replace(/\{class\}/g,(htmls[str_fulldate] !== undefined ?htmls[str_fulldate].a_class+(drawDate.getTime() >= today.getTime()?' enable':'') :''))
					...
					.replace(/\{atrrib\}/g,(htmls[str_fulldate] !== undefined ?htmls[str_fulldate].atrrib :''));
