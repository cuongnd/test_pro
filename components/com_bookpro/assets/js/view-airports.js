 ...
 * 
 * @version $Id: view-airports.js 19 2012-06-26 12:58:05Z quannv $
...
var ListCustomers = {
	...
	select : function(id, name) {
		window.parent.document.getElementById('airport_id').value = id;
		window.parent.document.getElementById('value').value = value;
