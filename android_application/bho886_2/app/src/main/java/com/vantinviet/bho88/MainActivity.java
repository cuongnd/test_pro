...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String host = "http://banhangonline88.com/index.php?os=android&screenSize=" + screenSize+"&version="+local_version;
            ...
            if (position.toLowerCase().contains("position-component")) {
                ...
                for (int i=0;i<modules.length();i++)
                {
                    ...
                    if (module_position.toLowerCase().contains("position-"+String.valueOf(id)))
                    {
                        ...
                        switch (module_name) {
                            case "mod_menu":
                                modMenuHelper.render_menu(context, linear_layout, module);
                                break;
                            case "column":
                        /*case "input":
                            EditText input_object = this.render_element_edit_text(object_parent, children);*/
    ...
    public EditText render_element_edit_text(View parent_object, JSONObject object) {
        EditText edit_text = new EditText(MainActivity.this);
        try {
