...
import com.vantinviet.vtv.video_player;
 ...
 */
public class JFormFieldVideoPlayerLink extends JFormField{
    static Map<String, JFormFieldText> map_form_field_text = new HashMap<String, JFormFieldText>();
    public JFormFieldVideoPlayerLink(JSONObject field, String type, String name, String group, String value){
        this.type=type;
        this.name=name;
        this.group=group;
        this.option=field;
    ...
    public JFormFieldVideoPlayerLink(){
    }
    ...
    public View getInput() {
        ...
        text_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                JFormFieldVideoPlayerLink form_field_link=(JFormFieldVideoPlayerLink)JFormField.map_form_field.get(tag);
