    ...
    $.sprFlat = function(element, options) {
        ...
        plugin.fixedSidebarTool = function (val) {
            if(val == true) {
                ...
                //activate slim scroll
                $('#right-sidebar-tool>.sidebar-inner').slimScroll({
                    position: "right",
                    height: '100%',
                    distance: '0',
                    railVisible: false,
                ...
                //deactivate slim scroll
                $('.right-sidebar-tool .sidebar-inner').parent().replaceWith($('.sidebar-inner'));
                $('.right-sidebar-tool .sidebar-inner').attr('style', '');
            }
        }
