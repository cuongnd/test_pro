...
$doc->addScriptNotCompile(JUri::root() . '/templates/sprflat/html/website/website_'.WEBSITE_ID.'/assets/js/custom_mega_menu_styles/js/jquery.dcmegamenu.1.3.js');
$doc->addScriptNotCompile(JUri::root() . '/templates/sprflat/html/website/website_'.WEBSITE_ID.'/mod_virtuemart_category/assets/js/dcmegamenu.js');
$doc->addLessStyleSheetTest(JUri::root() . '/templates/sprflat/html/website/website_'.WEBSITE_ID.'/assets/js/custom_mega_menu_styles/megamenu.less');
