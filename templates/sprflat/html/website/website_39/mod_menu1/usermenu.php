...
$doc->addStyleSheet(JUri::root().'/templates/shoponline123/html/mod_jbmenu/assets/css/style.css');
...
<div class="subnav<?php echo $class_sfx; ?>">
	...
	<ul class="nav dropdown-menu nav-pills menu<?php echo $class_sfx; ?>" aria-labelledby="dropdownMenu1"
		<?php
		$tag = '';
